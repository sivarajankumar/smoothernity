...
rd /S /Q G:\TEMP\smoothernity\build_rel_stable
mkdir G:\TEMP\smoothernity\build_rel_stable
g:
cd G:\TEMP\smoothernity\build_rel_stable
cmake -DSDL_LIBRARY_TEMP="C:\Devel\SDL\lib\x86\SDL.lib" ^
      ...
      -DPLATFORM="WINDOWS" ^
      C:\Attic\Projects\smoothernity\repo.stable\src
