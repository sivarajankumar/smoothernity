...
ifs-for-error-handling-in-c}%
    ...
    \item
        ...
        Distributed multiplayer is impossible, because of unpredictable
        latency.
        One way to engage remote players anyways is to let them see each
        other's position\footnote{
