...
syntax keyword shy_statement system machine state consts on to is command if do input entry exit initial discard vars ops receive request module trace with else while args proc init done copy paste replace module_name types reply messages stateless elif
