void shy_iphone_platform_sound_loader :: create_stereo_resource_id 
...
void shy_iphone_platform_sound_loader :: loader_ready ( so_called_type_platform_math_num_whole & result )
{
    void * void_loader = 0 ;
    so_called_platform_sound_loader_insider :: get_sound_loader ( void_loader ) ;
    shy_iphone_sound_loader * loader = reinterpret_cast < shy_iphone_sound_loader * > ( void_loader ) ;
    so_called_platform_math_insider :: num_whole_value_set ( result , [ loader loader_ready ] ) ;
}

void shy_iphone_platform_sound_loader :: loaded_samples_count ( so_called_type_platform_math_num_whole & result )
{
    void * void_loader = 0 ;
    so_called_platform_sound_loader_insider :: get_sound_loader ( void_loader ) ;
    shy_iphone_sound_loader * loader = reinterpret_cast < shy_iphone_sound_loader * > ( void_loader ) ;
...
void shy_iphone_platform_sound_loader :: _load_stereo_sample_data
