    ...
    )
{
    ...
    void * texture_loader = 0 ;
    so_called_platform_render_texture_loader_insider :: get_texture_loader ( texture_loader ) ;
    shy_macosx_texture_loader * loader = reinterpret_cast < shy_macosx_texture_loader * > ( texture_loader ) ;
    [ loader 
