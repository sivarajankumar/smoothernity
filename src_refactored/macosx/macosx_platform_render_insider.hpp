...
public :
    ...
    void set_texture_loader ( shy_macosx_texture_loader * texture_loader ) ;
...
template < typename platform_insider >
void shy_macosx_platform_render_insider < platform_insider > :: set_texture_loader ( shy_macosx_texture_loader * texture_loader )
{
    _platform_insider -> render . _texture_loader = texture_loader ;
}

template < typename platform_insider >
void shy_macosx_platform_render_insider < platform_insider > :: set_aspect_width ( float width )
{
    _platform_insider -> render . _aspect_width = width ;
}

template < typename platform_insider >
void shy_macosx_platform_render_insider < platform_insider > :: set_aspect_height ( float height )
{
