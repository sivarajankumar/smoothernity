...
void shy_loadable_fsm_reflection_logic_application :: prepare ( )
{
    ...
    shy_bind_action_helper ( logic_salutation_creation_permit ) ;
    shy_bind_action_helper ( logic_salutation_launch_permit ) ;
    shy_bind_action_helper ( logic_salutation_render ) ;
    ...
    shy_bind_input_helper ( logic_salutation_created ) ;
