...
{
    so_called_std_cerr << "machine " ;
    so_called_std_cerr << machine ;
    so_called_std_cerr << " state " ;
    so_called_std_cerr << state ;
    so_called_std_cerr << " action command " ;
    so_called_std_cerr << command_name ;
    so_called_std_cerr << " to machine " ;
    so_called_std_cerr << command_machine ;
    so_called_std_cerr << so_called_std_endl ;
}
    ...
    )
{
    ...
    so_called_std_cerr << " state " ;
    so_called_std_cerr << state ;
    so_called_std_cerr << " action do " ;
    so_called_std_cerr << action ;
    so_called_std_cerr << so_called_std_endl ;
}
...
{
    so_called_std_cerr << so_called_std_endl ;
    so_called_std_cerr << "tick all fsms" ;
    so_called_std_cerr << so_called_std_endl ;
}
