...
void shy_loadable_fsm_binder :: bind_system ( const so_called_lib_std_char * name , so_called_type_loadable_fsm_content_system_binding binding )
{
...
void shy_loadable_fsm_binder :: bind_input ( const so_called_lib_std_char * name , so_called_type_loadable_fsm_content_input_binding binding )
{
    if ( shy_guts :: current_system )
        shy_guts :: current_system -> inputs [ name ] = binding ;
}

void shy_loadable_fsm_binder :: bind_action ( const so_called_lib_std_char * name , so_called_type_loadable_fsm_content_action_binding binding )
{
    if ( shy_guts :: current_system )
