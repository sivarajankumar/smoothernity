namespace shy_guts
{
    namespace consts
    {
        ...
        static const so_called_std_string whitespace = " " ;
    }

    namespace consts_python
    {
...
void shy_guts :: consts_python :: main_script ( so_called_std_string & result , so_called_std_string logic )
{
    result . clear ( ) ;
...
void shy_guts :: consts_python :: generate_file ( so_called_std_string & result , so_called_std_string path , so_called_std_string contents )
{
    result . clear ( ) ;
...
void shy_guts :: generate_consts :: python_script ( so_called_std_string & result )
{
        ...
        )
    {
        ...
        shy_guts :: consts_python :: generate_file 
            ( generate_consts_hpp
...
void shy_guts :: generate_consts :: signed_value ( so_called_std_string & result , so_called_std_string sign , so_called_std_string number )
{
    ...
    result += sign ;
    if ( ! sign . empty ( ) )
        result += shy_guts :: consts :: whitespace ;
    result += number ;
}
...
void shy_loadable_generator :: generate ( so_called_std_string & result )
{
    ...
    shy_guts :: consts_python :: main_script ( result , consts_logic + fsm_logic ) ;
}
