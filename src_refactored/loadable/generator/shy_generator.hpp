namespace shy_guts
{
    ...
    namespace cplusplus
    {
        static void consts_injections_hpp_contents ( so_called_std_string & , so_called_std_string ) ;
        static void fsm_injections_hpp_contents ( so_called_std_string & , so_called_std_string ) ;
    }
...
void shy_guts :: cplusplus :: consts_injections_hpp_contents ( so_called_std_string & result , so_called_std_string module )
{
    result . clear ( ) ;
    result += "// autogenerated file begin\n" ;
    result += "\n" ;
...
void shy_guts :: cplusplus :: fsm_injections_hpp_contents ( so_called_std_string & result , so_called_std_string system )
{
    result . clear ( ) ;
    result += "// autogenerated file begin\n" ;
    result += "\n" ;
...
void shy_guts :: generate_consts ( so_called_std_string & result )
{
        ...
        )
    {
        ...
        shy_guts :: files :: consts_hpp 
            ( consts_hpp_path 
            , module_name 
            ) ;
        shy_guts :: files :: consts_injections_hpp 
            ( consts_injections_hpp_path 
            , module_name 
            ) ;

        shy_guts :: cplusplus :: consts_injections_hpp_contents 
...
void shy_guts :: generate_fsm ( so_called_std_string & result )
{
        ...
        )
    {
        ...
        shy_guts :: files :: fsm_hpp 
            ( fsm_hpp_path 
            , system_name 
            ) ;
        shy_guts :: files :: fsm_injections_hpp 
            ( fsm_injections_hpp_path 
            , system_name 
            ) ;

        shy_guts :: cplusplus :: fsm_injections_hpp_contents
