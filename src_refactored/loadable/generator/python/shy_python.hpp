void shy_loadable_generator_python :: main_script ( so_called_std_string & result , so_called_std_string logic )
{
    result . clear ( ) ;
...
void shy_loadable_generator_python :: generate_file ( so_called_std_string & result , so_called_std_string path , so_called_std_string contents )
{
    result . clear ( ) ;
