...
void shy_loadable_consts_binder :: module ( so_called_std_string name )
{
...
void shy_loadable_consts_binder :: bind ( so_called_std_string name , const so_called_type_platform_math_num_fract & value )
{
...
void shy_loadable_consts_binder :: bind ( so_called_std_string name , const so_called_type_platform_math_num_whole & value )
{
    if ( shy_guts :: current_module )
    {
