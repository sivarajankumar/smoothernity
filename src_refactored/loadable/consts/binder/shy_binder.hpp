...
void shy_loadable_consts_binder :: bind ( const so_called_lib_std_char * name , so_called_type_loadable_consts_content_value_fract_binding value )
{
...
void shy_loadable_consts_binder :: bind ( const so_called_lib_std_char * name , so_called_type_loadable_consts_content_value_whole_binding value )
{
    if ( shy_guts :: current_module )
    {
