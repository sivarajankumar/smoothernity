...
public :
    ...
    static void receive ( so_called_message_common_logic_salutation_letters_generate_finished ) ;
    static void receive ( so_called_message_common_logic_salutation_letters_meshes_generate_finished ) ;
