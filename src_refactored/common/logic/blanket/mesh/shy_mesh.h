...
public :
    ...
    static void receive ( so_called_message_common_logic_blanket_mesh_create ) ;
    static void receive ( so_called_message_common_logic_blanket_mesh_render_request ) ;
    static void receive ( so_called_message_common_logic_blanket_mesh_set_transform ) ;
