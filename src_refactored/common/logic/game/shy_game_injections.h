...
#include "../image/message/prepared/shy_prepared_injections.h"
#include "../image/message/render_reply/shy_render_reply_injections.h"
...
#include "../text/message/render_reply/shy_render_reply_injections.h"
