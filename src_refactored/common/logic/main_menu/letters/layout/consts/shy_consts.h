class shy_common_logic_main_menu_letters_layout_consts
{
public :
    static const so_called_type_platform_math_num_fract letter_size_fract_horizontal_spacing ;
    static const so_called_type_platform_math_num_fract letter_size_fract_vertical_spacing ;
