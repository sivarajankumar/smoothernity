...
{
public :
    static void receive ( so_called_message_common_logic_main_menu_selection_animation_select_start ) ;
    static void receive ( so_called_message_common_logic_main_menu_selection_animation_select_transform_request ) ;
