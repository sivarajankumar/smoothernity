class shy_common_logic_observer_animation_consts
{
public :
    static const so_called_type_platform_math_num_fract flight_target_z ;
    static const so_called_type_platform_math_num_fract flight_horizontal_offset_period ;
