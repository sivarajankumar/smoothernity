#ifndef _shy_message_common_engine_render_projection_frustum_included
#define _shy_message_common_engine_render_projection_frustum_included

class shy_message_common_engine_render_projection_frustum
{
public :
