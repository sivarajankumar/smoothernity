#ifndef _shy_message_common_engine_render_mesh_set_vertex_color_included
#define _shy_message_common_engine_render_mesh_set_vertex_color_included

class shy_message_common_engine_render_mesh_set_vertex_color
{
public :
