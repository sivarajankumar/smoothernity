...
void my_module1 :: register_in_scheduler ( )
{
    my_module1_scheduled_context :: register_in_scheduler ( ) ;
}
...
void my_module1 :: receive ( message_my_first_module_function msg )
{
    ...
    so_called_module2_sender :: send ( message_to_second_module_from_other_modules ( ) ) ;
}
...
void my_module1 :: receive ( message_to_first_module_from_other_modules msg )
{
    ...
    so_called_module1_sender :: send ( message_from_first_module_to_other_modules ( ) ) ;
}
