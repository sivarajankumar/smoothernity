...
void my_module2 :: receive ( message_my_second_module_function msg )
{
    ...
    so_called_module1_sender :: send ( msg1 ) ;

    so_called_module1_sender :: send ( message_to_first_module_from_other_modules ( ) ) ;
}
...
void my_module2 :: receive ( message_to_second_module_from_other_modules msg )
{
    ...
    so_called_module2_sender :: send ( message_from_second_module_to_other_modules ( ) ) ;
}
