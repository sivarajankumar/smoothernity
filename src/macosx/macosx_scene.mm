...
- init
{
    ...
    typedef shy_data_loader < shy_data_loader_types < facade_loadable_type , macosx_platform_type , shy_reflection > > data_loader_type ;
    ...
    if ( self )
	{
        ...
        {
            fsm_collection_loadable_type * fsm_collection_loadable = new fsm_collection_loadable_type ( ) ;
            platform_pointer :: pointer < fsm_collection_loadable_type > fsm_collection_loadable_obj ;
            platform_pointer :: bind ( fsm_collection_loadable_obj , * fsm_collection_loadable ) ;

            facade_loadable_type * facade_loadable = new facade_loadable_type ( platform_obj , fsm_collection_loadable_obj ) ;

            _facade = facade_loadable ;
            _fsm_collection = fsm_collection_loadable ;
        ...
        {
            shy_fsm_collection_autogenerated * fsm_collection_autogenerated = new shy_fsm_collection_autogenerated ( ) ;
            platform_pointer :: pointer < shy_fsm_collection_autogenerated > fsm_collection_autogenerated_obj ;
            platform_pointer :: bind ( fsm_collection_autogenerated_obj , * fsm_collection_autogenerated ) ;

		    _facade = new facade_static_type ( platform_obj , fsm_collection_autogenerated_obj ) ;
            _fsm_collection = fsm_collection_autogenerated ;
        }
