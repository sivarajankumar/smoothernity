...
{
    result . _value = ( shy_macosx_platform_utility :: _mouse_left_button_down != false ) ;
}

inline void shy_macosx_platform :: mouse_x ( num_fract & result )
{
    result . _value = shy_macosx_platform_utility :: _mouse_x ;
}

inline void shy_macosx_platform :: mouse_y ( num_fract & result )
{
    result . _value = shy_macosx_platform_utility :: _mouse_y ;
}
