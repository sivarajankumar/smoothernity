class shy_trace_common_engine_render_fribble
{
public :
    ...
    static void meshes_overflow_error ( ) ;
    static void meshes_underflow_error ( ) ;
    static void textures_in_use ( so_called_type_platform_math_num_whole , so_called_type_platform_math_num_whole ) ;
    static void textures_overflow_error ( ) ;
    static void trying_to_modify_finalized_mesh_error ( ) ;
} ;
