inline void shy_iphone_platform :: matrix_set_axis_x ( matrix_data & matrix , num_fract x , num_fract y , num_fract z )
{
...
inline void shy_iphone_platform :: matrix_set_axis_y ( matrix_data & matrix , num_fract x , num_fract y , num_fract z )
{
...
inline void shy_iphone_platform :: matrix_set_axis_z ( matrix_data & matrix , num_fract x , num_fract y , num_fract z )
{
...
inline void shy_iphone_platform :: matrix_set_origin ( matrix_data & matrix , num_fract x , num_fract y , num_fract z )
{
...
inline void shy_iphone_platform :: matrix_set_axis_x ( matrix_data & matrix , vector_data v )
{
...
inline void shy_iphone_platform :: matrix_set_axis_y ( matrix_data & matrix , vector_data v )
{
...
inline void shy_iphone_platform :: matrix_set_axis_z ( matrix_data & matrix , vector_data v )
{
...
inline void shy_iphone_platform :: matrix_set_origin ( matrix_data & matrix , vector_data v )
{
...
inline void shy_iphone_platform :: matrix_get_axis_x ( vector_data & result , const matrix_data & matrix )
{
...
inline void shy_iphone_platform :: matrix_get_axis_y ( vector_data & result , const matrix_data & matrix )
{
...
inline void shy_iphone_platform :: matrix_get_axis_z ( vector_data & result , const matrix_data & matrix )
{
...
inline void shy_iphone_platform :: matrix_get_origin ( vector_data & result , const matrix_data & matrix )
{
...
inline void shy_iphone_platform :: matrix_identity ( matrix_data & matrix )
{
    for ( int i = 0 ; i < 16 ; i ++ )
    {
...
inline void shy_iphone_platform :: matrix_inverse_rotation_translation ( matrix_data & matrix )
{
    vector_data axis_x ;
    vector_data axis_y ;
    vector_data axis_z ;
