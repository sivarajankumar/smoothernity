...
public :
    ...
    {
        friend class shy_iphone_platform ;
        friend class shy_iphone_platform_utility ;
    public :
        vertex_data ( ) ;
    private :
        GLfloat _position [ 3 ] ;
...
class shy_iphone_platform_utility
{
public :
    ...
    static int _touch_occured ;
    static float _touch_x ;
    static float _touch_y ;

    static shy_iphone_platform :: vertex_data _reference_vertex ;
...
#include "iphone_platform_array.hpp"
#include "iphone_platform_condition.hpp"
