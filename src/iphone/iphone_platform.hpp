...
#include "iphone_platform_touch_insider.hpp"
...
public :
    ...
    typedef shy_iphone_platform_touch_insider < shy_iphone_platform_insider > platform_touch_insider ;
    ...
    typedef shy_iphone_platform_touch < shy_iphone_platform_insider > platform_touch ;
