...
template < typename platform_insider >
class shy_iphone_platform_render
{
    friend class shy_iphone_platform_render_insider < platform_insider > ;
...
public :
    ...
    {
        friend class shy_iphone_platform_render ;
    public :
    ...
    {
        friend class shy_iphone_platform_render ;
        friend class shy_iphone_platform_insider ;
    public :
        vertex_data ( ) ;
    private :
        GLfloat _position [ 3 ] ;
...
template < typename platform_insider >
shy_iphone_platform_render < platform_insider > :: shy_iphone_platform_render ( )
: _texture_loader ( 0 )
, _aspect_width ( 1 )
, _aspect_height ( 1 )
...
template < typename platform_insider >
shy_iphone_platform_render < platform_insider > :: render_index_buffer_id :: render_index_buffer_id ( )
: _buffer_id ( GLuint ( platform_insider :: uninitialized_value ) )
{
}
    
template < typename platform_insider >
shy_iphone_platform_render < platform_insider > :: render_vertex_buffer_id :: render_vertex_buffer_id ( )
: _buffer_id ( GLuint ( platform_insider :: uninitialized_value ) )
{
}

template < typename platform_insider >
shy_iphone_platform_render < platform_insider > :: render_texture_id :: render_texture_id ( )
: _texture_id ( GLuint ( platform_insider :: uninitialized_value ) )
{
}

template < typename platform_insider >
shy_iphone_platform_render < platform_insider > :: texture_resource_id :: texture_resource_id ( )
: _resource_id ( platform_insider :: uninitialized_value )
{
}
	
template < typename platform_insider >
shy_iphone_platform_render < platform_insider > :: render_vertex_buffer_mapped_data :: render_vertex_buffer_mapped_data ( )
: _data ( ( void * ) platform_insider :: uninitialized_value )
{
}

template < typename platform_insider >
shy_iphone_platform_render < platform_insider > :: render_index_buffer_mapped_data :: render_index_buffer_mapped_data ( )
: _data ( ( void * ) platform_insider :: uninitialized_value )
{
}

template < typename platform_insider >
shy_iphone_platform_render < platform_insider > :: texel_data :: texel_data ( )
{
    for ( int i = 0 ; i < 4 ; i ++ )
...
template < typename platform_insider >
shy_iphone_platform_render < platform_insider > :: vertex_data :: vertex_data ( )
{
    for ( int i = 0 ; i < 3 ; i ++ )
...
template < typename platform_insider >
shy_iphone_platform_render < platform_insider > :: index_data :: index_data ( )
: _index ( ( GLushort ) platform_insider :: uninitialized_value )
{
}

template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: enable_face_culling ( )
{
    glEnable ( GL_CULL_FACE ) ;
}

template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: enable_depth_test ( )
{
    glEnable ( GL_DEPTH_TEST ) ;
}

template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: disable_depth_test ( )
{
    glDisable ( GL_DEPTH_TEST ) ;
}

template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: blend_disable ( )
{
    glDisable ( GL_BLEND ) ;
}

template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: blend_src_alpha_dst_one_minus_alpha ( )
{
    glEnable ( GL_BLEND ) ;
...
template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: enable_texturing ( )
{
	glEnable ( GL_TEXTURE_2D ) ;
}

template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: disable_texturing ( )
{
	glDisable ( GL_TEXTURE_2D ) ;
}

template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: texture_mode_modulate ( )
{
    glTexEnvf ( GL_TEXTURE_ENV , GL_TEXTURE_ENV_MODE , GL_MODULATE ) ;
}

template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: fog_disable ( )
{
    glDisable ( GL_FOG ) ;
}

template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: fog_linear 
    ( num_fract near 
    , num_fract far 
    , num_fract r 
    , num_fract g 
...
template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: use_texture ( render_texture_id arg_texture_id )
{
    glBindTexture ( GL_TEXTURE_2D , arg_texture_id . _texture_id ) ;
}

template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: set_texel_color 
...
template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: create_texture_resource_id ( texture_resource_id & resource_id , num_whole resource_index )
{
...
template < typename platform_insider >
template < typename texels_array >
inline void shy_iphone_platform_render < platform_insider > :: load_texture_resource
...
template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: texture_loader_ready ( num_whole & is_ready )
{
    platform_math_insider :: num_whole_value_set ( is_ready , [ _texture_loader loader_ready ] ) ;
}

template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: clear_screen ( num_fract r , num_fract g , num_fract b )
{
    float r_float ;
    float g_float ;
    float b_float ;
...
template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: projection_frustum 
    ( num_fract left 
    , num_fract right 
    , num_fract bottom 
    , num_fract top 
    ...
    )
{
    ...
    glLoadIdentity ( ) ;
    glFrustumf ( left_float , right_float , bottom_float , top_float , near_float , far_float ) ;
    glMatrixMode ( GL_MODELVIEW ) ;
}

template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: projection_ortho 
    ( num_fract left 
    , num_fract right 
    , num_fract bottom 
    , num_fract top 
    ...
    )
{
    ...
    glMatrixMode ( GL_PROJECTION ) ;
    glLoadIdentity ( ) ;
    glOrthof ( left_float , right_float , bottom_float , top_float , near_float , far_float ) ;
    glMatrixMode ( GL_MODELVIEW ) ;
}

template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: create_vertex_buffer ( render_vertex_buffer_id & arg_buffer_id , num_whole elements )
{
...
template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: map_vertex_buffer
...
template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: mapped_vertex_buffer_element
    ( typename platform_pointer :: template pointer < vertex_data > & ptr 
    , render_vertex_buffer_mapped_data data
    , num_whole index
    )
...
template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: set_vertex_position ( vertex_data & vertex , num_fract x , num_fract y , num_fract z )
{
...
template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: set_vertex_tex_coord ( vertex_data & vertex , num_fract u , num_fract v )
{
...
template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: set_vertex_color 
...
template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: create_index_buffer ( render_index_buffer_id & arg_buffer_id , num_whole elements )
{
    glGenBuffers ( 1 , & arg_buffer_id . _buffer_id ) ;
...
template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: mapped_index_buffer_element
    ( typename platform_pointer :: template pointer < index_data > & ptr 
    , render_index_buffer_mapped_data data
    , num_whole index
    )
...
template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: set_index_value ( index_data & data , num_whole index )
{
    int index_int = 0 ;
    platform_math_insider :: num_whole_value_get ( index_int , index ) ;
...
template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: matrix_identity ( )
{
    glLoadIdentity ( ) ;
}

template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: matrix_load ( const matrix_data & matrix )
{
...
template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: matrix_mult ( const matrix_data & matrix )
{
    const float * elements = 0 ;
    platform_matrix_insider :: elements_ptr ( elements , matrix ) ;
...
template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: matrix_push ( )
{
    glPushMatrix ( ) ;
}

template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: matrix_pop ( )
{
    glPopMatrix ( ) ;
}

template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: draw_triangle_strip 
...
template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: draw_triangle_fan
    ( render_vertex_buffer_id vertices_buffer , render_index_buffer_id indices_buffer , num_whole indices_count )
{
    int indices_count_int = 0 ;
    platform_math_insider :: num_whole_value_get ( indices_count_int , indices_count ) ;
...
template < typename platform_insider >
inline void shy_iphone_platform_render < platform_insider > :: get_aspect_width ( num_fract & result )
{
