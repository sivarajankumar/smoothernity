...
template < typename platform_insider >
class shy_iphone_platform_sound
{
    friend class shy_iphone_platform_sound_insider < platform_insider > ;
...
public :
    ...
    {
        friend class shy_iphone_platform_sound ;
    public :
        mono_sound_sample ( ) ;
    private :
        ALubyte _value ;
...
template < typename platform_insider >
shy_iphone_platform_sound < platform_insider > :: shy_iphone_platform_sound ( )
: _sound_loader ( 0 )
{
}

template < typename platform_insider >
shy_iphone_platform_sound < platform_insider > :: mono_sound_sample :: mono_sound_sample ( )
: _value ( ( GLubyte ) platform_insider :: uninitialized_value )
{
}
    
template < typename platform_insider >
shy_iphone_platform_sound < platform_insider > :: stereo_sound_sample :: stereo_sound_sample ( )
...
template < typename platform_insider >
shy_iphone_platform_sound < platform_insider > :: sound_buffer_id :: sound_buffer_id ( )
: _buffer_id ( ALuint ( platform_insider :: uninitialized_value ) )
{
}
    
template < typename platform_insider >
shy_iphone_platform_sound < platform_insider > :: sound_source_id :: sound_source_id ( )
: _source_id ( ALuint ( platform_insider :: uninitialized_value ) )
{
}
    
template < typename platform_insider >
shy_iphone_platform_sound < platform_insider > :: stereo_sound_resource_id :: stereo_sound_resource_id ( )
: _resource_id ( platform_insider :: uninitialized_value )
{
}

template < typename platform_insider >
inline void shy_iphone_platform_sound < platform_insider > :: set_listener_position ( vector_data position )
{
    float x ;
    float y ;
    float z ;
...
template < typename platform_insider >
inline void shy_iphone_platform_sound < platform_insider > :: set_listener_velocity ( vector_data velocity )
{
    float x ;
    float y ;
    float z ;
...
template < typename platform_insider >
inline void shy_iphone_platform_sound < platform_insider > :: set_listener_orientation ( vector_data look_at , vector_data up )
{
    float look_at_x ;
    float look_at_y ;
    float look_at_z ;
...
template < typename platform_insider >
inline void shy_iphone_platform_sound < platform_insider > :: set_sample_value ( mono_sound_sample & sample , num_fract value )
{
    float value_float = 0 ;
...
template < typename platform_insider >
inline void shy_iphone_platform_sound < platform_insider > :: create_stereo_resource_id 
...
template < typename platform_insider >
template < typename samples_array >
inline void shy_iphone_platform_sound < platform_insider > :: load_stereo_sample_data
...
template < typename platform_insider >
inline void shy_iphone_platform_sound < platform_insider > :: loader_ready ( num_whole & result )
{
    platform_math_insider :: num_whole_value_set ( result , [ _sound_loader loader_ready ] ) ;
}

template < typename platform_insider >
inline void shy_iphone_platform_sound < platform_insider > :: loaded_samples_count ( num_whole & result )
{
...
template < typename platform_insider >
template < typename samples_array >
inline void shy_iphone_platform_sound < platform_insider > :: create_mono_buffer 
...
template < typename platform_insider >
template < typename samples_array >
inline void shy_iphone_platform_sound < platform_insider > :: create_stereo_buffer 
    ( sound_buffer_id & result
    , const samples_array & samples 
    , num_whole samples_count 
    )
...
template < typename platform_insider >
inline void shy_iphone_platform_sound < platform_insider > :: create_source ( sound_source_id & result )
{
    alGenSources ( 1 , & result . _source_id ) ;
}

template < typename platform_insider >
inline void shy_iphone_platform_sound < platform_insider > :: set_source_pitch ( const sound_source_id & source_id , num_fract pitch )
{
    float pitch_float = 0 ;
...
template < typename platform_insider >
inline void shy_iphone_platform_sound < platform_insider > :: set_source_gain ( const sound_source_id & source_id , num_fract gain )
{
    float gain_float = 0 ;
...
template < typename platform_insider >
inline void shy_iphone_platform_sound < platform_insider > :: set_source_position ( const sound_source_id & source_id , vector_data position )
{
    float x ;
    float y ;
    float z ;
...
template < typename platform_insider >
inline void shy_iphone_platform_sound < platform_insider > :: set_source_velocity ( const sound_source_id & source_id , vector_data velocity )
{
    float x ;
    float y ;
    float z ;
...
template < typename platform_insider >
inline void shy_iphone_platform_sound < platform_insider > :: set_source_buffer ( const sound_source_id & source_id , sound_buffer_id & buffer_id )
{
    alSourcei ( source_id . _source_id , AL_BUFFER , buffer_id . _buffer_id ) ;
}

template < typename platform_insider >
inline void shy_iphone_platform_sound < platform_insider > :: set_source_playback_looping ( const sound_source_id & source_id )
{
    alSourcei ( source_id . _source_id , AL_LOOPING , AL_TRUE ) ;
}

template < typename platform_insider >
inline void shy_iphone_platform_sound < platform_insider > :: set_source_playback_once ( const sound_source_id & source_id )
{
    alSourcei ( source_id . _source_id , AL_LOOPING , AL_FALSE ) ;
}

template < typename platform_insider >
inline void shy_iphone_platform_sound < platform_insider > :: source_play ( const sound_source_id & source_id )
{
    alSourcePlay ( source_id . _source_id ) ;
}

template < typename platform_insider >
inline void shy_iphone_platform_sound < platform_insider > :: source_stop ( const sound_source_id & source_id )
{
