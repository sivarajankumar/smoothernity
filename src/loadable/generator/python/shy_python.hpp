...
void shy_guts :: main_script ( so_called_lib_std_string & result )
{
    ...
    result . clear ( ) ;
    result += so_called_loadable_generator_consts :: autogenerated_python_file_begin ;
    ...
    result += "\n" ;
    result += so_called_loadable_generator_consts :: autogenerated_python_file_end ;
}

void shy_loadable_generator_python :: generate_file ( so_called_lib_std_string path , so_called_lib_std_string contents )
{
