...
#define shy_guts_bind_value(value) so_called_loadable_consts_binder_helper_value ( logic_fader , value )
...
void shy_loadable_consts_reflection_logic_fader :: prepare ( )
{
    shy_guts_bind_module ( logic_fader ) ;
