namespace shy_guts
{
    ...
    static void module_path ( so_called_lib_std_string & , so_called_lib_std_string ) ;
...
void shy_guts :: module_path ( so_called_lib_std_string & result , so_called_lib_std_string module_name )
{
    result . clear ( ) ;
...
void shy_loadable_consts_generator :: generate ( so_called_lib_std_string & result )
{
        ...
        )
    {
        ...
        shy_guts :: module_path ( module_path , module_name ) ;
