    ...
    #include "loadable/fsm/binder/helper/action/shy_action_injections.h"
    #include "loadable/fsm/binder/helper/input/shy_input_injections.h"
    #include "loadable/fsm/binder/helper/system/shy_system_injections.h"
