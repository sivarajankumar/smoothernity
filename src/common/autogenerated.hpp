...
class shy_logic_application_fsm_autogenerated
{
    ...
    typedef typename logic_application_fsm :: mediator_type mediator_type ;
    ...
    {
    public :
        virtual ~ _machine_amusement_generator_state_finished_type ( ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_amusement_generator_state_generating_type ( ) ;
    ...
    {
    public :
        virtual ~ _machine_amusement_generator_state_initial_type ( ) ;
        virtual _state_type & transition ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_amusement_performer_state_finished_type ( ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_amusement_performer_state_initial_type ( ) ;
        virtual _state_type & transition ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_amusement_performer_state_performing_type ( ) ;
        virtual void on_entry ( _state_environment_type & ) ;
        virtual void on_input ( _state_environment_type & ) ;
        virtual _state_type & transition ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_game_performer_state_initial_type ( ) ;
        virtual _state_type & transition ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_game_performer_state_performing_type ( ) ;
        virtual void on_entry ( _state_environment_type & ) ;
        virtual void on_input ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_generator_state_amusement_type ( ) ;
        virtual void on_entry ( _state_environment_type & ) ;
        virtual _state_type & transition ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_generator_state_game_type ( ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_generator_state_initial_type ( ) ;
        virtual _state_type & transition ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_generator_state_main_menu_type ( ) ;
        virtual void on_entry ( _state_environment_type & ) ;
        virtual _state_type & transition ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_generator_state_text_type ( ) ;
        virtual void on_entry ( _state_environment_type & ) ;
        virtual _state_type & transition ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_generator_state_title_type ( ) ;
        virtual void on_entry ( _state_environment_type & ) ;
        virtual _state_type & transition ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_main_menu_generator_state_finished_type ( ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_main_menu_generator_state_generating_type ( ) ;
        virtual void on_entry ( _state_environment_type & ) ;
        virtual void on_input ( _state_environment_type & ) ;
        virtual _state_type & transition ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_main_menu_generator_state_initial_type ( ) ;
        virtual _state_type & transition ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_main_menu_performer_state_finished_type ( ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_main_menu_performer_state_initial_type ( ) ;
        virtual _state_type & transition ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_main_menu_performer_state_performing_type ( ) ;
        virtual void on_entry ( _state_environment_type & ) ;
        virtual void on_input ( _state_environment_type & ) ;
        virtual _state_type & transition ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_performer_state_amusement_type ( ) ;
        virtual void on_entry ( _state_environment_type & ) ;
        virtual _state_type & transition ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_performer_state_game_type ( ) ;
        virtual void on_entry ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_performer_state_initial_type ( ) ;
        virtual _state_type & transition ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_performer_state_main_menu_type ( ) ;
        virtual void on_entry ( _state_environment_type & ) ;
        virtual _state_type & transition ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_performer_state_title_type ( ) ;
        virtual void on_entry ( _state_environment_type & ) ;
        virtual _state_type & transition ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_text_generator_state_finished_type ( ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_text_generator_state_generating_type ( ) ;
        virtual void on_entry ( _state_environment_type & ) ;
        virtual void on_input ( _state_environment_type & ) ;
        virtual _state_type & transition ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_text_generator_state_initial_type ( ) ;
        virtual _state_type & transition ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_title_generator_state_finished_type ( ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_title_generator_state_generating_type ( ) ;
        virtual void on_entry ( _state_environment_type & ) ;
        virtual void on_input ( _state_environment_type & ) ;
        virtual _state_type & transition ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_title_generator_state_initial_type ( ) ;
        virtual _state_type & transition ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_title_performer_state_finished_type ( ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_title_performer_state_initial_type ( ) ;
        virtual _state_type & transition ( _state_environment_type & ) ;
    } ;
    ...
    {
    public :
        virtual ~ _machine_title_performer_state_performing_type ( ) ;
        virtual void on_input ( _state_environment_type & ) ;
        virtual _state_type & transition ( _state_environment_type & ) ;
    } ;
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_amusement_generator_state_finished_type :: ~ _machine_amusement_generator_state_finished_type ( )
{
}

template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_amusement_generator_state_generating_type :: ~ _machine_amusement_generator_state_generating_type ( )
{
}
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_amusement_generator_state_initial_type :: ~ _machine_amusement_generator_state_initial_type ( )
{
}
...
{
    if ( platform_conditions :: whole_is_true ( env . inputs . get ( ) . stage_amusement_enabled ) && platform_conditions :: whole_is_true ( env . autogenerated_inputs . get ( ) . machine_amusement_generator_command_start ) )
    {
        return env . states . get ( ) . amusement_generator_state_generating ;
    }
    else if ( platform_conditions :: whole_is_true ( env . inputs . get ( ) . stage_amusement_disabled ) && platform_conditions :: whole_is_true ( env . autogenerated_inputs . get ( ) . machine_amusement_generator_command_start ) )
    {
        return env . states . get ( ) . amusement_generator_state_finished ;
    }
    else
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_amusement_performer_state_finished_type :: ~ _machine_amusement_performer_state_finished_type ( )
{
}

template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_amusement_performer_state_initial_type :: ~ _machine_amusement_performer_state_initial_type ( )
{
}
...
{
    if ( platform_conditions :: whole_is_true ( env . inputs . get ( ) . stage_amusement_enabled ) && platform_conditions :: whole_is_true ( env . autogenerated_inputs . get ( ) . machine_amusement_performer_command_start ) )
    {
        return env . states . get ( ) . amusement_performer_state_performing ;
    }
    else if ( platform_conditions :: whole_is_true ( env . inputs . get ( ) . stage_amusement_disabled ) && platform_conditions :: whole_is_true ( env . autogenerated_inputs . get ( ) . machine_amusement_performer_command_start ) )
    {
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_amusement_performer_state_performing_type :: ~ _machine_amusement_performer_state_performing_type ( )
{
}
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_game_performer_state_initial_type :: ~ _machine_game_performer_state_initial_type ( )
{
}
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_game_performer_state_performing_type :: ~ _machine_game_performer_state_performing_type ( )
{
}
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_generator_state_amusement_type :: ~ _machine_generator_state_amusement_type ( )
{
}
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_generator_state_game_type :: ~ _machine_generator_state_game_type ( )
{
}

template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_generator_state_initial_type :: ~ _machine_generator_state_initial_type ( )
{
}
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_generator_state_main_menu_type :: ~ _machine_generator_state_main_menu_type ( )
{
}
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_generator_state_text_type :: ~ _machine_generator_state_text_type ( )
{
}
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_generator_state_title_type :: ~ _machine_generator_state_title_type ( )
{
}
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_main_menu_generator_state_finished_type :: ~ _machine_main_menu_generator_state_finished_type ( )
{
}

template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_main_menu_generator_state_generating_type :: ~ _machine_main_menu_generator_state_generating_type ( )
{
}
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_main_menu_generator_state_initial_type :: ~ _machine_main_menu_generator_state_initial_type ( )
{
}
...
{
    if ( platform_conditions :: whole_is_true ( env . inputs . get ( ) . stage_main_menu_enabled ) && platform_conditions :: whole_is_true ( env . autogenerated_inputs . get ( ) . machine_main_menu_generator_command_start ) )
    {
        return env . states . get ( ) . main_menu_generator_state_generating ;
    }
    else if ( platform_conditions :: whole_is_true ( env . inputs . get ( ) . stage_main_menu_disabled ) && platform_conditions :: whole_is_true ( env . autogenerated_inputs . get ( ) . machine_main_menu_generator_command_start ) )
    {
        return env . states . get ( ) . main_menu_generator_state_finished ;
    }
    else
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_main_menu_performer_state_finished_type :: ~ _machine_main_menu_performer_state_finished_type ( )
{
}

template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_main_menu_performer_state_initial_type :: ~ _machine_main_menu_performer_state_initial_type ( )
{
}
...
{
    if ( platform_conditions :: whole_is_true ( env . inputs . get ( ) . stage_main_menu_enabled ) && platform_conditions :: whole_is_true ( env . autogenerated_inputs . get ( ) . machine_main_menu_performer_command_start ) )
    {
        return env . states . get ( ) . main_menu_performer_state_performing ;
    }
    else if ( platform_conditions :: whole_is_true ( env . inputs . get ( ) . stage_main_menu_disabled ) && platform_conditions :: whole_is_true ( env . autogenerated_inputs . get ( ) . machine_main_menu_performer_command_start ) )
    {
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_main_menu_performer_state_performing_type :: ~ _machine_main_menu_performer_state_performing_type ( )
{
}
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_performer_state_amusement_type :: ~ _machine_performer_state_amusement_type ( )
{
}
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_performer_state_game_type :: ~ _machine_performer_state_game_type ( )
{
}
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_performer_state_initial_type :: ~ _machine_performer_state_initial_type ( )
{
}
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_performer_state_main_menu_type :: ~ _machine_performer_state_main_menu_type ( )
{
}
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_performer_state_title_type :: ~ _machine_performer_state_title_type ( )
{
}
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_text_generator_state_finished_type :: ~ _machine_text_generator_state_finished_type ( )
{
}

template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_text_generator_state_generating_type :: ~ _machine_text_generator_state_generating_type ( )
{
}
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_text_generator_state_initial_type :: ~ _machine_text_generator_state_initial_type ( )
{
}
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_title_generator_state_finished_type :: ~ _machine_title_generator_state_finished_type ( )
{
}

template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_title_generator_state_generating_type :: ~ _machine_title_generator_state_generating_type ( )
{
}
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_title_generator_state_initial_type :: ~ _machine_title_generator_state_initial_type ( )
{
}
...
{
    if ( platform_conditions :: whole_is_true ( env . inputs . get ( ) . stage_title_enabled ) && platform_conditions :: whole_is_true ( env . autogenerated_inputs . get ( ) . machine_title_generator_command_start ) )
    {
        return env . states . get ( ) . title_generator_state_generating ;
    }
    else if ( platform_conditions :: whole_is_true ( env . inputs . get ( ) . stage_title_disabled ) && platform_conditions :: whole_is_true ( env . autogenerated_inputs . get ( ) . machine_title_generator_command_start ) )
    {
        return env . states . get ( ) . title_generator_state_finished ;
    }
    else
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_title_performer_state_finished_type :: ~ _machine_title_performer_state_finished_type ( )
{
}

template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_title_performer_state_initial_type :: ~ _machine_title_performer_state_initial_type ( )
{
}
...
{
    if ( platform_conditions :: whole_is_true ( env . inputs . get ( ) . stage_title_enabled ) && platform_conditions :: whole_is_true ( env . autogenerated_inputs . get ( ) . machine_title_performer_command_start ) )
    {
        return env . states . get ( ) . title_performer_state_performing ;
    }
    else if ( platform_conditions :: whole_is_true ( env . inputs . get ( ) . stage_title_disabled ) && platform_conditions :: whole_is_true ( env . autogenerated_inputs . get ( ) . machine_title_performer_command_start ) )
    {
...
template < typename logic_application_fsm >
shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _machine_title_performer_state_performing_type :: ~ _machine_title_performer_state_performing_type ( )
{
}
...
template < typename logic_application_fsm >
void shy_logic_application_fsm_autogenerated < logic_application_fsm > :: set_mediator ( typename platform_pointer :: template pointer < mediator_type > )
{
}
...
template < typename logic_application_fsm >
void shy_logic_application_fsm_autogenerated < logic_application_fsm > :: init ( )
{
}
