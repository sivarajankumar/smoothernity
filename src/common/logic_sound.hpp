...
void shy_logic_sound < mediator > :: _create_mono_sound ( )
{
    ...
    num_fract fract_samples_per_second ;
    
    platform :: math_make_num_whole ( next_sample , 0 ) ;
    platform :: math_make_num_fract ( fract_samples_per_second , platform :: mono_sound_samples_per_second , 1 ) ;
    
    for ( platform :: math_make_num_whole ( i , 0 ) 
        , platform :: math_make_num_whole ( i_max , _max_mono_sound_samples )
        ...
        )
    {
        ...
        platform :: memory_pointer_offset ( sample_ptr , _mono_sound_data , i ) ;
