template 
    ...
    , template < typename mediator > class _logic_blanket_animation_appear
    , template < typename mediator > class _logic_blanket_animation_disappear
    , template < typename mediator > class _logic_blanket_animation_fit
...
public :
    ...
    public :
        ...
        typedef _logic_blanket_animation_appear < mediator > logic_blanket_animation_appear ;
        typedef _logic_blanket_animation_disappear < mediator > logic_blanket_animation_disappear ;
        typedef _logic_blanket_animation_fit < mediator > logic_blanket_animation_fit ;
        ...
        typedef _logic_door_animation_appear < mediator > logic_door_animation_appear ;
...
template 
    ...
    , template < typename _mediator > class _logic_blanket_animation_appear
    , template < typename _mediator > class _logic_blanket_animation_disappear
    , template < typename _mediator > class _logic_blanket_animation_fit
...
public :
    ...
    typedef typename platform_scheduler :: template module_wrapper < _logic_blanket_animation_disappear > scheduled_logic_blanket_animation_disappear ;
    typedef typename platform_scheduler :: template module_wrapper < _logic_blanket_animation_fit > scheduled_logic_blanket_animation_fit ;
    typedef typename platform_scheduler :: template module_wrapper < _logic_blanket_mesh > scheduled_logic_blanket_mesh ;
    typedef typename platform_scheduler :: template module_wrapper < _logic_blanket_placement > scheduled_logic_blanket_placement ;
    typedef typename platform_scheduler :: template module_wrapper < _logic_blanket_renderer > scheduled_logic_blanket_renderer ;
    ...
    typedef typename platform_scheduler :: template module_wrapper < _logic_door_animation > scheduled_logic_door_animation ;
    typedef typename platform_scheduler :: template module_wrapper < _logic_door_animation_appear > scheduled_logic_door_animation_appear ;
    typedef typename platform_scheduler :: template module_wrapper < _logic_door_mesh > scheduled_logic_door_mesh ;
    typedef typename platform_scheduler :: template module_wrapper < _logic_door_placement > scheduled_logic_door_placement ;
    typedef typename platform_scheduler :: template module_wrapper < _logic_door_renderer > scheduled_logic_door_renderer ;
    typedef typename platform_scheduler :: template module_wrapper < _logic_door_texture > scheduled_logic_door_texture ;
    ...
    typedef typename platform_scheduler :: template module_wrapper < _logic_ortho > scheduled_logic_ortho ;
    typedef typename platform_scheduler :: template module_wrapper < _logic_perspective > scheduled_logic_perspective ;
    ...
    typedef _mediator < mediator_types
        ...
        , scheduled_logic_blanket_animation_appear :: template scheduled_module
        , scheduled_logic_blanket_animation_disappear :: template scheduled_module
        , scheduled_logic_blanket_animation_fit :: template scheduled_module
        ...
        , scheduled_logic_door_animation_appear :: template scheduled_module
        , _logic_door_animation_stateless
        , scheduled_logic_door_mesh :: template scheduled_module
        , scheduled_logic_door_placement :: template scheduled_module
        , scheduled_logic_door_renderer :: template scheduled_module
        , _logic_door_stateless
        , scheduled_logic_door_texture :: template scheduled_module
...
private :
    typedef typename aggregator_types :: fsm_collection fsm_collection ;
    ...
    typedef typename aggregator_types :: scheduled_logic_blanket_animation_disappear :: template scheduled_module < mediator_type > logic_blanket_animation_disappear ;
    typedef typename aggregator_types :: scheduled_logic_blanket_animation_fit :: template scheduled_module < mediator_type > logic_blanket_animation_fit ;
    typedef typename aggregator_types :: scheduled_logic_blanket_mesh :: template scheduled_module < mediator_type > logic_blanket_mesh ;
    typedef typename aggregator_types :: scheduled_logic_blanket_placement :: template scheduled_module < mediator_type > logic_blanket_placement ;
    typedef typename aggregator_types :: scheduled_logic_blanket_renderer :: template scheduled_module < mediator_type > logic_blanket_renderer ;
    ...
    typedef typename aggregator_types :: scheduled_logic_door_animation :: template scheduled_module < mediator_type > logic_door_animation ;
    typedef typename aggregator_types :: scheduled_logic_door_animation_appear :: template scheduled_module < mediator_type > logic_door_animation_appear ;
    typedef typename aggregator_types :: scheduled_logic_door_mesh :: template scheduled_module < mediator_type > logic_door_mesh ;
    typedef typename aggregator_types :: scheduled_logic_door_placement :: template scheduled_module < mediator_type > logic_door_placement ;
    ...
    typedef typename aggregator_types :: scheduled_logic_door_texture :: template scheduled_module < mediator_type > logic_door_texture ;
    ...
    typedef typename aggregator_types :: scheduled_logic_ortho :: template scheduled_module < mediator_type > logic_ortho ;
    typedef typename aggregator_types :: scheduled_logic_perspective :: template scheduled_module < mediator_type > logic_perspective ;
...
private :
    ...
    logic_door_stateless _logic_door_stateless ;
    ...
    logic_perspective_stateless _logic_perspective_stateless ;
...
: _mediator ( arg_platform , arg_fsm_collection )
{
    ...
    typename platform_pointer :: template pointer < logic_door_stateless > logic_door_stateless_ptr ;
    ...
    typename platform_pointer :: template pointer < logic_perspective_stateless > logic_perspective_stateless_ptr ;
    ...
    platform_pointer :: bind ( logic_door_stateless_ptr , _logic_door_stateless ) ;
    ...
    platform_pointer :: bind ( logic_perspective_stateless_ptr , _logic_perspective_stateless ) ;
    ...
    platform_scheduler :: register_module_in_scheduler ( logic_blanket_animation_disappear_ptr , scheduler_ptr ) ;
    platform_scheduler :: register_module_in_scheduler ( logic_blanket_animation_fit_ptr , scheduler_ptr ) ;
    platform_scheduler :: register_module_in_scheduler ( logic_blanket_mesh_ptr , scheduler_ptr ) ;
    platform_scheduler :: register_module_in_scheduler ( logic_blanket_placement_ptr , scheduler_ptr ) ;
    platform_scheduler :: register_module_in_scheduler ( logic_blanket_renderer_ptr , scheduler_ptr ) ;
    ...
    platform_scheduler :: register_module_in_scheduler ( logic_door_animation_ptr , scheduler_ptr ) ;
    platform_scheduler :: register_module_in_scheduler ( logic_door_animation_appear_ptr , scheduler_ptr ) ;
    platform_scheduler :: register_module_in_scheduler ( logic_door_mesh_ptr , scheduler_ptr ) ;
    platform_scheduler :: register_module_in_scheduler ( logic_door_placement_ptr , scheduler_ptr ) ;
    platform_scheduler :: register_module_in_scheduler ( logic_door_renderer_ptr , scheduler_ptr ) ;
    platform_scheduler :: register_module_in_scheduler ( logic_door_texture_ptr , scheduler_ptr ) ;
    ...
    platform_scheduler :: register_module_in_scheduler ( logic_ortho_ptr , scheduler_ptr ) ;
    platform_scheduler :: register_module_in_scheduler ( logic_perspective_ptr , scheduler_ptr ) ;
    ...
    _mediator . register_modules
        ...
        , logic_perspective_stateless_ptr
        , logic_room_ptr
        , logic_room_mesh_ptr
