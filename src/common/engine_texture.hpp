    ...
    ( texture_id arg_texture_id , num_whole x , num_whole y , const texel_data & texel )
{
    ...
    _texture_data * texture_ptr = 0 ;
    num_whole texel_index ;
    platform :: math_make_num_whole ( texel_index , _texture_size ) ;
    platform :: math_mul_whole_by ( texel_index , y ) ;
    platform :: math_add_to_whole ( texel_index , x ) ;
    platform :: memory_pointer_offset ( texture_ptr , _textures_datas , arg_texture_id . _texture_id ) ;
    platform :: memory_pointer_offset ( texel_ptr , texture_ptr -> texels , texel_index ) ;
    * texel_ptr = texel ;
}
