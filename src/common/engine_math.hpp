    ...
    ( vector_data & result , num_fract t , vector_data p0 , vector_data p1 , vector_data p2 , vector_data p3 )
{
    ...
    platform :: math_sub_fracts ( p0_coeff , t2_mul_2 , t3 ) ;
    platform :: math_sub_from_fract ( p0_coeff , t ) ;
    platform :: math_sub_fracts ( p1_coeff , platform :: fract_2 , t2_mul_5 ) ;
    platform :: math_sub_from_fract ( p1_coeff , t3_mul_3 ) ;
