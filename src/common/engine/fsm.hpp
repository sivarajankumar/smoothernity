...
public :
    ...
    template < typename fsm_state_environment_type , typename fsm_state_type >
    static void tick_single_fsm 
        ( fsm_state_environment_type & 
        , typename platform_pointer :: template pointer < fsm_state_type > & 
        ) ;
private :
    template < typename fsm_type , typename fsm_autogenerated_type >
...
void shy_engine_fsm < mediator > :: tick_single_fsm 
    ...
    , typename platform_pointer :: template pointer < fsm_state_type > & state 
    )
{
    typename platform_pointer :: template pointer < fsm_state_type > next_state ;
