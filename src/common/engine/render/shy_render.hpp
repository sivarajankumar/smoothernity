namespace shy_guts
{
    ...
    static so_called_type_platform_static_array_data < mesh_data , so_called_common_engine_render_consts :: max_meshes_int > meshes_datas ;
    static so_called_type_platform_static_array_data < so_called_type_platform_math_num_whole , so_called_common_engine_render_consts :: max_meshes_int > vacant_mesh_ids ;
    ...
    if ( so_called_platform_conditions :: whole_less_than_whole ( shy_guts :: next_vacant_mesh_id_index , so_called_common_engine_render_consts :: max_meshes ) )
    {
        ...
        if ( so_called_platform_conditions :: whole_greater_than_whole ( msg . vertices , shy_guts :: consts :: max_vertices ) )
        {
            ...
            if ( so_called_platform_conditions :: whole_is_true ( shy_guts :: consts :: trace_enabled ) )
                so_called_trace_common_engine_render :: mesh_too_many_vertices_error ( msg . vertices , shy_guts :: consts :: max_vertices ) ;
        }
        ...
        if ( so_called_platform_conditions :: whole_greater_than_whole ( msg . triangle_strip_indices , shy_guts :: consts :: max_indices ) )
        {
            ...
            if ( so_called_platform_conditions :: whole_is_true ( shy_guts :: consts :: trace_enabled ) )
                so_called_trace_common_engine_render :: mesh_too_many_indices_error ( msg . triangle_strip_indices , shy_guts :: consts :: max_indices ) ;
        }
        ...
        if ( so_called_platform_conditions :: whole_greater_than_whole ( msg . triangle_fan_indices , shy_guts :: consts :: max_indices ) )
        {
            ...
            if ( so_called_platform_conditions :: whole_is_true ( shy_guts :: consts :: trace_enabled ) )
                so_called_trace_common_engine_render :: mesh_too_many_indices_error ( msg . triangle_fan_indices , shy_guts :: consts :: max_indices ) ;
        }
        ...
        if ( so_called_platform_conditions :: whole_is_true ( shy_guts :: consts :: trace_enabled ) )
            so_called_trace_common_engine_render :: meshes_in_use ( shy_guts :: next_vacant_mesh_id_index , so_called_common_engine_render_consts :: max_meshes ) ;
    }
    else
    {
        created_mesh = so_called_common_engine_render_consts :: null_mesh ;
        if ( so_called_platform_conditions :: whole_is_true ( shy_guts :: consts :: trace_enabled ) )
            so_called_trace_common_engine_render :: meshes_overflow_error ( ) ;
    }
...
void _shy_common_engine_render :: receive ( so_called_message_common_engine_render_mesh_delete msg )
{
    if ( so_called_platform_conditions :: whole_less_than_whole ( msg . mesh . _mesh_id , so_called_common_engine_render_consts :: max_meshes ) )
    {
        if ( so_called_platform_conditions :: whole_greater_than_zero ( shy_guts :: next_vacant_mesh_id_index ) )
        {
            ...
            so_called_trace_common_engine_render :: meshes_underflow_error ( ) ;
    }
}
    ...
    if ( so_called_platform_conditions :: whole_less_than_whole ( msg . mesh . _mesh_id , so_called_common_engine_render_consts :: max_meshes ) )
    {
        ...
        if ( so_called_platform_conditions :: whole_is_false ( mesh . get ( ) . finalized ) )
        {
            if ( so_called_platform_conditions :: whole_less_than_whole ( msg . offset , mesh . get ( ) . triangle_fan_indices_count ) )
            {
                ...
                so_called_trace_common_engine_render :: mesh_index_out_of_range_error ( msg . offset , mesh . get ( ) . triangle_fan_indices_count ) ;
        }
        else if ( so_called_platform_conditions :: whole_is_true ( shy_guts :: consts :: trace_enabled ) )
            so_called_trace_common_engine_render :: trying_to_modify_finalized_mesh_error ( ) ;
    }
}
    ...
    if ( so_called_platform_conditions :: whole_less_than_whole ( msg . mesh . _mesh_id , so_called_common_engine_render_consts :: max_meshes ) )
    {
        ...
        if ( so_called_platform_conditions :: whole_is_false ( mesh . get ( ) . finalized ) )
        {
            if ( so_called_platform_conditions :: whole_less_than_whole ( msg . offset , mesh . get ( ) . triangle_strip_indices_count ) )
            {
                ...
                so_called_trace_common_engine_render :: mesh_index_out_of_range_error ( msg . offset , mesh . get ( ) . triangle_strip_indices_count ) ;
        }
        else if ( so_called_platform_conditions :: whole_is_true ( shy_guts :: consts :: trace_enabled ) )
            so_called_trace_common_engine_render :: trying_to_modify_finalized_mesh_error ( ) ;
    }
    ...
    if ( so_called_platform_conditions :: whole_less_than_whole ( msg . mesh . _mesh_id , so_called_common_engine_render_consts :: max_meshes ) )
    {
        ...
        if ( so_called_platform_conditions :: whole_is_false ( mesh . get ( ) . finalized ) )
        {
            if ( so_called_platform_conditions :: whole_less_than_whole ( msg . offset , mesh . get ( ) . vertices_count ) )
            {
                ...
                so_called_trace_common_engine_render :: mesh_vertex_out_of_range_error ( msg . offset , mesh . get ( ) . vertices_count ) ;
        }
        else if ( so_called_platform_conditions :: whole_is_true ( shy_guts :: consts :: trace_enabled ) )
            so_called_trace_common_engine_render :: trying_to_modify_finalized_mesh_error ( ) ;
    }
...
{
    so_called_type_common_engine_render_texture_id created_texture ;
    so_called_type_platform_math_num_whole whole_max_textures ;
    so_called_platform_math :: make_num_whole ( whole_max_textures , shy_guts :: consts :: max_textures ) ;
    ...
    else
    {
        ...
        if ( so_called_platform_conditions :: whole_is_true ( shy_guts :: consts :: trace_enabled ) )
            so_called_trace_common_engine_render :: textures_overflow_error ( ) ;
    }
