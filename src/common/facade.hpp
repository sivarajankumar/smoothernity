...
#include "logic/application/fsm_autogenerated.hpp"
...
template < typename platform , typename fsm_collection = shy_fsm_collection_autogenerated >
class shy_facade
{
...
template < typename platform , typename fsm_collection >
shy_facade < platform , fsm_collection > :: shy_facade ( typename platform_pointer :: template pointer < const platform > arg_platform )
: _aggregator ( arg_platform )
{
}

template < typename platform , typename fsm_collection >
void shy_facade < platform , fsm_collection > :: mediator_obj ( typename platform_pointer :: template pointer < mediator > & result )
{
    _aggregator . mediator_obj ( result ) ;
}

template < typename platform , typename fsm_collection >
void shy_facade < platform , fsm_collection > :: init ( )
{
    _aggregator . init ( ) ;
}

template < typename platform , typename fsm_collection >
void shy_facade < platform , fsm_collection > :: done ( )
{
    _aggregator . done ( ) ;
}

template < typename platform , typename fsm_collection >
void shy_facade < platform , fsm_collection > :: render ( )
{
    _aggregator . render ( ) ;
}

template < typename platform , typename fsm_collection >
void shy_facade < platform , fsm_collection > :: update ( )
{
    _aggregator . update ( ) ;
}

template < typename platform , typename fsm_collection >
void shy_facade < platform , fsm_collection > :: video_mode_changed ( )
{
