...
template < typename platform , typename fsm_collection >
void shy_composer < platform , fsm_collection > :: register_components
...
{
    _aggregator . register_components ( arg_platform , arg_fsm_collection ) ;
}

template < typename platform , typename fsm_collection >
void shy_composer < platform , fsm_collection > :: mediator_obj ( typename platform_pointer :: template pointer < mediator > & result )
{
    _aggregator . mediator_obj ( result ) ;
}

template < typename platform , typename fsm_collection >
void shy_composer < platform , fsm_collection > :: init ( )
{
    _aggregator . init ( ) ;
}

template < typename platform , typename fsm_collection >
void shy_composer < platform , fsm_collection > :: done ( )
{
    _aggregator . done ( ) ;
}

template < typename platform , typename fsm_collection >
void shy_composer < platform , fsm_collection > :: render ( )
{
    _aggregator . render ( ) ;
}

template < typename platform , typename fsm_collection >
void shy_composer < platform , fsm_collection > :: update ( )
{
    _aggregator . update ( ) ;
}

template < typename platform , typename fsm_collection >
void shy_composer < platform , fsm_collection > :: video_mode_changed ( )
{
