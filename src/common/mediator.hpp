...
public :
    ...
    typedef typename mediator_types :: template modules < shy_mediator > :: logic_main_menu_animation_stateless logic_main_menu_animation_stateless ;
    ...
    typedef typename mediator_types :: template modules < shy_mediator > :: logic_ortho_stateless logic_ortho_stateless ;
...
private :
    ...
    typedef typename mediator_types :: template modules < shy_mediator > :: logic_application_stateless :: logic_application_stateless_consts_type logic_application_stateless_consts_type ;
    ...
    typedef typename mediator_types :: template modules < shy_mediator > :: logic_fidget_stateless :: logic_fidget_stateless_consts_type logic_fidget_stateless_consts_type ;
    typedef typename mediator_types :: template modules < shy_mediator > :: logic_main_menu_animation_stateless :: logic_main_menu_animation_stateless_consts_type logic_main_menu_animation_stateless_consts_type ;
    typedef typename mediator_types :: template modules < shy_mediator > :: logic_main_menu_letters_animation_stateless :: logic_main_menu_letters_animation_stateless_consts_type logic_main_menu_letters_animation_stateless_consts_type ;
    ...
    typedef typename mediator_types :: template modules < shy_mediator > :: logic_ortho_stateless :: logic_ortho_stateless_consts_type logic_ortho_stateless_consts_type ;
...
public :
    ...
    void logic_fidget_stateless_consts ( typename platform_pointer :: template pointer < const logic_fidget_stateless_consts_type > & ) ;
    void logic_main_menu_animation_stateless_consts ( typename platform_pointer :: template pointer < const logic_main_menu_animation_stateless_consts_type > & ) ;
    void logic_main_menu_letters_animation_stateless_consts ( typename platform_pointer :: template pointer < const logic_main_menu_letters_animation_stateless_consts_type > & ) ;
    ...
    void logic_ortho_stateless_consts ( typename platform_pointer :: template pointer < const logic_ortho_stateless_consts_type > & ) ;
    ...
    void register_modules
        ...
        , typename platform_pointer :: template pointer < logic_application_stateless >
        ...
        , typename platform_pointer :: template pointer < logic_fidget_stateless >
        ...
        , typename platform_pointer :: template pointer < logic_main_menu_animation_stateless >
        ...
        , typename platform_pointer :: template pointer < logic_main_menu_letters_animation_stateless >
        ...
        , typename platform_pointer :: template pointer < logic_main_menu_selection_animation_stateless >
        ...
        , typename platform_pointer :: template pointer < logic_ortho_stateless >
        , typename platform_pointer :: template pointer < logic_perspective >
        , typename platform_pointer :: template pointer < logic_perspective_stateless >
        ...
        , typename platform_pointer :: template pointer < logic_room_stateless >
...
private :
    ...
    typename platform_pointer :: template pointer < logic_main_menu_animation_stateless > _logic_main_menu_animation_stateless ;
    typename platform_pointer :: template pointer < logic_main_menu_letters_animation_stateless > _logic_main_menu_letters_animation_stateless ;
    ...
    typename platform_pointer :: template pointer < logic_ortho_stateless > _logic_ortho_stateless ;
    ...
    )
{
    ...
    _fsm_collection = arg_fsm_collection ;
}
...
void shy_mediator < mediator_types > :: register_modules
    ...
    , typename platform_pointer :: template pointer < logic_main_menu_animation_stateless > arg_logic_main_menu_animation_stateless
    ...
    , typename platform_pointer :: template pointer < logic_main_menu_letters_animation_stateless > arg_logic_main_menu_letters_animation_stateless
    ...
    , typename platform_pointer :: template pointer < logic_main_menu_selection_animation_stateless > arg_logic_main_menu_selection_animation_stateless
    ...
    , typename platform_pointer :: template pointer < logic_ortho_stateless > arg_logic_ortho_stateless
    , typename platform_pointer :: template pointer < logic_perspective > arg_logic_perspective
    , typename platform_pointer :: template pointer < logic_perspective_stateless > arg_logic_perspective_stateless
    ...
    , typename platform_pointer :: template pointer < logic_room_stateless > arg_logic_room_stateless
    ...
    )
{
    ...
    _logic_main_menu_animation_stateless = arg_logic_main_menu_animation_stateless ;
    _logic_main_menu_letters_animation_stateless = arg_logic_main_menu_letters_animation_stateless ;
    ...
    _logic_ortho_stateless = arg_logic_ortho_stateless ;
...
template < typename mediator_types >
void shy_mediator < mediator_types > :: fsm_collection_obj ( typename platform_pointer :: template pointer < fsm_collection > & result )
{
    result = _fsm_collection ;
}
...
template < typename mediator_types >
void shy_mediator < mediator_types > :: logic_application_stateless_consts ( typename platform_pointer :: template pointer < const logic_application_stateless_consts_type > & result )
{
    platform_pointer :: bind ( result , _logic_application_stateless . get ( ) . logic_application_stateless_consts ) ;
}
...
template < typename mediator_types >
void shy_mediator < mediator_types > :: logic_fidget_stateless_consts ( typename platform_pointer :: template pointer < const logic_fidget_stateless_consts_type > & result )
{
    platform_pointer :: bind ( result , _logic_fidget_stateless . get ( ) . logic_fidget_stateless_consts ) ;
}

template < typename mediator_types >
void shy_mediator < mediator_types > :: logic_main_menu_animation_stateless_consts ( typename platform_pointer :: template pointer < const logic_main_menu_animation_stateless_consts_type > & result )
{
    platform_pointer :: bind ( result , _logic_main_menu_animation_stateless . get ( ) . logic_main_menu_animation_stateless_consts ) ;
}

template < typename mediator_types >
void shy_mediator < mediator_types > :: logic_main_menu_letters_animation_stateless_consts ( typename platform_pointer :: template pointer < const logic_main_menu_letters_animation_stateless_consts_type > & result )
{
    platform_pointer :: bind ( result , _logic_main_menu_letters_animation_stateless . get ( ) . logic_main_menu_letters_animation_stateless_consts ) ;
}
...
template < typename mediator_types >
void shy_mediator < mediator_types > :: logic_main_menu_selection_animation_stateless_consts ( typename platform_pointer :: template pointer < const logic_main_menu_selection_animation_stateless_consts_type > & result )
{
    platform_pointer :: bind ( result , _logic_main_menu_selection_animation_stateless . get ( ) . logic_main_menu_selection_animation_stateless_consts ) ;
}
...
template < typename mediator_types >
void shy_mediator < mediator_types > :: logic_ortho_stateless_consts ( typename platform_pointer :: template pointer < const logic_ortho_stateless_consts_type > & result )
{
    platform_pointer :: bind ( result , _logic_ortho_stateless . get ( ) . logic_ortho_stateless_consts ) ;
}

template < typename mediator_types >
void shy_mediator < mediator_types > :: logic_perspective_stateless_consts ( typename platform_pointer :: template pointer < const logic_perspective_stateless_consts_type > & result )
{
    platform_pointer :: bind ( result , _logic_perspective_stateless . get ( ) . logic_perspective_stateless_consts ) ;
}

template < typename mediator_types >
void shy_mediator < mediator_types > :: logic_room_stateless_consts ( typename platform_pointer :: template pointer < const logic_room_stateless_consts_type > & result )
{
    platform_pointer :: bind ( result , _logic_room_stateless . get ( ) . logic_room_stateless_consts ) ;
}
