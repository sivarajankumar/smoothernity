...
void shy_guts :: compute_vertical_scale ( )
{
    ...
    so_called_platform_math_num_fract_type vertical_scale_time_from_begin_to_middle ;
    so_called_platform_math_num_fract_type vertical_scale_time_from_middle_to_end ;
    so_called_platform_math_num_fract_type time_begin ;
...
{
    so_called_common_logic_main_menu_selection_animation_appear_transform_reply_message msg ;
    ...
    so_called_common_logic_main_menu_selection_animation_appear_transform_reply_sender :: send ( msg ) ;
}

void _shy_common_logic_main_menu_selection_animation_appear :: receive ( so_called_common_init_message )
{
...
void _shy_common_logic_main_menu_selection_animation_appear :: receive ( so_called_common_logic_main_menu_selection_animation_appear_start_message )
{
    shy_guts :: logic_main_menu_update_state :: started = so_called_platform_math_consts :: whole_true ;
    shy_guts :: logic_main_menu_update_state :: time = so_called_platform_math_consts :: fract_0 ;
}

void _shy_common_logic_main_menu_selection_animation_appear :: receive ( so_called_common_logic_main_menu_selection_animation_appear_transform_request_message )
{
...
void _shy_common_logic_main_menu_selection_animation_appear :: receive ( so_called_common_logic_main_menu_update_message )
{
    if ( so_called_platform_conditions :: whole_is_true ( shy_guts :: logic_main_menu_update_state :: started ) )
    {
        ...
        {
            shy_guts :: logic_main_menu_update_state :: started = so_called_platform_math_consts :: whole_false ;
            so_called_common_logic_main_menu_selection_animation_appear_finished_sender :: send ( so_called_common_logic_main_menu_selection_animation_appear_finished_message ( ) ) ;
        }
