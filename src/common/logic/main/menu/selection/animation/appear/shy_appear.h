...
public :
    ...
    static void receive ( so_called_common_logic_main_menu_selection_animation_appear_start_message ) ;
    static void receive ( so_called_common_logic_main_menu_selection_animation_appear_transform_request_message ) ;
