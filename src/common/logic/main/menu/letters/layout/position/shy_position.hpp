namespace shy_guts
{
    namespace logic_main_menu_letters_layout_position_state
    {
        ...
        static so_called_common_engine_rect_type decorated_row_rect ;
        static so_called_common_engine_rect_type letter_rect ;
        static so_called_platform_vector_data_type letter_position ;
    }
