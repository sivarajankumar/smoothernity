...
void _shy_common_logic_main_menu_letters_meshes_destroyer :: receive ( so_called_common_init_message )
{
    shy_guts :: iteration_in_progress = so_called_platform_math_consts :: whole_false ;
}

void _shy_common_logic_main_menu_letters_meshes_destroyer :: receive ( so_called_common_logic_main_menu_letters_meshes_destroy_request_message )
{
...
void _shy_common_logic_main_menu_letters_meshes_destroyer :: receive ( so_called_common_logic_main_menu_letters_meshes_iterate_finished_message )
{
    if ( so_called_platform_conditions :: whole_is_true ( shy_guts :: iteration_in_progress ) )
    {
        shy_guts :: iteration_in_progress = so_called_platform_math_consts :: whole_false ;
        so_called_common_logic_main_menu_letters_meshes_destroy_reply_sender :: send ( so_called_common_logic_main_menu_letters_meshes_destroy_reply_message ( ) ) ;
    }
}

void _shy_common_logic_main_menu_letters_meshes_destroyer :: receive ( so_called_common_logic_main_menu_letters_meshes_iteration_message msg )
{
    if ( so_called_platform_conditions :: whole_is_true ( shy_guts :: iteration_in_progress ) )
    {
        so_called_common_engine_render_mesh_delete_message delete_msg ;
