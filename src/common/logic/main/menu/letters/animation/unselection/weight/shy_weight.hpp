...
{
    so_called_common_logic_main_menu_letters_animation_unselection_weight_reply_message msg ;
    ...
    so_called_common_logic_main_menu_letters_animation_unselection_weight_reply_sender :: send ( msg ) ;
}
...
void _shy_common_logic_main_menu_letters_animation_unselection_weight :: receive ( so_called_common_logic_main_menu_letters_animation_unselection_weight_request_message msg )
{
...
void _shy_common_logic_main_menu_letters_animation_unselection_weight :: receive ( so_called_common_logic_main_menu_letters_animation_unselection_weight_select_row_message msg )
{
    shy_guts :: logic_main_menu_letters_animation_unselection_weight_state :: row_unselected = so_called_platform_math_consts :: whole_false ;
    shy_guts :: logic_main_menu_letters_animation_unselection_weight_state :: unselected_row_index = msg . row ;
}

void _shy_common_logic_main_menu_letters_animation_unselection_weight :: receive ( so_called_common_logic_main_menu_letters_animation_unselection_weight_unselect_row_message msg )
{
...
void _shy_common_logic_main_menu_letters_animation_unselection_weight :: receive ( so_called_common_logic_main_menu_update_message )
{
