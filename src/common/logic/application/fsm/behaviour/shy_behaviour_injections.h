...
#define _shy_common_logic_application_fsm_behaviour_injections_included
    ...
    #include "common/logic/application/fsm/behaviour/loadable/shy_loadable_injections.h"
    ...
    #include "common/logic/application/fsm/behaviour/static/shy_static_injections.h"
