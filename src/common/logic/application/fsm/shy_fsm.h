...
public :
    ...
    static void receive ( so_called_message_common_logic_salutation_letters_meshes_cleaner_clean_finished ) ;
    static void receive ( so_called_message_common_logic_salutation_letters_meshes_generator_generate_finished ) ;
    static void receive ( so_called_message_common_logic_salutation_letters_text_cleaner_clean_finished ) ;
    static void receive ( so_called_message_common_logic_salutation_letters_text_generator_generate_finished ) ;
    static void receive ( so_called_message_common_logic_salutation_timer_appear_run_finished ) ;
