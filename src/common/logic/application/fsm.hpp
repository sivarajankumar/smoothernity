...
template < typename mediator >
void shy_logic_application_fsm < mediator > :: _is_fsm_running ( num_whole & result )
{
    result = _fsm_running ;
}

template < typename mediator >
void shy_logic_application_fsm < mediator > :: _run_fsm_begin ( )
{
    _fsm_running = _platform_math_consts . get ( ) . whole_true ;
}

template < typename mediator >
void shy_logic_application_fsm < mediator > :: _run_fsm_end ( )
{
    _fsm_running = _platform_math_consts . get ( ) . whole_false ;
}
