...
public :
    ...
    void _determine_autogenerated_inputs_change ( ) ;
...
public :
    ...
    typename platform_pointer :: template pointer < _logic_application_fsm_autogenerated_actions_type > _autogenerated_actions ;
    typename platform_pointer :: template pointer < _logic_application_fsm_actions_type > _actions ;
    typename platform_pointer :: template pointer < _logic_application_fsm_states_type > _states ;
    typename platform_pointer :: template pointer < _logic_application_fsm_autogenerated_inputs_type > _autogenerated_inputs ;
    typename platform_pointer :: template pointer < _logic_application_fsm_inputs_type > _inputs ;
    ...
    num_whole _autogenerated_inputs_changed ;
...
{
    return fsm . _states . get ( ) . performer_state_title ;
}
...
{
    fsm . _autogenerated_actions . get ( ) . title_performer_command_start ( ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _autogenerated_inputs . get ( ) . machine_title_performer_state_is_finished ) )
        return fsm . _states . get ( ) . performer_state_main_menu ;
    else
...
{
    fsm . _autogenerated_actions . get ( ) . main_menu_performer_command_start ( ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _autogenerated_inputs . get ( ) . machine_main_menu_performer_state_is_finished ) )
        return fsm . _states . get ( ) . performer_state_amusement ;
    else
        return _logic_application_fsm_state_type :: transition ( fsm ) ;
}
...
{
    fsm . _autogenerated_actions . get ( ) . amusement_performer_command_start ( ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _autogenerated_inputs . get ( ) . machine_amusement_performer_state_is_finished ) )
        return fsm . _states . get ( ) . performer_state_game ;
    else
        return _logic_application_fsm_state_type :: transition ( fsm ) ;
}
...
{
    fsm . _autogenerated_actions . get ( ) . game_performer_command_start ( ) ;
}
...
{
    return fsm . _states . get ( ) . generator_state_text ;
}
...
{
    fsm . _autogenerated_actions . get ( ) . text_generator_command_start ( ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _autogenerated_inputs . get ( ) . machine_text_generator_state_is_finished ) )
        return fsm . _states . get ( ) . generator_state_title ;
    else
        return _logic_application_fsm_state_type :: transition ( fsm ) ;
}
...
{
    fsm . _autogenerated_actions . get ( ) . title_generator_command_start ( ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _autogenerated_inputs . get ( ) . machine_title_generator_state_is_finished ) )
        return fsm . _states . get ( ) . generator_state_main_menu ;
    else
        return _logic_application_fsm_state_type :: transition ( fsm ) ;
}
...
{
    fsm . _autogenerated_actions . get ( ) . main_menu_generator_command_start ( ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _autogenerated_inputs . get ( ) . machine_main_menu_generator_state_is_finished ) )
        return fsm . _states . get ( ) . generator_state_amusement ;
    else
        return _logic_application_fsm_state_type :: transition ( fsm ) ;
}
...
{
    fsm . _autogenerated_actions . get ( ) . amusement_generator_command_start ( ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _autogenerated_inputs . get ( ) . machine_amusement_generator_state_is_finished ) )
        return fsm . _states . get ( ) . generator_state_game ;
    else
        return _logic_application_fsm_state_type :: transition ( fsm ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _autogenerated_inputs . get ( ) . machine_text_generator_command_start ) )
        return fsm . _states . get ( ) . text_generator_state_generating ;
    else
        return _logic_application_fsm_state_type :: transition ( fsm ) ;
}
...
{
    fsm . _actions . get ( ) . logic_text_prepare_permit ( ) ;
}

template < typename mediator >
void shy_logic_application_fsm < mediator > :: _machine_text_generator_state_generating_type :: on_input ( logic_application_fsm & fsm )
{
    if ( platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . logic_application_update ) )
        fsm . _actions . get ( ) . logic_text_update ( ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . logic_text_prepared ) )
        return fsm . _states . get ( ) . text_generator_state_finished ;
    else
        return _logic_application_fsm_state_type :: transition ( fsm ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _autogenerated_inputs . get ( ) . machine_title_generator_command_start )
      && platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . stage_title_enabled )
       )
    {
        return fsm . _states . get ( ) . title_generator_state_generating ;
    }
    else if ( platform_conditions :: whole_is_true ( fsm . _autogenerated_inputs . get ( ) . machine_title_generator_command_start )
           && platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . stage_title_disabled )
            )
    {
        return fsm . _states . get ( ) . title_generator_state_finished ;
    }
    else
        return _logic_application_fsm_state_type :: transition ( fsm ) ;
}
...
{
    fsm . _actions . get ( ) . logic_title_launch_permit ( ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . logic_application_update ) )
        fsm . _actions . get ( ) . logic_title_update ( ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . logic_title_created ) )
        return fsm . _states . get ( ) . title_generator_state_finished ;
    else
        return _logic_application_fsm_state_type :: transition ( fsm ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _autogenerated_inputs . get ( ) . machine_title_performer_command_start )
      && platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . stage_title_enabled )
       )
    {
        return fsm . _states . get ( ) . title_performer_state_performing ;
    }
    else if ( platform_conditions :: whole_is_true ( fsm . _autogenerated_inputs . get ( ) . machine_title_performer_command_start )
           && platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . stage_title_disabled )
            )
    {
        return fsm . _states . get ( ) . title_performer_state_finished ;
    }
    else
        return _logic_application_fsm_state_type :: transition ( fsm ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . logic_application_render ) )
        fsm . _actions . get ( ) . logic_title_render ( ) ;
    if ( platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . logic_application_update ) )
        fsm . _actions . get ( ) . logic_title_update ( ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . logic_title_finished ) )
        return fsm . _states . get ( ) . title_performer_state_finished ;
    else
        return _logic_application_fsm_state_type :: transition ( fsm ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _autogenerated_inputs . get ( ) . machine_main_menu_generator_command_start )
      && platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . stage_main_menu_enabled )
       )
    {
        return fsm . _states . get ( ) . main_menu_generator_state_generating ;
    }
    else if ( platform_conditions :: whole_is_true ( fsm . _autogenerated_inputs . get ( ) . machine_main_menu_generator_command_start )
           && platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . stage_main_menu_disabled )
            )
    {
        return fsm . _states . get ( ) . main_menu_generator_state_finished ;
    }
    else
        return _logic_application_fsm_state_type :: transition ( fsm ) ;
}
...
{
    fsm . _actions . get ( ) . logic_main_menu_creation_permit ( ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . logic_application_update ) )
        fsm . _actions . get ( ) . logic_main_menu_update ( ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . logic_main_menu_created ) )
        return fsm . _states . get ( ) . main_menu_generator_state_finished ;
    else
        return _logic_application_fsm_state_type :: transition ( fsm ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _autogenerated_inputs . get ( ) . machine_main_menu_performer_command_start )
      && platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . stage_main_menu_enabled )
       )
    {
        return fsm . _states . get ( ) . main_menu_performer_state_performing ;
    }
    else if ( platform_conditions :: whole_is_true ( fsm . _autogenerated_inputs . get ( ) . machine_main_menu_performer_command_start )
           && platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . stage_main_menu_disabled )
            )
    {
        return fsm . _states . get ( ) . main_menu_performer_state_finished ;
    }
    else
        return _logic_application_fsm_state_type :: transition ( fsm ) ;
}
...
{
    fsm . _actions . get ( ) . logic_main_menu_launch_permit ( ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . logic_application_render ) )
        fsm . _actions . get ( ) . logic_main_menu_render ( ) ;
    if ( platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . logic_application_update ) )
        fsm . _actions . get ( ) . logic_main_menu_update ( ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . logic_main_menu_finished ) )
        return fsm . _states . get ( ) . main_menu_performer_state_finished ;
    else
        return _logic_application_fsm_state_type :: transition ( fsm ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _autogenerated_inputs . get ( ) . machine_amusement_generator_command_start ) 
      && platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . stage_amusement_enabled )
       )
    {
        return fsm . _states . get ( ) . amusement_generator_state_generating ;
    }
    else if ( platform_conditions :: whole_is_true ( fsm . _autogenerated_inputs . get ( ) . machine_amusement_generator_command_start ) 
           && platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . stage_amusement_disabled )
            )
    {
        return fsm . _states . get ( ) . amusement_generator_state_finished ;
    }
    else
        return _logic_application_fsm_state_type :: transition ( fsm ) ;
}
...
{
    fsm . _actions . get ( ) . logic_amusement_creation_permit ( ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . logic_application_update ) )
        fsm . _actions . get ( ) . logic_amusement_update ( ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . logic_amusement_created ) )
        return fsm . _states . get ( ) . amusement_generator_state_finished ;
    else
        return _logic_application_fsm_state_type :: transition ( fsm ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _autogenerated_inputs . get ( ) . machine_amusement_performer_command_start )
      && platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . stage_amusement_enabled )
       )
    {
        return fsm . _states . get ( ) . amusement_performer_state_performing ;
    }
    else if ( platform_conditions :: whole_is_true ( fsm . _autogenerated_inputs . get ( ) . machine_amusement_performer_command_start )
           && platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . stage_amusement_disabled )
            )
    {
        return fsm . _states . get ( ) . amusement_performer_state_finished ;
    }
    else
        return _logic_application_fsm_state_type :: transition ( fsm ) ;
}
...
{
    fsm . _actions . get ( ) . logic_amusement_launch_permit ( ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . logic_application_render ) )
        fsm . _actions . get ( ) . logic_amusement_render ( ) ;
    if ( platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . logic_application_update ) )
        fsm . _actions . get ( ) . logic_amusement_update ( ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . logic_amusement_finished ) )
        return fsm . _states . get ( ) . amusement_performer_state_finished ;
    else
        return _logic_application_fsm_state_type :: transition ( fsm ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _autogenerated_inputs . get ( ) . machine_game_performer_command_start ) )
        return fsm . _states . get ( ) . game_performer_state_performing ;
    else
        return _logic_application_fsm_state_type :: transition ( fsm ) ;
}
...
{
    fsm . _actions . get ( ) . logic_game_launch_permit ( ) ;
}
...
{
    if ( platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . logic_application_render ) )
        fsm . _actions . get ( ) . logic_game_render ( ) ;
    if ( platform_conditions :: whole_is_true ( fsm . _inputs . get ( ) . logic_application_update ) )
        fsm . _actions . get ( ) . logic_game_update ( ) ;
}
...
void shy_logic_application_fsm < mediator > :: receive ( typename messages :: init )
{
    ...
    _autogenerated_inputs_changed = _platform_math_consts . get ( ) . whole_false ;
    ...
    platform_pointer :: bind ( _autogenerated_actions , _logic_application_fsm_autogenerated_actions ) ;
    platform_pointer :: bind ( _actions , _logic_application_fsm_actions ) ;
    platform_pointer :: bind ( _states , _logic_application_fsm_states ) ;
    platform_pointer :: bind ( _autogenerated_inputs , _fixed_autogenerated_inputs ) ;
    platform_pointer :: bind ( _inputs , _fixed_inputs ) ;
...
template < typename mediator >
void shy_logic_application_fsm < mediator > :: _determine_autogenerated_inputs_change ( )
{
       ...
       )
    {
        ...
        _autogenerated_inputs_changed = _platform_math_consts . get ( ) . whole_true ;
}
...
void shy_logic_application_fsm < mediator > :: _run_fsm ( )
{
    if ( platform_conditions :: whole_is_false ( _fsm_running ) )
    {
        ...
        _stabilize_fsm ( ) ;
        _reset_autogenerated_input_events ( ) ;
        _reset_input_events ( ) ;
        _stabilize_fsm ( ) ;
        _fsm_running = _platform_math_consts . get ( ) . whole_false ;
    }
...
void shy_logic_application_fsm < mediator > :: _stabilize_fsm ( )
{
    for ( ; ; )
    {
        _recalc_current_autogenerated_inputs ( ) ;
        _recalc_current_inputs ( ) ;
        _determine_autogenerated_inputs_change ( ) ;
        _determine_inputs_change ( ) ;
        if ( platform_conditions :: whole_is_true ( _autogenerated_inputs_changed )
          || platform_conditions :: whole_is_true ( _inputs_changed )
           )
        {
            _update_fixed_autogenerated_inputs ( ) ;
