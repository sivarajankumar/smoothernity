...
class shy_logic_application_fsm_autogenerated
{
    ...
    typedef typename logic_application_fsm :: _logic_application_fsm_actions_type _logic_application_fsm_actions_type ;
    typedef typename logic_application_fsm :: _logic_application_fsm_inputs_type _logic_application_fsm_inputs_type ;
...
public :
    ...
    void _is_fsm_running ( num_whole & ) ;
    void _run_fsm_begin ( ) ;
    void _run_fsm_end ( ) ;
...
template < typename logic_application_fsm >
void shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _reset_autogenerated_input_events ( )
{
...
template < typename logic_application_fsm >
void shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _determine_autogenerated_inputs_change ( num_whole & inputs_changed )
{
...
template < typename logic_application_fsm >
void shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _recalc_current_autogenerated_inputs ( )
{
...
template < typename logic_application_fsm >
void shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _update_fixed_autogenerated_inputs ( )
{
    _fixed_autogenerated_inputs = _current_autogenerated_inputs ;
}

template < typename logic_application_fsm >
void shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _tick_all_fsms ( _logic_application_fsm_state_environment_type & env )
{
    engine_fsm :: tick_single_fsm ( env , _machine_amusement_generator_state ) ;
    engine_fsm :: tick_single_fsm ( env , _machine_amusement_performer_state ) ;
    engine_fsm :: tick_single_fsm ( env , _machine_game_performer_state ) ;
    engine_fsm :: tick_single_fsm ( env , _machine_generator_state ) ;
    engine_fsm :: tick_single_fsm ( env , _machine_main_menu_generator_state ) ;
    engine_fsm :: tick_single_fsm ( env , _machine_main_menu_performer_state ) ;
    engine_fsm :: tick_single_fsm ( env , _machine_performer_state ) ;
    engine_fsm :: tick_single_fsm ( env , _machine_text_generator_state ) ;
    engine_fsm :: tick_single_fsm ( env , _machine_title_generator_state ) ;
    engine_fsm :: tick_single_fsm ( env , _machine_title_performer_state ) ;
}

template < typename logic_application_fsm >
void shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _is_fsm_running ( num_whole & result )
{
    result = _fsm_running ;
}

template < typename logic_application_fsm >
void shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _run_fsm_begin ( )
{
    platform_math :: make_num_whole ( _fsm_running , true ) ;
}

template < typename logic_application_fsm >
void shy_logic_application_fsm_autogenerated < logic_application_fsm > :: _run_fsm_end ( )
{
    platform_math :: make_num_whole ( _fsm_running , false ) ;
}
