...
public :
    ...
    static void receive ( so_called_common_logic_salutation_letters_animation_transform_reply_message ) ;
    ...
    static void receive ( so_called_common_logic_salutation_letters_renderer_render_request_message ) ;
