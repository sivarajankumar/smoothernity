void shy_common_logic_salutation_letters_animation_appear_transform_checker :: check 
    ( so_called_platform_math_num_whole_type & result
    , so_called_common_logic_salutation_letters_animation_appear_transform_request_message msg_request
