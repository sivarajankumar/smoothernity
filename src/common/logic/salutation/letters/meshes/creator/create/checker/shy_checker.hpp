void shy_common_logic_salutation_letters_meshes_creator_create_checker :: check 
    ...
    , so_called_message_common_logic_salutation_letters_meshes_creator_create_request msg_request
    , so_called_message_common_logic_salutation_letters_meshes_creator_create_reply msg_reply
    )
{
