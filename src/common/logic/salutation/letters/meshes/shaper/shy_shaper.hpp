...
void shy_guts :: request_letters_text_storage_letter ( )
{
    ...
    letter_index = shy_guts :: logic_salutation_letters_meshes_shaper_shape_state :: letter_index ;
...
void _shy_common_logic_salutation_letters_meshes_shaper :: receive ( so_called_message_common_logic_salutation_letters_text_storage_letter_reply msg )
{
