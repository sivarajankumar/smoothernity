void shy_common_logic_salutation_letters_meshes_storage_mesh_checker :: check 
    ...
    , so_called_common_logic_salutation_letters_meshes_storage_mesh_request_message msg_request
    , so_called_common_logic_salutation_letters_meshes_storage_mesh_reply_message msg_reply
    )
{
