namespace shy_guts
{
    ...
    namespace logic_salutation_letters_meshes_cleaner_update_state
    {
...
void shy_guts :: update_state ( )
{
    ...
    if ( so_called_platform_conditions :: whole_is_true ( shy_guts :: logic_salutation_letters_meshes_cleaner_update_state :: requested ) )
    {
        shy_guts :: logic_salutation_letters_meshes_cleaner_update_state :: requested = so_called_platform_math_consts :: whole_false ;
        shy_guts :: logic_salutation_letters_meshes_cleaner_update_state :: on_requested ( ) ;
    }
...
void shy_guts :: logic_salutation_letters_meshes_cleaner_update_state :: on_requested ( )
{
}
...
{
    shy_guts :: logic_salutation_letters_meshes_cleaner_clean_state :: requested = so_called_platform_math_consts :: whole_false ;
    shy_guts :: logic_salutation_letters_meshes_cleaner_update_state :: enabled = so_called_platform_math_consts :: whole_false ;
    shy_guts :: logic_salutation_letters_meshes_cleaner_update_state :: requested = so_called_platform_math_consts :: whole_false ;
    shy_guts :: logic_salutation_letters_meshes_storage_mesh_state :: replied = so_called_platform_math_consts :: whole_false ;
