...
void shy_guts :: proceed_with_generation ( )
{
    ...
    if ( so_called_platform_conditions :: whole_is_true ( shy_guts :: logic_salutation_letters_meshes_shaper_shape_state :: replied ) )
    {
        shy_guts :: logic_salutation_letters_meshes_shaper_shape_state :: replied = so_called_platform_math_consts :: whole_false ;
...
void shy_guts :: generate_next_mesh ( )
{
    ...
    shy_guts :: logic_salutation_letters_meshes_shaper_shape_state :: requested_letter_index = letter_index ;

    so_called_message_common_logic_salutation_letters_meshes_shaper_shape_request msg ;
    msg . letter_index = letter_index ;
    so_called_sender_common_logic_salutation_letters_meshes_shaper_shape_request :: send ( msg ) ;
}
...
void _shy_common_logic_salutation_letters_meshes_generator :: receive ( so_called_message_common_logic_salutation_letters_meshes_shaper_shape_reply msg )
{
    if ( so_called_platform_conditions :: whole_is_true ( shy_guts :: logic_salutation_letters_meshes_shaper_shape_state :: requested )
      && so_called_platform_conditions :: wholes_are_equal ( shy_guts :: logic_salutation_letters_meshes_shaper_shape_state :: requested_letter_index , msg . letter_index )
       )
    {
        shy_guts :: logic_salutation_letters_meshes_shaper_shape_state :: requested = so_called_platform_math_consts :: whole_false ;
        shy_guts :: logic_salutation_letters_meshes_shaper_shape_state :: replied = so_called_platform_math_consts :: whole_true ;
        shy_guts :: proceed_with_generation ( ) ;
    }
}
