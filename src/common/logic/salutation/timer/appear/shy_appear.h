...
public :
    ...
    static void receive ( so_called_common_logic_salutation_timer_appear_start_message ) ;
    static void receive ( so_called_common_logic_salutation_timer_appear_tick_message ) ;
