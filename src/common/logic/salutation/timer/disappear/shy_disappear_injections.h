...
#include "common/logic/salutation/timer/disappear/start/message/shy_message_injections.h"
...
typedef shy_common_logic_salutation_timer_disappear_scheduled so_called_common_logic_salutation_timer_disappear ;
