...
public :
    ...
    static void receive ( so_called_common_logic_salutation_animation_update_message ) ;
    static void receive ( so_called_common_logic_salutation_animation_zoom_play_message ) ;
