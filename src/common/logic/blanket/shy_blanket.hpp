...
{
    so_called_common_logic_blanket_mesh_create_sender :: send ( so_called_message_common_logic_blanket_mesh_create ( ) ) ;
}
...
void _shy_common_logic_blanket :: receive ( so_called_message_common_logic_blanket_mesh_creation_finished )
{
    ...
    so_called_common_logic_blanket_creation_finished_sender :: send ( so_called_message_common_logic_blanket_creation_finished ( ) ) ;
}
