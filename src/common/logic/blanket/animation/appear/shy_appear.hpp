...
void shy_guts :: compute_scale ( )
{
    ...
    scale_begin = so_called_common_logic_blanket_animation_consts :: appear_scale_begin ;
    scale_end = so_called_common_logic_blanket_animation_consts :: appear_scale_end ;
    ...
    shy_guts :: logic_blanket_animation_appear_transform_state :: scale = scale ;
}
...
{
    so_called_common_logic_blanket_animation_appear_transform_reply_message msg ;
    ...
    so_called_common_logic_blanket_animation_appear_transform_reply_sender :: send ( msg ) ;
}

void _shy_common_logic_blanket_animation_appear :: receive ( so_called_common_init_message )
{
...
void _shy_common_logic_blanket_animation_appear :: receive ( so_called_common_logic_blanket_animation_appear_start_message )
{
    shy_guts :: logic_blanket_update_state :: started = so_called_platform_math_consts :: whole_true ;
    shy_guts :: logic_blanket_update_state :: time = so_called_platform_math_consts :: fract_0 ;
}

void _shy_common_logic_blanket_animation_appear :: receive ( so_called_common_logic_blanket_animation_appear_transform_request_message )
{
...
void _shy_common_logic_blanket_animation_appear :: receive ( so_called_common_logic_blanket_update_message )
{
    if ( so_called_platform_conditions :: whole_is_true ( shy_guts :: logic_blanket_update_state :: started ) )
    {
        ...
        if ( so_called_platform_conditions :: fract_greater_than_fract ( time , time_from_begin_to_end ) )
        {
            ...
            so_called_common_logic_blanket_animation_appear_finished_sender :: send ( so_called_common_logic_blanket_animation_appear_finished_message ( ) ) ;
        }
