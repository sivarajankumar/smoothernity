...
public :
    ...
    static void receive ( so_called_common_logic_blanket_animation_disappear_start_message ) ;
    static void receive ( so_called_common_logic_blanket_animation_disappear_transform_request_message ) ;
