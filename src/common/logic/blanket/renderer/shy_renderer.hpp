...
void shy_guts :: request_blanket_render ( )
{
    ...
    so_called_common_logic_blanket_mesh_render_request_sender :: send ( so_called_common_logic_blanket_mesh_render_request_message ( ) ) ;
}

void shy_guts :: reply_render ( )
{
    so_called_common_logic_blanket_render_reply_sender :: send ( so_called_common_logic_blanket_render_reply_message ( ) ) ;
}

void _shy_common_logic_blanket_renderer :: receive ( so_called_common_init_message )
{
    shy_guts :: logic_blanket_mesh_render_state :: replied = so_called_platform_math_consts :: whole_false ;
...
void _shy_common_logic_blanket_renderer :: receive ( so_called_common_logic_blanket_mesh_render_reply_message )
{
...
void _shy_common_logic_blanket_renderer :: receive ( so_called_common_logic_blanket_render_request_message )
{
