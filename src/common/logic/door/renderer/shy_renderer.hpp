...
void shy_guts :: request_mesh_render ( )
{
    ...
    so_called_common_logic_door_mesh_render_request_sender :: send ( so_called_message_common_logic_door_mesh_render_request ( ) ) ;
}
...
void shy_guts :: request_texture_select ( )
{
    ...
    so_called_common_logic_door_texture_select_request_sender :: send ( so_called_message_common_logic_door_texture_select_request ( ) ) ;
}

void shy_guts :: reply_door_render ( )
{
    so_called_common_logic_door_render_reply_sender :: send ( so_called_message_common_logic_door_render_reply ( ) ) ;
}
