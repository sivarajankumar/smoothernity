...
void shy_guts :: request_mesh_render ( )
{
    ...
    so_called_common_logic_door_mesh_render_request_sender :: send ( so_called_common_logic_door_mesh_render_request_message ( ) ) ;
}
...
void shy_guts :: request_texture_select ( )
{
    ...
    so_called_common_logic_door_texture_select_request_sender :: send ( so_called_common_logic_door_texture_select_request_message ( ) ) ;
}

void shy_guts :: reply_door_render ( )
{
    so_called_common_logic_door_render_reply_sender :: send ( so_called_common_logic_door_render_reply_message ( ) ) ;
}

void _shy_common_logic_door_renderer :: receive ( so_called_common_init_message )
{
    shy_guts :: logic_door_mesh_render_state :: replied = so_called_platform_math_consts :: whole_false ;
...
void _shy_common_logic_door_renderer :: receive ( so_called_common_logic_door_mesh_render_reply_message )
{
...
void _shy_common_logic_door_renderer :: receive ( so_called_common_logic_door_render_request_message )
{
    shy_guts :: logic_door_render_state :: requested = so_called_platform_math_consts :: whole_true ;
    shy_guts :: proceed_with_render ( ) ;
}

void _shy_common_logic_door_renderer :: receive ( so_called_common_logic_door_texture_select_reply_message )
{
...
void _shy_common_logic_door_renderer :: register_in_scheduler ( )
{
