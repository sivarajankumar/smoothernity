...
#include "common/logic/door/animation/sender/appear_transform_request/shy_appear_transform_request_injections.h"
#include "common/logic/door/animation/sender/transform_reply/shy_transform_reply_injections.h"
