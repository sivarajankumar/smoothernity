...
void shy_logic_door_animation < mediator > :: _compute_transform ( )
{
    ...
    origin_x = _logic_door_animation_stateless_consts . get ( ) . animation_origin_x ;
    origin_y = _logic_door_animation_stateless_consts . get ( ) . animation_origin_y ;
    origin_z = _logic_door_animation_stateless_consts . get ( ) . animation_origin_z ;
