...
#include "src/common/logic/room/consts/shy_consts_injections.h"
#include "src/common/logic/room/texture/creation/finished/sender/shy_sender_injections.h"
#include "src/common/logic/room/texture/select/reply/sender/shy_sender_injections.h"
