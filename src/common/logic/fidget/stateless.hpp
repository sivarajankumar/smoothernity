...
public :
    ...
    public :
        ...
        void send ( typename logic_fidget_messages :: fidget_prepare_permit msg ) ;
        void send ( typename logic_fidget_messages :: fidget_prepared msg ) ;
        void send ( typename logic_fidget_messages :: fidget_render_reply msg ) ;
        void send ( typename logic_fidget_messages :: fidget_render_request msg ) ;
        void send ( typename logic_fidget_messages :: fidget_update msg ) ;
    private :
