...
public :
    ...
    static void receive ( so_called_common_logic_observer_animation_flight_transform_reply_message ) ;
    static void receive ( so_called_common_logic_observer_animation_transform_request_message ) ;
