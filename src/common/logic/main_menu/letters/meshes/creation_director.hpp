...
class shy_logic_main_menu_letters_meshes_creation_director
{
    ...
    class logic_main_menu_letters_meshes_creation_director_consts_type
    {
    public :
        logic_main_menu_letters_meshes_creation_director_consts_type ( ) ;
    public :
...
private :
    ...
    logic_main_menu_letters_meshes_creation_director_consts_type _logic_main_menu_letters_meshes_creation_director_consts ;
    num_whole _creation_in_progress ;
    num_fract _time_passed ;
} ;

template < typename mediator >
shy_logic_main_menu_letters_meshes_creation_director < mediator >
:: logic_main_menu_letters_meshes_creation_director_consts_type
:: logic_main_menu_letters_meshes_creation_director_consts_type ( )
{
...
void shy_logic_main_menu_letters_meshes_creation_director < mediator > :: receive ( typename messages :: logic_main_menu_update )
{
    if ( platform_conditions :: whole_is_true ( _creation_in_progress ) )
    {
        ...
        while ( platform_conditions :: fract_greater_than_fract ( _time_passed , _logic_main_menu_letters_meshes_creation_director_consts . time_between_creation ) )
        {
            platform_math :: sub_from_fract ( _time_passed , _logic_main_menu_letters_meshes_creation_director_consts . time_between_creation ) ;
