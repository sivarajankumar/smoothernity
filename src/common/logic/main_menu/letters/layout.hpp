...
void shy_logic_main_menu_letters_layout < mediator > :: _compute_unscaled_menu_size ( )
{
    ...
    platform_math :: make_fract_from_whole ( letters_in_row , _logic_main_menu_letters_layout_state . max_cols ) ;
    platform_math :: make_fract_from_whole ( letters_in_col , _logic_main_menu_letters_layout_state . max_rows ) ;
    ...
    platform_math :: mul_fracts ( spacings_width , _logic_main_menu_letters_layout_consts . letter_size_fract_horizontal_spacing , spacings_in_row ) ;
    platform_math :: mul_fracts ( spacings_height , _logic_main_menu_letters_layout_consts . letter_size_fract_vertical_spacing , spacings_in_col ) ;
    
    platform_math :: mul_fracts ( borders_width , _logic_main_menu_letters_layout_consts . letter_size_fract_horizontal_border , _platform_math_consts . get ( ) . fract_2 ) ;
    platform_math :: mul_fracts ( borders_height , _logic_main_menu_letters_layout_consts . letter_size_fract_vertical_border , _platform_math_consts . get ( ) . fract_2 ) ;
    ...
    _logic_main_menu_letters_layout_state . unscaled_menu_width = unscaled_menu_width ;
    _logic_main_menu_letters_layout_state . unscaled_menu_height = unscaled_menu_height ;
}
...
void shy_logic_main_menu_letters_layout < mediator > :: _compute_menu_rect ( )
{
    ...
    platform_math :: mul_fracts ( scaled_menu_width , _logic_main_menu_letters_layout_state . unscaled_menu_width , _logic_main_menu_letters_layout_state . menu_scale ) ;
    platform_math :: mul_fracts ( scaled_menu_height , _logic_main_menu_letters_layout_state . unscaled_menu_height , _logic_main_menu_letters_layout_state . menu_scale ) ;
    ...
    _logic_main_menu_letters_layout_state . menu_rect = menu_rect ;
}
...
void shy_logic_main_menu_letters_layout < mediator > :: _compute_row_rect ( )
{
    ...
    platform_math :: add_fracts ( row_height , _platform_math_consts . get ( ) . fract_1 , _logic_main_menu_letters_layout_consts . letter_size_fract_vertical_spacing ) ;
    
    platform_math :: mul_fracts ( letter_size , _logic_main_menu_stateless_consts . get ( ) . letter_mesh_size , _logic_main_menu_letters_layout_state . menu_scale ) ;
    ...
    platform_math :: make_fract_from_whole ( row_number , _logic_main_menu_letters_layout_state . requested_row ) ;
    ...
    platform_math :: add_to_fract ( row_rect . top , _logic_main_menu_letters_layout_state . menu_rect . top ) ;
    ...
    _logic_main_menu_letters_layout_state . row_rect = row_rect ;
}
...
void shy_logic_main_menu_letters_layout < mediator > :: _compute_decorated_row_rect ( )
{
    ...
    platform_math :: div_fracts ( rect_vertical_extent , _logic_main_menu_letters_layout_consts . letter_size_fract_vertical_spacing , _platform_math_consts . get ( ) . fract_2 ) ;
    platform_math :: sub_wholes ( last_row , _logic_main_menu_letters_layout_state . max_rows , _platform_math_consts . get ( ) . whole_1 ) ;
    ...
    if ( platform_conditions :: whole_greater_than_zero ( _logic_main_menu_letters_layout_state . requested_row ) )
        platform_math :: add_to_fract ( decorated_row_rect . top , rect_vertical_extent ) ;
    if ( platform_conditions :: whole_less_than_whole ( _logic_main_menu_letters_layout_state . requested_row , last_row ) )
        platform_math :: add_to_fract ( decorated_row_rect . bottom , rect_vertical_extent ) ;        
        
    _logic_main_menu_letters_layout_state . decorated_row_rect = decorated_row_rect ;
}
...
void shy_logic_main_menu_letters_layout < mediator > :: _compute_letter_rect ( )
{
    ...
    platform_math :: make_fract_from_whole ( col_number , _logic_main_menu_letters_layout_state . requested_col ) ;
    platform_math :: mul_fracts ( letter_size , _logic_main_menu_stateless_consts . get ( ) . letter_mesh_size , _logic_main_menu_letters_layout_state . menu_scale ) ;
    ...
    letter_rect . top = _logic_main_menu_letters_layout_state . row_rect . top ;
    ...
    platform_math :: add_to_fract ( letter_rect . left , _logic_main_menu_letters_layout_state . row_rect . left ) ;
    platform_math :: add_fracts ( letter_rect . right , letter_rect . left , letter_size ) ;
    
    _logic_main_menu_letters_layout_state . letter_rect = letter_rect ;
}
...
void shy_logic_main_menu_letters_layout < mediator > :: _compute_letter_position ( )
{
    ...
    letter_rect = _logic_main_menu_letters_layout_state . letter_rect ;
    ...
    platform_vector :: xyz ( _logic_main_menu_letters_layout_state . letter_position , letter_position_x , letter_position_y , letter_position_z ) ;
}
