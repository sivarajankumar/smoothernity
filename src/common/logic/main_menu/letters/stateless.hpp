...
template < typename mediator >
void shy_logic_main_menu_letters_stateless < mediator > :: compute_unscaled_menu_size 
    ( num_fract & unscaled_menu_width
    , num_fract & unscaled_menu_height
    , num_whole max_cols
    , num_whole max_rows
...
template < typename mediator >
void shy_logic_main_menu_letters_stateless < mediator > :: compute_menu_scale 
    ( num_fract & menu_scale
    , num_fract aspect_width
    , num_fract aspect_height
    , num_fract unscaled_menu_width
...
template < typename mediator >
void shy_logic_main_menu_letters_stateless < mediator > :: compute_menu_rect 
    ( rect & menu_rect
    , num_fract menu_scale
    , num_fract unscaled_menu_width
    , num_fract unscaled_menu_height
...
template < typename mediator >
void shy_logic_main_menu_letters_stateless < mediator > :: compute_row_rect 
    ( rect & row_rect
    , num_whole row
    , num_whole cols
    , num_fract menu_scale
...
template < typename mediator >
void shy_logic_main_menu_letters_stateless < mediator > :: compute_letter_rect 
    ( rect & letter_rect
    , num_whole col
    , num_fract menu_scale
    , rect row_rect
...
template < typename mediator >
void shy_logic_main_menu_letters_stateless < mediator > :: compute_letter_position 
    ( vector_data & letter_position
    , rect letter_rect
    , num_fract letter_position_z
    )
