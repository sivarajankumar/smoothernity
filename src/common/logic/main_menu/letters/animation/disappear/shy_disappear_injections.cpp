...
#include "common/logic/main_menu/letters/animation/sender/disappear_finished/shy_disappear_finished_injections.h"
#include "common/logic/main_menu/letters/animation/sender/disappear_transform_reply/shy_disappear_transform_reply_injections.h"
