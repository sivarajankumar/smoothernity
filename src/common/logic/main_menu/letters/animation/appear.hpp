...
void shy_logic_main_menu_letters_animation_appear < mediator > :: receive ( typename messages :: logic_main_menu_letters_animation_appear_transform_request msg )
{
    ...
    _logic_main_menu_letters_animation_appear_transform_state . col = msg . col ;
...
void shy_logic_main_menu_letters_animation_appear < mediator > :: _compute_delay ( )
{
    ...
    delay_per_row = _logic_main_menu_letters_animation_stateless_consts . get ( ) . appear_delay_per_row_in_seconds ;
    delay_per_col = _logic_main_menu_letters_animation_stateless_consts . get ( ) . appear_delay_per_col_in_seconds ;
    ...
    _logic_main_menu_letters_animation_appear_transform_state . delay = delay ;
}
...
void shy_logic_main_menu_letters_animation_appear < mediator > :: _compute_time ( )
{
    ...
    time_from_begin_to_middle = _logic_main_menu_letters_animation_stateless_consts . get ( ) . appear_time_from_begin_to_middle_in_seconds ;
    time_from_middle_to_end = _logic_main_menu_letters_animation_stateless_consts . get ( ) . appear_time_from_middle_to_end_in_seconds ;
    time_begin = delay ;
    ...
    _logic_main_menu_letters_animation_appear_transform_state . time_begin = time_begin ;
    _logic_main_menu_letters_animation_appear_transform_state . time_middle = time_middle ;
    _logic_main_menu_letters_animation_appear_transform_state . time_end = time_end ;
}
...
void shy_logic_main_menu_letters_animation_appear < mediator > :: _compute_transform ( )
{
    ...
    time_begin = _logic_main_menu_letters_animation_appear_transform_state . time_begin ;
    ...
    scale_begin = _logic_main_menu_letters_animation_stateless_consts . get ( ) . appear_scale_begin ;
    scale_middle = _logic_main_menu_letters_animation_stateless_consts . get ( ) . appear_scale_middle ;
    scale_end = _logic_main_menu_letters_animation_stateless_consts . get ( ) . appear_scale_end ;
...
void shy_logic_main_menu_letters_animation_appear < mediator > :: _reply_transform ( )
{
    ...
    msg . col = _logic_main_menu_letters_animation_appear_transform_state . col ;
    msg . scale = _logic_main_menu_letters_animation_appear_transform_state . scale ;
