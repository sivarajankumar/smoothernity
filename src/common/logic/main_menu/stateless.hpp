...
public :
    ...
    {
    public :
        class logic_main_menu_animation_idle_transform_request { public : num_whole row ; num_whole col ; } ;
        class logic_main_menu_animation_transform_reply { public : num_whole row ; num_whole col ; matrix_data transform ; } ;
        class logic_main_menu_animation_transform_request { public : num_whole row ; num_whole col ; } ;
        ...
        class logic_main_menu_mesh_row_col_request { public : num_whole index ; } ;
        ...
        class logic_main_menu_meshes_destroy_reply { } ;
        class logic_main_menu_meshes_destroy_request { } ;
        class logic_main_menu_meshes_iterate_finished { } ;
        class logic_main_menu_meshes_iterate_start { } ;
        class logic_main_menu_meshes_iteration { public : num_whole row ; num_whole col ; engine_render_mesh_id mesh ; } ;
        class logic_main_menu_meshes_place { } ;
        class logic_main_menu_meshes_render_reply { } ;
        class logic_main_menu_meshes_render_request { } ;
    ...
    public :
        ...
        void send ( typename logic_main_menu_messages :: logic_main_menu_animation_idle_transform_request ) ;
        void send ( typename logic_main_menu_messages :: logic_main_menu_animation_transform_reply ) ;
        void send ( typename logic_main_menu_messages :: logic_main_menu_animation_transform_request ) ;
        ...
        void send ( typename logic_main_menu_messages :: logic_main_menu_letters_animation_appear_transform_reply ) ;
        void send ( typename logic_main_menu_messages :: logic_main_menu_letters_animation_appear_transform_request ) ;
        void send ( typename logic_main_menu_messages :: logic_main_menu_letters_animation_disappear_finished ) ;
        void send ( typename logic_main_menu_messages :: logic_main_menu_letters_animation_disappear_start ) ;
        void send ( typename logic_main_menu_messages :: logic_main_menu_letters_animation_disappear_transform_reply ) ;
        void send ( typename logic_main_menu_messages :: logic_main_menu_letters_animation_disappear_transform_request ) ;
        void send ( typename logic_main_menu_messages :: logic_main_menu_letters_animation_idle_transform_reply ) ;
        ...
        void send ( typename logic_main_menu_messages :: logic_main_menu_mesh_row_col_request ) ;
        ...
        void send ( typename logic_main_menu_messages :: logic_main_menu_meshes_destroy_reply ) ;
        void send ( typename logic_main_menu_messages :: logic_main_menu_meshes_destroy_request ) ;
        void send ( typename logic_main_menu_messages :: logic_main_menu_meshes_iterate_finished ) ;
        void send ( typename logic_main_menu_messages :: logic_main_menu_meshes_iterate_start ) ;
        void send ( typename logic_main_menu_messages :: logic_main_menu_meshes_iteration ) ;
        void send ( typename logic_main_menu_messages :: logic_main_menu_meshes_place ) ;
        void send ( typename logic_main_menu_messages :: logic_main_menu_meshes_render_reply ) ;
        void send ( typename logic_main_menu_messages :: logic_main_menu_meshes_render_request ) ;
...
void shy_logic_main_menu_stateless < mediator > 
:: logic_main_menu_sender < receivers > 
:: send ( typename logic_main_menu_messages :: logic_main_menu_letters_animation_appear_transform_reply msg )
{
...
void shy_logic_main_menu_stateless < mediator > 
:: logic_main_menu_sender < receivers > 
:: send ( typename logic_main_menu_messages :: logic_main_menu_letters_animation_appear_transform_request msg )
{
...
void shy_logic_main_menu_stateless < mediator > 
:: logic_main_menu_sender < receivers > 
:: send ( typename logic_main_menu_messages :: logic_main_menu_letters_animation_disappear_start msg )
{
...
void shy_logic_main_menu_stateless < mediator > 
:: logic_main_menu_sender < receivers > 
:: send ( typename logic_main_menu_messages :: logic_main_menu_letters_animation_disappear_finished msg )
{
...
void shy_logic_main_menu_stateless < mediator > 
:: logic_main_menu_sender < receivers > 
:: send ( typename logic_main_menu_messages :: logic_main_menu_letters_animation_disappear_transform_reply msg )
{
    _receivers . get ( ) . logic_main_menu_animation . get ( ) . receive ( msg ) ;
}
...
void shy_logic_main_menu_stateless < mediator > 
:: logic_main_menu_sender < receivers > 
:: send ( typename logic_main_menu_messages :: logic_main_menu_letters_animation_disappear_transform_request msg )
{
    _receivers . get ( ) . logic_main_menu_animation_disappear . get ( ) . receive ( msg ) ;
}
...
void shy_logic_main_menu_stateless < mediator > 
:: logic_main_menu_sender < receivers > 
:: send ( typename logic_main_menu_messages :: logic_main_menu_letters_animation_idle_transform_reply msg )
{
    _receivers . get ( ) . logic_main_menu_animation . get ( ) . receive ( msg ) ;
}
...
void shy_logic_main_menu_stateless < mediator > 
:: logic_main_menu_sender < receivers > 
:: send ( typename logic_main_menu_messages :: logic_main_menu_animation_idle_transform_request msg )
{
...
void shy_logic_main_menu_stateless < mediator > 
:: logic_main_menu_sender < receivers > 
:: send ( typename logic_main_menu_messages :: logic_main_menu_animation_transform_reply msg )
{
...
void shy_logic_main_menu_stateless < mediator > 
:: logic_main_menu_sender < receivers > 
:: send ( typename logic_main_menu_messages :: logic_main_menu_animation_transform_request msg )
{
    _receivers . get ( ) . logic_main_menu_animation . get ( ) . receive ( msg ) ;
}
...
void shy_logic_main_menu_stateless < mediator > 
:: logic_main_menu_sender < receivers > 
:: send ( typename logic_main_menu_messages :: logic_main_menu_mesh_row_col_reply msg ) 
{
    _receivers . get ( ) . logic_main_menu_meshes_placement . get ( ) . receive ( msg ) ;
}
...
void shy_logic_main_menu_stateless < mediator > 
:: logic_main_menu_sender < receivers > 
:: send ( typename logic_main_menu_messages :: logic_main_menu_mesh_row_col_request msg ) 
{
    _receivers . get ( ) . logic_main_menu_meshes_storage . get ( ) . receive ( msg ) ;
}
...
void shy_logic_main_menu_stateless < mediator > 
:: logic_main_menu_sender < receivers > 
:: send ( typename logic_main_menu_messages :: logic_main_menu_meshes_destroy_reply msg ) 
{
    _receivers . get ( ) . logic_main_menu . get ( ) . receive ( msg ) ;
}
...
void shy_logic_main_menu_stateless < mediator > 
:: logic_main_menu_sender < receivers > 
:: send ( typename logic_main_menu_messages :: logic_main_menu_meshes_destroy_request msg ) 
{
...
void shy_logic_main_menu_stateless < mediator > 
:: logic_main_menu_sender < receivers > 
:: send ( typename logic_main_menu_messages :: logic_main_menu_meshes_iterate_finished msg ) 
{
...
void shy_logic_main_menu_stateless < mediator > 
:: logic_main_menu_sender < receivers > 
:: send ( typename logic_main_menu_messages :: logic_main_menu_meshes_iterate_start msg ) 
{
    _receivers . get ( ) . logic_main_menu_meshes_storage . get ( ) . receive ( msg ) ;
}
...
void shy_logic_main_menu_stateless < mediator > 
:: logic_main_menu_sender < receivers > 
:: send ( typename logic_main_menu_messages :: logic_main_menu_meshes_iteration msg ) 
{
    _receivers . get ( ) . logic_main_menu_meshes_renderer . get ( ) . receive ( msg ) ;
    _receivers . get ( ) . logic_main_menu_meshes_destroyer . get ( ) . receive ( msg ) ;
}
...
void shy_logic_main_menu_stateless < mediator > 
:: logic_main_menu_sender < receivers > 
:: send ( typename logic_main_menu_messages :: logic_main_menu_meshes_place msg ) 
{
    _receivers . get ( ) . logic_main_menu_meshes_placement . get ( ) . receive ( msg ) ;
}
...
void shy_logic_main_menu_stateless < mediator > 
:: logic_main_menu_sender < receivers > 
:: send ( typename logic_main_menu_messages :: logic_main_menu_meshes_render_request msg ) 
{
    _receivers . get ( ) . logic_main_menu_meshes_renderer . get ( ) . receive ( msg ) ;
}
...
void shy_logic_main_menu_stateless < mediator > 
:: logic_main_menu_sender < receivers > 
:: send ( typename logic_main_menu_messages :: logic_main_menu_meshes_render_reply msg ) 
{
    _receivers . get ( ) . logic_main_menu_renderer . get ( ) . receive ( msg ) ;
}
