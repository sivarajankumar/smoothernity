class shy_common_logic_main_menu_animation_consts
{
public :
    static const so_called_type_platform_math_num_fract shake_time_to_begin ;
    static const so_called_type_platform_math_num_fract shake_time_from_begin_to_end ;
