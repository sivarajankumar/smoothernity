...
typedef so_called_platform_scheduler :: scheduled_context < _shy_common_logic_main_menu_selection_animation_idle_attention > _scheduled_context_type ;
template < > _scheduled_context_type _scheduled_context_type :: _singleton = _scheduled_context_type ( ) ;

void shy_guts :: reply_transform ( )
{
    so_called_common_logic_main_menu_selection_animation_idle_attention_transform_reply_message msg ;
...
{
    shy_guts :: compute_animation_scale
        ( shy_guts :: logic_main_menu_selection_animation_idle_attention_transform_state :: vertical_scale
        , so_called_common_logic_main_menu_selection_animation_consts :: idle_attention_vertical_scale_min
        , so_called_common_logic_main_menu_selection_animation_consts :: idle_attention_vertical_scale_max
        , so_called_common_logic_main_menu_selection_animation_consts :: idle_attention_vertical_scale_period_in_seconds
        ) ;
}
...
void _shy_common_logic_main_menu_selection_animation_idle_attention :: receive ( so_called_common_init_message )
{
...
void _shy_common_logic_main_menu_selection_animation_idle_attention :: receive ( so_called_common_logic_main_menu_launch_permit_message )
{
    shy_guts :: logic_main_menu_update_state :: launch_permitted = so_called_platform_math_consts :: whole_true ;
    shy_guts :: logic_main_menu_update_state :: time = so_called_platform_math_consts :: fract_0 ;
}

void _shy_common_logic_main_menu_selection_animation_idle_attention :: receive ( so_called_common_logic_main_menu_selection_animation_idle_attention_transform_request_message )
{
...
void _shy_common_logic_main_menu_selection_animation_idle_attention :: receive ( so_called_common_logic_main_menu_update_message )
{
...
void _shy_common_logic_main_menu_selection_animation_idle_attention :: register_in_scheduler ( )
{
