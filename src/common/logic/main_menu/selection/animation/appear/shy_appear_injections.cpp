...
#include "common/logic/main_menu/selection/animation/sender/appear_finished/shy_appear_finished_injections.h"
#include "common/logic/main_menu/selection/animation/sender/appear_transform_reply/shy_appear_transform_reply_injections.h"
