...
typedef so_called_platform_scheduler :: scheduled_context < _shy_common_logic_main_menu_selection_animation_unselect > _scheduled_context_type ;
...
void shy_guts :: compute_horizontal_scale ( )
{
    ...
    horizontal_scale_time_to_begin = so_called_common_logic_main_menu_selection_animation_consts :: unselect_horizontal_scale_time_to_begin ;
    horizontal_scale_time_from_begin_to_end = so_called_common_logic_main_menu_selection_animation_consts :: unselect_horizontal_scale_time_from_begin_to_end ;
    ...
    so_called_common_engine_math_stateless :: easy_in_hard_out
        ( shy_guts :: logic_main_menu_selection_animation_unselect_transform_state :: horizontal_scale
        , shy_guts :: logic_main_menu_update_state :: time
        , so_called_common_logic_main_menu_selection_animation_consts :: unselect_horizontal_scale_value_begin
        , time_begin
        , so_called_common_logic_main_menu_selection_animation_consts :: unselect_horizontal_scale_value_end
        , time_end
        ) ;
}
...
void shy_guts :: compute_vertical_scale ( )
{
    ...
    vertical_scale_time_to_begin = so_called_common_logic_main_menu_selection_animation_consts :: unselect_vertical_scale_time_to_begin ;
    vertical_scale_time_from_begin_to_end = so_called_common_logic_main_menu_selection_animation_consts :: unselect_vertical_scale_time_from_begin_to_end ;
    ...
    so_called_common_engine_math_stateless :: easy_in_hard_out
        ( shy_guts :: logic_main_menu_selection_animation_unselect_transform_state :: vertical_scale
        , shy_guts :: logic_main_menu_update_state :: time
        , so_called_common_logic_main_menu_selection_animation_consts :: unselect_vertical_scale_value_begin
        , time_begin
        , so_called_common_logic_main_menu_selection_animation_consts :: unselect_vertical_scale_value_end
        , time_end
        ) ;
}
...
{
    shy_guts :: logic_main_menu_selection_animation_unselect_transform_state :: vertical_scale = so_called_platform_math_consts :: fract_1 ;
    shy_guts :: logic_main_menu_selection_animation_unselect_transform_state :: horizontal_scale = so_called_platform_math_consts :: fract_1 ;
}
...
void shy_guts :: reply_computed_transform ( )
{
    ...
    so_called_sender_common_logic_main_menu_selection_animation_unselect_transform_reply :: send ( msg ) ;
}
...
void _shy_common_logic_main_menu_selection_animation_unselect :: receive ( so_called_message_common_logic_main_menu_update )
{
    if ( so_called_platform_conditions :: whole_is_true ( shy_guts :: logic_main_menu_update_state :: select_started ) )
    {
        ...
        total_animation_time = so_called_common_logic_main_menu_selection_animation_consts :: unselect_total_animation_time ;
        ...
        if ( so_called_platform_conditions :: fract_greater_than_fract ( time , total_animation_time ) )
        {
            ...
            so_called_sender_common_logic_main_menu_selection_animation_unselect_finished :: send ( so_called_message_common_logic_main_menu_selection_animation_unselect_finished ( ) ) ;
        }
