...
public :
    ...
    void receive ( typename messages :: logic_main_menu_selection_animation_disappear_transform_request ) ;
    void receive ( typename messages :: logic_main_menu_selection_animation_disappear_start ) ;
    void receive ( typename messages :: logic_main_menu_update ) ;
private :
    shy_logic_main_menu_selection_animation_disappear < mediator > & operator= ( const shy_logic_main_menu_selection_animation_disappear < mediator > & ) ;
...
template < typename mediator >
void shy_logic_main_menu_selection_animation_disappear < mediator > :: set_mediator ( typename platform_pointer :: template pointer < mediator > arg_mediator )
{
    _mediator = arg_mediator ;
}

template < typename mediator >
void shy_logic_main_menu_selection_animation_disappear < mediator > :: receive ( typename messages :: init )
{
...
template < typename mediator >
void shy_logic_main_menu_selection_animation_disappear < mediator > :: receive ( typename messages :: logic_main_menu_selection_animation_disappear_start )
{
    _logic_main_menu_update_state . disappear_started = _platform_math_consts . get ( ) . whole_true ;
    _logic_main_menu_update_state . time = _platform_math_consts . get ( ) . fract_0 ;
}

template < typename mediator >
void shy_logic_main_menu_selection_animation_disappear < mediator > :: receive ( typename messages :: logic_main_menu_update )
{
    if ( platform_conditions :: whole_is_true ( _logic_main_menu_update_state . disappear_started ) )
    {
        num_fract time_step ;
...
template < typename mediator >
void shy_logic_main_menu_selection_animation_disappear < mediator > :: receive ( typename messages :: logic_main_menu_selection_animation_disappear_transform_request )
{
...
template < typename mediator >
void shy_logic_main_menu_selection_animation_disappear < mediator > :: _compute_horizontal_scale ( )
{
    num_fract horizontal_scale_time_to_begin ;
    num_fract horizontal_scale_time_from_begin_to_end ;
...
template < typename mediator >
void shy_logic_main_menu_selection_animation_disappear < mediator > :: _compute_vertical_scale ( )
{
    num_fract vertical_scale_time_to_begin ;
    num_fract vertical_scale_time_from_begin_to_end ;
    num_fract time_begin ;
...
template < typename mediator >
void shy_logic_main_menu_selection_animation_disappear < mediator > :: _reply_computed_transform ( )
{
    typename messages :: logic_main_menu_selection_animation_disappear_transform_reply msg ;
    msg . scale_x = _logic_main_menu_selection_animation_disappear_transform_state . horizontal_scale ;
    msg . scale_y = _logic_main_menu_selection_animation_disappear_transform_state . vertical_scale ;
