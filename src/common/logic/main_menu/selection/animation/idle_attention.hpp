...
template < typename mediator >
void shy_logic_main_menu_selection_animation_idle_attention < mediator > :: set_mediator ( typename platform_pointer :: template pointer < mediator > arg_mediator )
{
    _mediator = arg_mediator ;
}

template < typename mediator >
void shy_logic_main_menu_selection_animation_idle_attention < mediator > :: receive ( typename messages :: init )
{
...
template < typename mediator >
void shy_logic_main_menu_selection_animation_idle_attention < mediator > :: receive ( typename messages :: logic_main_menu_launch_permit )
{
...
template < typename mediator >
void shy_logic_main_menu_selection_animation_idle_attention < mediator > :: receive ( typename messages :: logic_main_menu_update )
{
...
template < typename mediator >
void shy_logic_main_menu_selection_animation_idle_attention < mediator > :: receive ( typename messages :: logic_main_menu_selection_animation_idle_attention_transform_request )
{
...
template < typename mediator >
void shy_logic_main_menu_selection_animation_idle_attention < mediator > :: _reply_transform ( )
{
    typename messages :: logic_main_menu_selection_animation_idle_attention_transform_reply msg ;
    msg . scale_x = _logic_main_menu_selection_animation_idle_attention_transform_state . horizontal_scale ;
    msg . scale_y = _logic_main_menu_selection_animation_idle_attention_transform_state . vertical_scale ;
    _mediator . get ( ) . send ( msg ) ;
}

template < typename mediator >
void shy_logic_main_menu_selection_animation_idle_attention < mediator > :: _compute_horizontal_scale ( )
{
...
template < typename mediator >
void shy_logic_main_menu_selection_animation_idle_attention < mediator > :: _compute_vertical_scale ( )
{
    _compute_animation_scale
...
template < typename mediator >
void shy_logic_main_menu_selection_animation_idle_attention < mediator > :: _compute_animation_scale 
    ( num_fract & scale
    , num_fract scale_min
    , num_fract scale_max
    , num_fract period_in_seconds
