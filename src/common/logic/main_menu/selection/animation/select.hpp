...
class shy_logic_main_menu_selection_animation_select
{
    ...
    class _logic_main_menu_selection_animation_select_consts_type
    {
    public :
        _logic_main_menu_selection_animation_select_consts_type ( ) ;
    public :
...
private :
    ...
    const _logic_main_menu_selection_animation_select_consts_type _logic_main_menu_selection_animation_select_consts ;
...
{
    platform_math :: make_num_fract ( horizontal_scale_time_to_begin , 0 , 100 ) ;
    platform_math :: make_num_fract ( horizontal_scale_time_from_begin_to_end , 7 , 100 ) ;
    platform_math :: make_num_fract ( horizontal_scale_value_begin , 8 , 10 ) ;
    platform_math :: make_num_fract ( horizontal_scale_value_end , 10 , 10 ) ;
    ...
    platform_math :: make_num_fract ( vertical_scale_value_begin , 5 , 10 ) ;
    platform_math :: make_num_fract ( vertical_scale_value_end , 10 , 10 ) ;
...
void shy_logic_main_menu_selection_animation_select < mediator > :: _compute_horizontal_scale ( )
{
    ...
    horizontal_scale_time_to_begin = _logic_main_menu_selection_animation_select_consts . horizontal_scale_time_to_begin ;
    horizontal_scale_time_from_begin_to_end = _logic_main_menu_selection_animation_select_consts . horizontal_scale_time_from_begin_to_end ;
    ...
    engine_math :: hard_in_easy_out
        ...
        , _logic_main_menu_selection_animation_select_consts . horizontal_scale_value_begin
        , time_begin
        , _logic_main_menu_selection_animation_select_consts . horizontal_scale_value_end
        , time_end
        ) ;
}
