...
class shy_logic_main_menu_animation_disappear
{
    ...
    class _logic_main_menu_animation_disappear_consts_type
    {
    public :
        _logic_main_menu_animation_disappear_consts_type ( ) ;
    public :
...
template < typename mediator >
shy_logic_main_menu_animation_disappear < mediator > :: _logic_main_menu_animation_disappear_consts_type :: _logic_main_menu_animation_disappear_consts_type ( )
{
...
template < typename mediator >
void shy_logic_main_menu_animation_disappear < mediator > :: receive ( typename messages :: logic_main_menu_launch_permit )
{
...
template < typename mediator >
void shy_logic_main_menu_animation_disappear < mediator > :: _compute_delay ( )
{
...
template < typename mediator >
void shy_logic_main_menu_animation_disappear < mediator > :: _compute_time ( )
{
    num_fract time_begin ;
    num_fract time_end ;
    num_fract delay ;
...
template < typename mediator >
void shy_logic_main_menu_animation_disappear < mediator > :: _update_request_received ( )
{
    num_fract time_step ;
    num_fract animation_time ;
    animation_time = _logic_main_menu_animation_disappear_consts . animation_time_in_seconds ;
