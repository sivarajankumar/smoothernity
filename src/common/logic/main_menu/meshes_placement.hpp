...
public :
    ...
    void receive ( typename messages :: logic_main_menu_animated_transform_reply ) ;
private :
...
template < typename mediator >
void shy_logic_main_menu_meshes_placement < mediator > :: receive ( typename messages :: logic_main_menu_animated_transform_reply msg )
{
    if ( platform_conditions :: whole_is_true ( _logic_main_menu_animated_transform_state . requested )
      && platform_conditions :: wholes_are_equal ( _logic_main_menu_animated_transform_state . requested_row , msg . row )
      && platform_conditions :: wholes_are_equal ( _logic_main_menu_animated_transform_state . requested_col , msg . col )
       )
    {
        _logic_main_menu_animated_transform_state . requested = _platform_math_consts . get ( ) . whole_false ;
        _logic_main_menu_animated_transform_state . replied = _platform_math_consts . get ( ) . whole_true ;
        _logic_main_menu_animated_transform_state . transform = msg . transform ;
        _proceed_with_placement ( ) ;
    }
}
...
void shy_logic_main_menu_meshes_placement < mediator > :: _proceed_with_placement ( )
{
    ...
    if ( platform_conditions :: whole_is_true ( _logic_main_menu_animated_transform_state . replied ) )
    {
        _logic_main_menu_animated_transform_state . replied = _platform_math_consts . get ( ) . whole_false ;
...
template < typename mediator >
void shy_logic_main_menu_meshes_placement < mediator > :: _obtain_animated_transform ( )
{
    _logic_main_menu_animated_transform_state . requested = _platform_math_consts . get ( ) . whole_true ;
    _logic_main_menu_animated_transform_state . requested_row = _logic_main_menu_mesh_row_col_state . row ;
    _logic_main_menu_animated_transform_state . requested_col = _logic_main_menu_mesh_row_col_state . col ;
    typename messages :: logic_main_menu_animated_transform_request msg ;
...
template < typename mediator >
void shy_logic_main_menu_meshes_placement < mediator > :: _animated_transform_received ( )
{
    _place_current_mesh ( ) ;
    _move_to_next_mesh ( ) ;
}
