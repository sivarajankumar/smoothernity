...
template < typename mediator >
void shy_logic_main_menu_animation < mediator > :: receive ( typename messages :: logic_main_menu_animation_idle_transform_reply msg )
{
...
template < typename mediator >
void shy_logic_main_menu_animation < mediator > :: receive ( typename messages :: logic_main_menu_animation_disappear_transform_reply msg )
{
...
void shy_logic_main_menu_animation < mediator > :: _obtain_appear_transform ( )
{
    ...
    typename messages :: logic_main_menu_animation_appear_transform_request msg ;
...
void shy_logic_main_menu_animation < mediator > :: _obtain_idle_transform ( )
{
    ...
    typename messages :: logic_main_menu_animation_idle_transform_request msg ;
    msg . row = _logic_main_menu_animation_transform_state . row ;
    msg . col = _logic_main_menu_animation_transform_state . col ;
    _mediator . get ( ) . send ( msg ) ;
}
