...
template < typename mediator >
void shy_logic_main_menu_animation < mediator > :: _idle_transform_received ( )
{
    _compute_transform ( ) ;
...
void shy_logic_main_menu_animation < mediator > :: _compute_transform ( )
{
    ...
    scale = _logic_main_menu_animation_idle_transform_state . scale ;
