...
{
    platform_math :: math_make_num_whole ( _text_mesh_created , false ) ;
    platform_math :: math_make_num_whole ( _text_prepare_permitted , false ) ;
    platform_math :: math_make_num_whole ( _scale_frames , 0 ) ;
    platform_math :: math_make_num_whole ( _letter_size_x , 0 ) ;
    platform_math :: math_make_num_whole ( _letter_size_y , 0 ) ;
    platform_math :: math_make_num_whole ( _origin_x , 0 ) ;
    platform_math :: math_make_num_whole ( _origin_y , 0 ) ;
}
...
{
    if ( platform_conditions :: condition_true ( _text_mesh_created ) )
    {
...
shy_logic_text < mediator > :: alphabet_english :: alphabet_english ( )
{
    ...
    A . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    B . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    C . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    D . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    E . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    F . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    G . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    H . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    I . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    J . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    K . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    L . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    M . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    N . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    O . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    P . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    Q . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    R . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    S . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    T . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    U . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    V . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    W . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    X . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    Y . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
    Z . _letter_id = index ; platform_math :: math_inc_whole ( index ) ;
}
...
{
    platform_math :: math_make_num_whole ( _text_prepare_permitted , true ) ;
}
...
{
    if ( platform_conditions :: condition_true ( _text_prepare_permitted ) )
    {
        if ( platform_conditions :: condition_false ( _text_mesh_created ) )
        {
            _create_text_mesh ( ) ;
            _create_text_texture ( ) ;
            platform_math :: math_make_num_whole ( _text_mesh_created , true ) ;
...
void shy_logic_text < mediator > :: _create_text_mesh ( )
{
    ...
    platform_math :: math_make_num_fract ( color_r , _canvas_r , 255 ) ;
    platform_math :: math_make_num_fract ( color_g , _canvas_g , 255 ) ;
    platform_math :: math_make_num_fract ( color_b , _canvas_b , 255 ) ;
    platform_math :: math_make_num_fract ( color_a , _canvas_a , 255 ) ;
...
void shy_logic_text < mediator > :: _create_text_texture ( )
{
    ...
    platform_math :: math_make_num_whole ( small_size , 16 ) ;
    platform_math :: math_make_num_whole ( big_size , 32 ) ;
    platform_math :: math_make_num_fract ( filler_r , 1 , 1 ) ;
    platform_math :: math_make_num_fract ( filler_g , 1 , 1 ) ;
    platform_math :: math_make_num_fract ( filler_b , 1 , 1 ) ;
    platform_math :: math_make_num_fract ( filler_a , 1 , 1 ) ;
    platform_math :: math_make_num_fract ( eraser_r , 0 , 1 ) ;
    platform_math :: math_make_num_fract ( eraser_g , 0 , 1 ) ;
    platform_math :: math_make_num_fract ( eraser_b , 0 , 1 ) ;
    platform_math :: math_make_num_fract ( eraser_a , 0 , 1 ) ;
    platform_render :: render_set_texel_color ( _filler , filler_r , filler_g , filler_b , filler_a ) ;
    platform_render :: render_set_texel_color ( _eraser , eraser_r , eraser_g , eraser_b , eraser_a ) ;
    _mediator . get ( ) . texture_create ( _text_texture_id ) ;
        ...
        )
    {
        for ( num_whole y = platform :: math_consts . whole_0 
            ; platform_conditions :: condition_whole_less_than_whole ( y , texture_height ) 
...
void shy_logic_text < mediator > :: _next_letter_col ( )
{
    ...
    _mediator . get ( ) . texture_width ( texture_width ) ;
    platform_math :: math_div_wholes ( delta_x , _letter_size_x , platform :: math_consts . whole_8 ) ;
    platform_math :: math_add_to_whole ( _origin_x , _letter_size_x ) ;
    platform_math :: math_add_to_whole ( _origin_x , delta_x ) ;
    platform_math :: math_sub_wholes ( right_limit , texture_width , _letter_size_x ) ;
    if ( platform_conditions :: condition_whole_greater_or_equal_to_whole ( _origin_x , right_limit ) )
    {
        num_whole delta_y ;
        platform_math :: math_div_wholes ( delta_y , _letter_size_y , platform :: math_consts . whole_4 ) ;
        platform_math :: math_sub_from_whole ( _origin_y , delta_y ) ;
        _next_letter_row ( ) ;
    }
}
...
{
    platform_math :: math_sub_from_whole ( _origin_y , _letter_size_y ) ;
    platform_math :: math_make_num_whole ( _origin_x , 0 ) ;
}
...
void shy_logic_text < mediator > :: _store_tex_coords ( letter_id letter , _letters_tex_coords & letters_tex_coords )
{
    ...
    platform_math :: math_add_wholes ( whole_right , _origin_x , _letter_size_x ) ;
    platform_math :: math_add_wholes ( whole_top , _origin_y , _letter_size_y ) ;
    _mediator . get ( ) . texture_width ( whole_texture_width ) ;
    _mediator . get ( ) . texture_height ( whole_texture_height ) ;
    platform_math :: math_make_fract_from_whole ( fract_texture_width , whole_texture_width ) ;
    platform_math :: math_make_fract_from_whole ( fract_texture_height , whole_texture_height ) ;
    platform_math :: math_make_fract_from_whole ( coords . left , whole_left ) ;
    platform_math :: math_make_fract_from_whole ( coords . bottom , whole_bottom ) ;
    platform_math :: math_make_fract_from_whole ( coords . right , whole_right ) ;
    platform_math :: math_make_fract_from_whole ( coords . top , whole_top ) ;
    platform_math :: math_div_fract_by ( coords . left , fract_texture_width ) ;
    platform_math :: math_div_fract_by ( coords . bottom , fract_texture_height ) ;
    platform_math :: math_div_fract_by ( coords . right , fract_texture_width ) ;
    platform_math :: math_div_fract_by ( coords . top , fract_texture_height ) ;
...
void shy_logic_text < mediator > :: _rasterize_letter ( letter_id letter , _letters_tex_coords & letters_tex_coords )
{
    ...
    if      ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . A . _letter_id ) ) _rasterize_font_english_A ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . B . _letter_id ) ) _rasterize_font_english_B ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . C . _letter_id ) ) _rasterize_font_english_C ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . D . _letter_id ) ) _rasterize_font_english_D ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . E . _letter_id ) ) _rasterize_font_english_E ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . F . _letter_id ) ) _rasterize_font_english_F ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . G . _letter_id ) ) _rasterize_font_english_G ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . H . _letter_id ) ) _rasterize_font_english_H ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . I . _letter_id ) ) _rasterize_font_english_I ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . J . _letter_id ) ) _rasterize_font_english_J ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . K . _letter_id ) ) _rasterize_font_english_K ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . L . _letter_id ) ) _rasterize_font_english_L ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . M . _letter_id ) ) _rasterize_font_english_M ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . N . _letter_id ) ) _rasterize_font_english_N ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . O . _letter_id ) ) _rasterize_font_english_O ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . P . _letter_id ) ) _rasterize_font_english_P ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . Q . _letter_id ) ) _rasterize_font_english_Q ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . R . _letter_id ) ) _rasterize_font_english_R ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . S . _letter_id ) ) _rasterize_font_english_S ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . T . _letter_id ) ) _rasterize_font_english_T ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . U . _letter_id ) ) _rasterize_font_english_U ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . V . _letter_id ) ) _rasterize_font_english_V ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . W . _letter_id ) ) _rasterize_font_english_W ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . X . _letter_id ) ) _rasterize_font_english_X ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . Y . _letter_id ) ) _rasterize_font_english_Y ( ) ;
    else if ( platform_conditions :: condition_wholes_are_equal ( letter . _letter_id , _alphabet_english . Z . _letter_id ) ) _rasterize_font_english_Z ( ) ;
}
...
void shy_logic_text < mediator > :: _rasterize_font_english_A ( )
{
    ...
    platform_math :: math_sub_wholes ( outer_top , _letter_size_y , platform :: math_consts . whole_1 ) ;
    platform_math :: math_div_wholes ( outer_center , _letter_size_x , platform :: math_consts . whole_2 ) ;
    platform_math :: math_sub_wholes ( outer_right , _letter_size_x , platform :: math_consts . whole_1 ) ;
    ...
    platform_math :: math_mul_wholes ( inner_top , _letter_size_y , platform :: math_consts . whole_2 ) ;
    platform_math :: math_div_whole_by ( inner_top , platform :: math_consts . whole_3 ) ;
    platform_math :: math_div_wholes ( inner_center , _letter_size_x , platform :: math_consts . whole_2 ) ;
    platform_math :: math_div_wholes ( inner_left , _letter_size_x , platform :: math_consts . whole_5 ) ;
    platform_math :: math_mul_wholes ( inner_right , _letter_size_x , platform :: math_consts . whole_4 ) ;
    platform_math :: math_div_whole_by ( inner_right , platform :: math_consts . whole_5 ) ;
    ...
    platform_math :: math_mul_wholes ( board_top , _letter_size_y , platform :: math_consts . whole_3 ) ;
    platform_math :: math_div_whole_by ( board_top , platform :: math_consts . whole_7 ) ;
    platform_math :: math_mul_wholes ( board_bottom , _letter_size_y , platform :: math_consts . whole_2 ) ;
    platform_math :: math_div_whole_by ( board_bottom , platform :: math_consts . whole_7 ) ;
    platform_math :: math_sub_wholes ( outer_left_minus_center , outer_left , outer_center ) ;
    platform_math :: math_sub_wholes ( outer_right_minus_center , outer_right , outer_center ) ;
    platform_math :: math_sub_wholes ( outer_top_minus_board_top , outer_top , board_top ) ;
    platform_math :: math_sub_wholes ( outer_top_minus_board_bottom , outer_top , board_bottom ) ;
    platform_math :: math_sub_wholes ( outer_top_minus_bottom , outer_top , outer_bottom ) ;    
    platform_math :: math_mul_wholes ( board_top_left , outer_left_minus_center , outer_top_minus_board_top ) ;
    platform_math :: math_div_whole_by ( board_top_left , outer_top_minus_bottom ) ;
    platform_math :: math_add_to_whole ( board_top_left , outer_center ) ;
    platform_math :: math_mul_wholes ( board_bottom_left , outer_left_minus_center , outer_top_minus_board_bottom ) ;
    platform_math :: math_div_whole_by ( board_bottom_left , outer_top_minus_bottom ) ;
    platform_math :: math_add_to_whole ( board_bottom_left , outer_center ) ;
    platform_math :: math_mul_wholes ( board_top_right , outer_right_minus_center , outer_top_minus_board_top ) ;
    platform_math :: math_div_whole_by ( board_top_right , outer_top_minus_bottom ) ;
    platform_math :: math_add_to_whole ( board_top_right , outer_center ) ;
    platform_math :: math_mul_wholes ( board_bottom_right , outer_right_minus_center , outer_top_minus_board_bottom ) ;
    platform_math :: math_div_whole_by ( board_bottom_right , outer_top_minus_bottom ) ;
    platform_math :: math_add_to_whole ( board_bottom_right , outer_center ) ;    
    _rasterize_use_texel ( _filler ) ;
...
void shy_logic_text < mediator > :: _rasterize_font_english_B ( )
{
    ...
    platform_math :: math_sub_wholes ( ellipse_y_top , _letter_size_y , platform :: math_consts . whole_1 ) ;
    platform_math :: math_div_wholes ( ellipse_y_mid , _letter_size_y , platform :: math_consts . whole_2 ) ;
    platform_math :: math_sub_wholes ( ellipse_x_right , _letter_size_x , platform :: math_consts . whole_1 ) ;    
    _rasterize_use_texel ( _filler ) ;
    ...
    num_whole spine_top ;
    platform_math :: math_div_wholes ( spine_right , _letter_size_x , platform :: math_consts . whole_2 ) ;
    platform_math :: math_sub_wholes ( spine_top , _letter_size_y , platform :: math_consts . whole_1 ) ;
    _rasterize_use_texel ( _filler ) ;
    ...
    platform_math :: math_make_num_whole ( hole_divider , 16 ) ;
    platform_math :: math_mul_wholes ( hole_left , _letter_size_x , platform :: math_consts . whole_4 ) ;
    platform_math :: math_div_whole_by ( hole_left , hole_divider ) ;
    platform_math :: math_make_num_whole ( hole_right , 12 ) ;
    platform_math :: math_mul_whole_by ( hole_right , _letter_size_x ) ;
    platform_math :: math_div_whole_by ( hole_right , hole_divider ) ;
    platform_math :: math_make_num_whole ( hole_top , 13 ) ;
    platform_math :: math_mul_whole_by ( hole_top , _letter_size_y ) ;
    platform_math :: math_div_whole_by ( hole_top , hole_divider ) ;
    platform_math :: math_mul_wholes ( hole_bottom , _letter_size_y , platform :: math_consts . whole_3 ) ;
    platform_math :: math_div_whole_by ( hole_bottom , hole_divider ) ;
    platform_math :: math_mul_wholes ( hole_height , _letter_size_y , platform :: math_consts . whole_3 ) ;
    platform_math :: math_div_whole_by ( hole_height , hole_divider ) ;
    platform_math :: math_sub_wholes ( hole_top_minus_height , hole_top , hole_height ) ;
    platform_math :: math_add_wholes ( hole_bottom_plus_height , hole_bottom , hole_height ) ;
    _rasterize_use_texel ( _eraser ) ;
    ...
    platform_math :: math_add_wholes ( hole_center_x , hole_left , hole_right ) ;
    platform_math :: math_div_whole_by ( hole_center_x , platform :: math_consts . whole_2 ) ;
    _rasterize_use_texel ( _eraser ) ;
...
void shy_logic_text < mediator > :: _rasterize_font_english_C ( )
{
    ...
    num_whole right_limit ;
    num_whole top_limit ;
    platform_math :: math_sub_wholes ( right_limit , _letter_size_x , platform :: math_consts . whole_1 ) ;
    platform_math :: math_sub_wholes ( top_limit , _letter_size_y , platform :: math_consts . whole_1 ) ;
    _rasterize_use_texel ( _filler ) ;
    ...
    num_whole hole_left ;
    num_whole hole_right ;
    platform_math :: math_mul_wholes ( hole_top , _letter_size_y , platform :: math_consts . whole_4 ) ;
    platform_math :: math_div_whole_by ( hole_top , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_div_wholes ( hole_bottom , _letter_size_y , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_div_wholes ( hole_left , _letter_size_x , platform :: math_consts . whole_5 ) ;
    platform_math :: math_mul_wholes ( hole_right , _letter_size_x , platform :: math_consts . whole_4 ) ;
    platform_math :: math_div_whole_by ( hole_right , platform :: math_consts . whole_5 ) ;    
    _rasterize_use_texel ( _eraser ) ;
    ...
    platform_math :: math_add_wholes ( hole_center_x , hole_left , hole_right ) ;
    platform_math :: math_div_whole_by ( hole_center_x , platform :: math_consts . whole_2 ) ;    
    platform_math :: math_mul_wholes ( hole_center_top , _letter_size_y , platform :: math_consts . whole_5 ) ;
    platform_math :: math_div_whole_by ( hole_center_top , platform :: math_consts . whole_7 ) ;    
    platform_math :: math_mul_wholes ( hole_center_bottom , _letter_size_y , platform :: math_consts . whole_2 ) ;
    platform_math :: math_div_whole_by ( hole_center_bottom , platform :: math_consts . whole_7 ) ;
    _rasterize_use_texel ( _eraser ) ;
...
void shy_logic_text < mediator > :: _rasterize_font_english_D ( )
{
    ...
    platform_math :: math_div_wholes ( half_size_x , _letter_size_x , platform :: math_consts . whole_2 ) ;
    _rasterize_use_texel ( _filler ) ;
...
void shy_logic_text < mediator > :: _rasterize_font_english_E ( )
{
    ...
    num_whole top_limit ;
    platform_math :: math_sub_wholes ( top_limit , _letter_size_y , platform :: math_consts . whole_1 ) ;
    platform_math :: math_mul_wholes ( right , _letter_size_x , platform :: math_consts . whole_4 ) ;
    platform_math :: math_div_whole_by ( right , platform :: math_consts . whole_5 ) ;
    _rasterize_use_texel ( _filler ) ;
    ...
    num_whole hole_bottom ;
    platform_math :: math_div_wholes ( hole_left , _letter_size_x , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_sub_wholes ( hole_right , _letter_size_x , platform :: math_consts . whole_1 ) ;    
    platform_math :: math_mul_wholes ( hole_top , _letter_size_y , platform :: math_consts . whole_4 ) ;
    platform_math :: math_div_whole_by ( hole_top , platform :: math_consts . whole_5 ) ;
    platform_math :: math_mul_wholes ( hole_mid_top , _letter_size_y , platform :: math_consts . whole_3 ) ;
    platform_math :: math_div_whole_by ( hole_mid_top , platform :: math_consts . whole_5 ) ;
    platform_math :: math_mul_wholes ( hole_mid_bottom , _letter_size_y , platform :: math_consts . whole_2 ) ;
    platform_math :: math_div_whole_by ( hole_mid_bottom , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_div_wholes ( hole_bottom , _letter_size_y , platform :: math_consts . whole_5 ) ;
    _rasterize_use_texel ( _eraser ) ;
...
void shy_logic_text < mediator > :: _rasterize_font_english_G ( )
{
    ...
    platform_math :: math_mul_wholes ( hole_center_top , _letter_size_y , platform :: math_consts . whole_5 ) ;
    platform_math :: math_div_whole_by ( hole_center_top , platform :: math_consts . whole_7 ) ;    
    platform_math :: math_mul_wholes ( hole_center_bottom , _letter_size_y , platform :: math_consts . whole_3 ) ;
    platform_math :: math_div_whole_by ( hole_center_bottom , platform :: math_consts . whole_7 ) ;    
    _rasterize_use_texel ( _eraser ) ;
    _rasterize_rect ( hole_center_x , hole_center_top , right_limit , hole_center_bottom ) ;
    ...
    platform_math :: math_mul_wholes ( brick_top , _letter_size_y , platform :: math_consts . whole_4 ) ;
    platform_math :: math_div_whole_by ( brick_top , platform :: math_consts . whole_7 ) ;    
    platform_math :: math_mul_wholes ( brick_bottom , _letter_size_y , platform :: math_consts . whole_3 ) ;
    platform_math :: math_div_whole_by ( brick_bottom , platform :: math_consts . whole_7 ) ;    
    platform_math :: math_mul_wholes ( brick_left , _letter_size_x , platform :: math_consts . whole_2 ) ;
    platform_math :: math_div_whole_by ( brick_left , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_sub_wholes ( brick_right , _letter_size_x , platform :: math_consts . whole_1 ) ;    
    _rasterize_use_texel ( _filler ) ;
...
void shy_logic_text < mediator > :: _rasterize_font_english_H ( )
{
    ...
    num_whole hole_mid_bottom ;
    platform_math :: math_div_wholes ( hole_left , _letter_size_x , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_mul_wholes ( hole_right , _letter_size_x , platform :: math_consts . whole_3 ) ;
    platform_math :: math_div_whole_by ( hole_right , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_mul_wholes ( hole_mid_top , _letter_size_y , platform :: math_consts . whole_3 ) ;
    platform_math :: math_div_whole_by ( hole_mid_top , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_mul_wholes ( hole_mid_bottom , _letter_size_y , platform :: math_consts . whole_2 ) ;
...
void shy_logic_text < mediator > :: _rasterize_font_english_I ( )
{
    ...
    num_whole right ;
    platform_math :: math_sub_wholes ( top_limit , _letter_size_y , platform :: math_consts . whole_1 ) ;    
    platform_math :: math_mul_wholes ( right , _letter_size_x , platform :: math_consts . whole_6 ) ;
    platform_math :: math_div_whole_by ( right , platform :: math_consts . whole_7 ) ;
    _rasterize_use_texel ( _filler ) ;
    _rasterize_rect ( platform :: math_consts . whole_0 , platform :: math_consts . whole_0 , right , top_limit ) ;
    ...
    num_whole hole_top ;
    num_whole hole_bottom ;
    platform_math :: math_mul_wholes ( hole_mid_left , _letter_size_x , platform :: math_consts . whole_2 ) ;
    platform_math :: math_div_whole_by ( hole_mid_left , platform :: math_consts . whole_7 ) ;    
    platform_math :: math_mul_wholes ( hole_mid_right , _letter_size_x , platform :: math_consts . whole_4 ) ;
    platform_math :: math_div_whole_by ( hole_mid_right , platform :: math_consts . whole_7 ) ;    
    platform_math :: math_mul_wholes ( hole_top , _letter_size_y , platform :: math_consts . whole_4 ) ;
    platform_math :: math_div_whole_by ( hole_top , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_div_wholes ( hole_bottom , _letter_size_y , platform :: math_consts . whole_5 ) ;
    _rasterize_use_texel ( _eraser ) ;
...
void shy_logic_text < mediator > :: _rasterize_font_english_J ( )
{
    ...
    platform_math :: math_mul_wholes ( right , _letter_size_x , platform :: math_consts . whole_4 ) ;
    platform_math :: math_div_whole_by ( right , platform :: math_consts . whole_5 ) ;
    platform_math :: math_mul_wholes ( circle_top , _letter_size_y , platform :: math_consts . whole_4 ) ;
    platform_math :: math_div_whole_by ( circle_top , platform :: math_consts . whole_5 ) ;
    _rasterize_use_texel ( _filler ) ;
    ...
    platform_math :: math_div_wholes ( circle_center_y , circle_top , platform :: math_consts . whole_2 ) ;
    _rasterize_use_texel ( _filler ) ;
    ...
    platform_math :: math_mul_wholes ( hole_right , _letter_size_x , platform :: math_consts . whole_3 ) ;
    platform_math :: math_div_whole_by ( hole_right , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_mul_wholes ( hole_top , _letter_size_y , platform :: math_consts . whole_3 ) ;
    platform_math :: math_div_whole_by ( hole_top , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_div_wholes ( hole_bottom , _letter_size_y , platform :: math_consts . whole_5 ) ;
    _rasterize_use_texel ( _eraser ) ;
    _rasterize_ellipse_in_rect ( hole_left , hole_top , hole_right , hole_bottom ) ;
    ...
    platform_math :: math_add_wholes ( hole_center_y , hole_top , hole_bottom ) ;
    platform_math :: math_div_whole_by ( hole_center_y , platform :: math_consts . whole_2 ) ;
    _rasterize_use_texel ( _eraser ) ;
...
void shy_logic_text < mediator > :: _rasterize_font_english_K ( )
{
    ...
    platform_math :: math_sub_wholes ( top_limit , _letter_size_y , platform :: math_consts . whole_1 ) ;
    platform_math :: math_sub_wholes ( right_limit , _letter_size_x , platform :: math_consts . whole_1 ) ;
    platform_math :: math_div_wholes ( half_size_y , _letter_size_y , platform :: math_consts . whole_2 ) ;
    _rasterize_use_texel ( _filler ) ;
    _rasterize_rect ( platform :: math_consts . whole_0 , platform :: math_consts . whole_0 , right_limit , top_limit ) ;

    num_whole hole_1_left ;
    platform_math :: math_mul_wholes ( hole_1_left , _letter_size_x , platform :: math_consts . whole_3 ) ;
    platform_math :: math_div_whole_by ( hole_1_left , platform :: math_consts . whole_9 ) ;
    _rasterize_use_texel ( _eraser ) ;
    ...
    platform_math :: math_mul_wholes ( hole_2_right , _letter_size_x , platform :: math_consts . whole_6 ) ;
    platform_math :: math_div_whole_by ( hole_2_right , platform :: math_consts . whole_9 ) ;
    _rasterize_use_texel ( _eraser ) ;
    ...
    num_whole spine_right ;
    platform_math :: math_div_wholes ( spine_right , _letter_size_x , platform :: math_consts . whole_5 ) ;
    _rasterize_use_texel ( _filler ) ;
...
void shy_logic_text < mediator > :: _rasterize_font_english_M ( )
{
    ...
    platform_math :: math_sub_wholes ( top_limit , _letter_size_y , platform :: math_consts . whole_1 ) ;    
    platform_math :: math_div_wholes ( spine_1_right , _letter_size_x , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_mul_wholes ( spine_2_left , _letter_size_x , platform :: math_consts . whole_3 ) ;
    platform_math :: math_div_whole_by ( spine_2_left , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_mul_wholes ( spine_2_right , _letter_size_x , platform :: math_consts . whole_4 ) ;
    platform_math :: math_div_whole_by ( spine_2_right , platform :: math_consts . whole_5 ) ;    
    _rasterize_use_texel ( _filler ) ;
    ...
    platform_math :: math_mul_wholes ( board_height , _letter_size_y , platform :: math_consts . whole_2 ) ;
    platform_math :: math_div_whole_by ( board_height , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_div_wholes ( board_center_x , spine_2_right , platform :: math_consts . whole_2 ) ;    
    platform_math :: math_sub_wholes ( top_minus_board_height , _letter_size_y , board_height ) ;
    _rasterize_use_texel ( _filler ) ;
...
void shy_logic_text < mediator > :: _rasterize_font_english_N ( )
{
    ...
    num_whole board_height ;
    num_whole top_minus_board_height ;
    platform_math :: math_div_wholes ( board_height , _letter_size_y , platform :: math_consts . whole_3 ) ;    
    platform_math :: math_sub_wholes ( top_minus_board_height , _letter_size_y , board_height ) ;
    _rasterize_use_texel ( _filler ) ;
...
void shy_logic_text < mediator > :: _rasterize_font_english_P ( )
{
    ...
    platform_math :: math_div_wholes ( ellipse_left , _letter_size_x , platform :: math_consts . whole_2 ) ;    
    platform_math :: math_sub_wholes ( ellipse_right , _letter_size_x , platform :: math_consts . whole_1 ) ;    
    platform_math :: math_mul_wholes ( ellipse_bottom , _letter_size_y , platform :: math_consts . whole_2 ) ;
    platform_math :: math_div_whole_by ( ellipse_bottom , platform :: math_consts . whole_5 ) ;
    _rasterize_use_texel ( _filler ) ;
    _rasterize_ellipse_in_rect ( ellipse_left , top_limit , ellipse_right , ellipse_bottom ) ;
    
    num_whole ellipse_center_x ;
    platform_math :: math_add_wholes ( ellipse_center_x , ellipse_left , ellipse_right ) ;
    platform_math :: math_div_whole_by ( ellipse_center_x , platform :: math_consts . whole_2 ) ;    
    _rasterize_use_texel ( _filler ) ;
    ...
    num_whole hole_center_x ;
    platform_math :: math_mul_wholes ( hole_left , _letter_size_x , platform :: math_consts . whole_4 ) ;
    platform_math :: math_div_whole_by ( hole_left , platform :: math_consts . whole_6 ) ;    
    platform_math :: math_mul_wholes ( hole_right , _letter_size_x , platform :: math_consts . whole_5 ) ;
    platform_math :: math_div_whole_by ( hole_right , platform :: math_consts . whole_6 ) ;    
    platform_math :: math_mul_wholes ( hole_top , _letter_size_y , platform :: math_consts . whole_4 ) ;
    platform_math :: math_div_whole_by ( hole_top , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_mul_wholes ( hole_bottom , _letter_size_y , platform :: math_consts . whole_3 ) ;
    platform_math :: math_div_whole_by ( hole_bottom , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_add_wholes ( hole_center_x , hole_left , hole_right ) ;
    platform_math :: math_div_whole_by ( hole_center_x , platform :: math_consts . whole_2 ) ;    
    _rasterize_use_texel ( _eraser ) ;
    _rasterize_ellipse_in_rect ( hole_left , hole_top , hole_right , hole_bottom ) ;
...
void shy_logic_text < mediator > :: _rasterize_font_english_Q ( )
{
    ...
    platform_math :: math_div_wholes ( board_width , _letter_size_x , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_div_wholes ( board_left , _letter_size_x , platform :: math_consts . whole_2 ) ;    
    platform_math :: math_mul_wholes ( board_top , _letter_size_y , platform :: math_consts . whole_2 ) ;
    platform_math :: math_div_whole_by ( board_top , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_sub_wholes ( right_minus_board_width , _letter_size_x , board_width ) ;
    platform_math :: math_add_wholes ( left_plus_board_width , board_left , board_width ) ;    
    _rasterize_use_texel ( _filler ) ;
...
void shy_logic_text < mediator > :: _rasterize_font_english_R ( )
{
    ...
    platform_math :: math_div_wholes ( ellipse_left , _letter_size_x , platform :: math_consts . whole_2 ) ;    
    platform_math :: math_sub_wholes ( ellipse_right , _letter_size_x , platform :: math_consts . whole_1 ) ;    
    platform_math :: math_sub_wholes ( ellipse_top , _letter_size_y , platform :: math_consts . whole_1 ) ;    
    platform_math :: math_mul_wholes ( ellipse_bottom , _letter_size_y , platform :: math_consts . whole_2 ) ;
    platform_math :: math_div_whole_by ( ellipse_bottom , platform :: math_consts . whole_5 ) ;    
    _rasterize_use_texel ( _filler ) ;
    ...
    platform_math :: math_mul_wholes ( board_width , _letter_size_x , platform :: math_consts . whole_2 ) ;
    platform_math :: math_div_whole_by ( board_width , platform :: math_consts . whole_7 ) ;    
    platform_math :: math_sub_wholes ( right_minus_board_width , _letter_size_x , board_width ) ;    
    platform_math :: math_add_wholes ( spine_plus_board_width , spine_right , board_width ) ;    
    _rasterize_use_texel ( _filler ) ;
...
void shy_logic_text < mediator > :: _rasterize_font_english_S ( )
{
    ...
    platform_math :: math_make_num_whole ( circle_high_left , 0 ) ;    
    platform_math :: math_div_wholes ( circle_high_right , _letter_size_x , platform :: math_consts . whole_2 ) ;    
    platform_math :: math_sub_wholes ( circle_high_top , _letter_size_y , platform :: math_consts . whole_1 ) ;    
    platform_math :: math_mul_wholes ( circle_high_bottom , _letter_size_y , platform :: math_consts . whole_2 ) ;
    platform_math :: math_div_whole_by ( circle_high_bottom , platform :: math_consts . whole_5 ) ;    
    _rasterize_use_texel ( _filler ) ;
    ...
    platform_math :: math_div_wholes ( circle_low_left , _letter_size_x , platform :: math_consts . whole_2 ) ;    
    platform_math :: math_sub_wholes ( circle_low_right , _letter_size_x , platform :: math_consts . whole_1 ) ;    
    platform_math :: math_mul_wholes ( circle_low_top , _letter_size_y , platform :: math_consts . whole_3 ) ;
    platform_math :: math_div_whole_by ( circle_low_top , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_make_num_whole ( circle_low_bottom , 0 ) ;
    ...
    platform_math :: math_div_wholes ( board_mid_left , _letter_size_x , platform :: math_consts . whole_4 ) ;    
    platform_math :: math_mul_wholes ( board_mid_right , _letter_size_x , platform :: math_consts . whole_3 ) ;
    platform_math :: math_div_whole_by ( board_mid_right , platform :: math_consts . whole_4 ) ;    
    ...
    platform_math :: math_mul_wholes ( board_high_right , _letter_size_x , platform :: math_consts . whole_8 ) ;
    platform_math :: math_div_whole_by ( board_high_right , platform :: math_consts . whole_9 ) ;
    platform_math :: math_sub_wholes ( board_high_top , _letter_size_y , platform :: math_consts . whole_1 ) ;    
    platform_math :: math_mul_wholes ( board_high_bottom , _letter_size_y , platform :: math_consts . whole_4 ) ;
    platform_math :: math_div_whole_by ( board_high_bottom , platform :: math_consts . whole_5 ) ;    
    _rasterize_use_texel ( _filler ) ;
    ...
    platform_math :: math_div_wholes ( board_low_left , _letter_size_x , platform :: math_consts . whole_9 ) ;    
    board_low_right = board_mid_right ;
    platform_math :: math_div_wholes ( board_low_top , _letter_size_y , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_make_num_whole ( board_low_bottom , 0 ) ;    
    _rasterize_use_texel ( _filler ) ;
    ...
    platform_math :: math_div_wholes ( hole_high_left , _letter_size_x , platform :: math_consts . whole_6 ) ;    
    platform_math :: math_div_wholes ( hole_high_right , _letter_size_x , platform :: math_consts . whole_3 ) ;    
    platform_math :: math_sub_wholes ( hole_high_top , board_high_bottom , platform :: math_consts . whole_1 ) ;    
    platform_math :: math_add_wholes ( hole_high_bottom , board_mid_top , platform :: math_consts . whole_1 ) ;    
    _rasterize_use_texel ( _eraser ) ;
    ...
    platform_math :: math_mul_wholes ( hole_low_left , _letter_size_x , platform :: math_consts . whole_2 ) ;
    platform_math :: math_div_whole_by ( hole_low_left , platform :: math_consts . whole_3 ) ;    
    platform_math :: math_mul_wholes ( hole_low_right , _letter_size_x , platform :: math_consts . whole_5 ) ;
    platform_math :: math_div_whole_by ( hole_low_right , platform :: math_consts . whole_6 ) ;    
    platform_math :: math_sub_wholes ( hole_low_top , board_mid_bottom , platform :: math_consts . whole_1 ) ;    
    platform_math :: math_add_wholes ( hole_low_bottom , board_low_top , platform :: math_consts . whole_1 ) ;    
    _rasterize_use_texel ( _eraser ) ;
    _rasterize_ellipse_in_rect ( hole_low_left , hole_low_top , hole_low_right , hole_low_bottom ) ;
    
    num_whole hole_high_center_x ;
    platform_math :: math_add_wholes ( hole_high_center_x , hole_high_left , hole_high_right ) ;
    platform_math :: math_div_whole_by ( hole_high_center_x , platform :: math_consts . whole_2 ) ;    
    _rasterize_use_texel ( _eraser ) ;
    _rasterize_rect ( hole_high_center_x , hole_high_top , circle_high_right , hole_high_bottom ) ;
    
    num_whole hole_low_center_x ;
    platform_math :: math_add_wholes ( hole_low_center_x , hole_low_left , hole_low_right ) ;
    platform_math :: math_div_whole_by ( hole_low_center_x , platform :: math_consts . whole_2 ) ;
    _rasterize_use_texel ( _eraser ) ;
...
void shy_logic_text < mediator > :: _rasterize_font_english_T ( )
{
    ...
    num_whole hole_top ;
    num_whole hole_bottom ;
    platform_math :: math_make_num_whole ( hole_left , 0 ) ;
    hole_right = right ;    
    platform_math :: math_mul_wholes ( hole_mid_left , _letter_size_x , platform :: math_consts . whole_2 ) ;
    platform_math :: math_div_whole_by ( hole_mid_left , platform :: math_consts . whole_7 ) ;    
    platform_math :: math_mul_wholes ( hole_mid_right , _letter_size_x , platform :: math_consts . whole_4 ) ;
    ...
    platform_math :: math_mul_wholes ( hole_top , _letter_size_y , platform :: math_consts . whole_4 ) ;
    platform_math :: math_div_whole_by ( hole_top , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_make_num_whole ( hole_bottom , 0 ) ;
    _rasterize_use_texel ( _eraser ) ;
...
void shy_logic_text < mediator > :: _rasterize_font_english_U ( )
{
    ...
    num_whole ellipse_bottom ;
    platform_math :: math_sub_wholes ( top_limit , _letter_size_y , platform :: math_consts . whole_1 ) ;
    platform_math :: math_make_num_whole ( ellipse_left , 0 ) ;    
    platform_math :: math_mul_wholes ( ellipse_right , _letter_size_x , platform :: math_consts . whole_4 ) ;
    platform_math :: math_div_whole_by ( ellipse_right , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_div_wholes ( ellipse_top , _letter_size_y , platform :: math_consts . whole_2 ) ;    
    platform_math :: math_make_num_whole ( ellipse_bottom , 0 ) ;
    _rasterize_use_texel ( _filler ) ;
    _rasterize_ellipse_in_rect ( ellipse_left , ellipse_top , ellipse_right , ellipse_bottom ) ;    
    
    num_whole ellipse_center_y ;
    platform_math :: math_div_wholes ( ellipse_center_y , _letter_size_y , platform :: math_consts . whole_4 ) ;    
    _rasterize_use_texel ( _filler ) ;
    ...
    num_whole hole_bottom ;
    platform_math :: math_div_wholes ( hole_left , _letter_size_x , platform :: math_consts . whole_5 ) ;
    platform_math :: math_add_to_whole ( hole_left , platform :: math_consts . whole_1 ) ;    
    platform_math :: math_mul_wholes ( hole_right , _letter_size_x , platform :: math_consts . whole_3 ) ;
    platform_math :: math_div_whole_by ( hole_right , platform :: math_consts . whole_5 ) ;
    platform_math :: math_sub_from_whole ( hole_right , platform :: math_consts . whole_1 ) ;    
    platform_math :: math_div_wholes ( hole_top , _letter_size_y , platform :: math_consts . whole_3 ) ;
    platform_math :: math_sub_from_whole ( hole_top , platform :: math_consts . whole_1 ) ;    
    platform_math :: math_div_wholes ( hole_bottom , _letter_size_y , platform :: math_consts . whole_6 ) ;
    platform_math :: math_add_to_whole ( hole_bottom , platform :: math_consts . whole_1 ) ;
    _rasterize_use_texel ( _eraser ) ;
    _rasterize_ellipse_in_rect ( hole_left , hole_top , hole_right , hole_bottom ) ;
...
void shy_logic_text < mediator > :: _rasterize_font_english_V ( )
{
    ...
    num_whole low_right ;
    platform_math :: math_sub_wholes ( top_limit , _letter_size_y , platform :: math_consts . whole_1 ) ;
    platform_math :: math_make_num_whole ( high_1_left , 0 ) ;    
    platform_math :: math_div_wholes ( high_1_right , _letter_size_x , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_mul_wholes ( high_2_left , _letter_size_x , platform :: math_consts . whole_4 ) ;
    platform_math :: math_div_whole_by ( high_2_left , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_sub_wholes ( high_2_right , _letter_size_x , platform :: math_consts . whole_1 ) ;    
    platform_math :: math_mul_wholes ( low_left , _letter_size_x , platform :: math_consts . whole_2 ) ;
    platform_math :: math_div_whole_by ( low_left , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_mul_wholes ( low_right , _letter_size_x , platform :: math_consts . whole_3 ) ;
    platform_math :: math_div_whole_by ( low_right , platform :: math_consts . whole_5 ) ;
    _rasterize_use_texel ( _filler ) ;
...
void shy_logic_text < mediator > :: _rasterize_font_english_W ( )
{
    ...
    platform_math :: math_make_num_whole ( high_1_left , 0 ) ;    
    platform_math :: math_div_wholes ( high_1_right , _letter_size_x , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_mul_wholes ( high_2_left , _letter_size_x , platform :: math_consts . whole_2 ) ;
    platform_math :: math_div_whole_by ( high_2_left , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_mul_wholes ( high_2_right , _letter_size_x , platform :: math_consts . whole_3 ) ;
    platform_math :: math_div_whole_by ( high_2_right , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_mul_wholes ( high_3_left , _letter_size_x , platform :: math_consts . whole_4 ) ;
    platform_math :: math_div_whole_by ( high_3_left , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_sub_wholes ( high_3_right , _letter_size_x , platform :: math_consts . whole_1 ) ;    
    platform_math :: math_div_wholes ( low_1_left , _letter_size_x , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_mul_wholes ( low_1_right , _letter_size_x , platform :: math_consts . whole_2 ) ;
    platform_math :: math_div_whole_by ( low_1_right , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_mul_wholes ( low_2_left , _letter_size_x , platform :: math_consts . whole_3 ) ;
    platform_math :: math_div_whole_by ( low_2_left , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_mul_wholes ( low_2_right , _letter_size_x , platform :: math_consts . whole_4 ) ;
    platform_math :: math_div_whole_by ( low_2_right , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_sub_wholes ( high_top , _letter_size_y , platform :: math_consts . whole_1 ) ;    
    platform_math :: math_make_num_whole ( low_bottom , 0 ) ;
    _rasterize_use_texel ( _filler ) ;
...
void shy_logic_text < mediator > :: _rasterize_font_english_X ( )
{
    ...
    num_whole top_y ;
    num_whole bottom_y ;
    platform_math :: math_make_num_whole ( left_1 , 0 ) ;    
    platform_math :: math_div_wholes ( right_1 , _letter_size_x , platform :: math_consts . whole_4 ) ;    
    platform_math :: math_mul_wholes ( left_2 , _letter_size_x , platform :: math_consts . whole_3 ) ;
    platform_math :: math_div_whole_by ( left_2 , platform :: math_consts . whole_4 ) ;    
    platform_math :: math_sub_wholes ( right_2 , _letter_size_x , platform :: math_consts . whole_1 ) ;    
    platform_math :: math_sub_wholes ( top_y , _letter_size_y , platform :: math_consts . whole_1 ) ;    
    platform_math :: math_make_num_whole ( bottom_y , 0 ) ;    
    _rasterize_use_texel ( _filler ) ;
...
void shy_logic_text < mediator > :: _rasterize_font_english_Y ( )
{
    ...
    num_whole mid_y ;
    platform_math :: math_make_num_whole ( high_1_left , 0 ) ;    
    platform_math :: math_div_wholes ( high_1_right , _letter_size_x , platform :: math_consts . whole_4 ) ;    
    platform_math :: math_mul_wholes ( high_2_left , _letter_size_x , platform :: math_consts . whole_3 ) ;
    platform_math :: math_div_whole_by ( high_2_left , platform :: math_consts . whole_4 ) ;    
    platform_math :: math_sub_wholes ( high_2_right , _letter_size_x , platform :: math_consts . whole_1 ) ;    
    platform_math :: math_sub_wholes ( high_top , _letter_size_y , platform :: math_consts . whole_1 ) ;    
    platform_math :: math_mul_wholes ( low_left , _letter_size_x , platform :: math_consts . whole_2 ) ;
    platform_math :: math_div_whole_by ( low_left , platform :: math_consts . whole_5 ) ;    
    ...
    platform_math :: math_div_whole_by ( low_right , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_make_num_whole ( low_bottom , 0 ) ;    
    platform_math :: math_div_wholes ( mid_y , _letter_size_y , platform :: math_consts . whole_2 ) ;    
    _rasterize_use_texel ( _filler ) ;
...
void shy_logic_text < mediator > :: _rasterize_font_english_Z ( )
{
    ...
    platform_math :: math_make_num_whole ( hor_left , 0 ) ;    
    platform_math :: math_mul_wholes ( hor_right , _letter_size_x , platform :: math_consts . whole_4 ) ;
    platform_math :: math_div_whole_by ( hor_right , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_sub_wholes ( high_top , _letter_size_y , platform :: math_consts . whole_1 ) ;    
    platform_math :: math_mul_wholes ( high_bottom , _letter_size_y , platform :: math_consts . whole_4 ) ;
    platform_math :: math_div_whole_by ( high_bottom , platform :: math_consts . whole_5 ) ;    
    _rasterize_use_texel ( _filler ) ;
    _rasterize_rect ( hor_left , high_top , hor_right , high_bottom ) ;
    
    num_whole low_top ;
    num_whole low_bottom ;
    platform_math :: math_div_wholes ( low_top , _letter_size_y , platform :: math_consts . whole_5 ) ;    
    platform_math :: math_make_num_whole ( low_bottom , 0 ) ;
    _rasterize_use_texel ( _filler ) ;
    ...
    num_whole board_width ;
    num_whole right_minus_board_width ;
    platform_math :: math_div_wholes ( board_width , _letter_size_y , platform :: math_consts . whole_4 ) ;    
    platform_math :: math_sub_wholes ( right_minus_board_width , hor_right , board_width ) ;
    _rasterize_use_texel ( _filler ) ;
