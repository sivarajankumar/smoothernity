# $ANTLR 3.4 grammar/ShyLexer.g 2012-01-26 18:24:42
...
class ShyLexer(Lexer):
    ...
    def mTREE_STATEMENT_CALL_ARGS(self, ):
        try:
            ...
            # grammar/ShyLexer.g:76:26: ( 'TREE_STATEMENT_CALL_ARGS' )
            # grammar/ShyLexer.g:76:28: 'TREE_STATEMENT_CALL_ARGS'
            pass 
    ...
    def mTokens(self):
        # grammar/ShyLexer.g:1:8: ( ALL | ANY | ARGS | CONSTS | COPY | DEDENT | DO | ELIF | ELSE | IF | INDENT | MODULE | OPS | PASTE | PROC | REPLACE | STATELESS | TYPES | VARS | WITH | ARROW_LEFT | ARROW_RIGHT | CURLY_OPEN | CURLY_CLOSE | DIVIDE | MINUS | UNDERSCORE | NEWLINE | ID | NUMBER | WHITESPACE | EXPRESSION | STRING | TREE_ARBITRARY_TOKEN | TREE_CONDITION_ALL | TREE_CONDITION_ANY | TREE_CONSTS | TREE_COPY | TREE_COPY_PASTE | TREE_EXPRESSION | TREE_HINT | TREE_HINT_NONE | TREE_MODULE | TREE_NUM_FRACT | TREE_NUM_WHOLE | TREE_PASTE | TREE_PASTE_REPLACE | TREE_PASTE_WITH | TREE_PROC | TREE_PROC_ARGS | TREE_PROC_VARS | TREE_STATELESS | TREE_STATEMENT_CALL | TREE_STATEMENT_CALL_ARGS | TREE_STATEMENT_ELIF | TREE_STATEMENT_ELSE | TREE_STATEMENT_IF | TREE_STATEMENTS | TREE_TYPES | TREE_TYPES_ITEM | TREE_VAR | TREE_VAR_HINT | TREE_VARS_HINT )
        alt6 = 63
        ...
        if alt6 == 1:
            ...
            # grammar/ShyLexer.g:1:539: TREE_STATEMENT_CALL_ARGS
            pass 
            ...
            # grammar/ShyLexer.g:1:564: TREE_STATEMENT_ELIF
            pass 
            ...
            # grammar/ShyLexer.g:1:584: TREE_STATEMENT_ELSE
            pass 
            ...
            # grammar/ShyLexer.g:1:604: TREE_STATEMENT_IF
            pass 
            ...
            # grammar/ShyLexer.g:1:622: TREE_STATEMENTS
            pass 
            ...
            # grammar/ShyLexer.g:1:638: TREE_TYPES
            pass 
            self.mTREE_TYPES()
            ...
            # grammar/ShyLexer.g:1:649: TREE_TYPES_ITEM
            pass 
            ...
            # grammar/ShyLexer.g:1:665: TREE_VAR
            pass 
            self.mTREE_VAR()
            ...
            # grammar/ShyLexer.g:1:674: TREE_VAR_HINT
            pass 
            self.mTREE_VAR_HINT()
            ...
            # grammar/ShyLexer.g:1:688: TREE_VARS_HINT
            pass 
    ...
    DFA6_min = DFA.unpack(
        ...
        u"\uffff\2\116\1\124\1\137\1\123\1\101\1\103\1\uffff\1\114\1\101"
        u"\1\114\3\uffff\1\114\1\111\1\114\2\uffff\1\137\2\uffff"
        )
    ...
    DFA6_max = DFA.unpack(
        ...
        u"\111\1\uffff\1\116\1\101\1\114\3\uffff\1\114\1\123\1\114\2\uffff"
        u"\1\137\2\uffff"
        )
    ...
    DFA6_accept = DFA.unpack(
        ...
        u"\1\uffff\1\74\1\73\1\uffff\1\57\1\60\7\uffff\1\72\3\uffff\1\71"
        u"\1\43\1\44\3\uffff\1\67\1\70\1\uffff\1\66\1\65"
        )
