...
if __name__ == '__main__' :
    ...
    try :
        ...
        bf ( 'platform_matrix_identity' , [ { } ] )
        bf ( 'platform_matrix_inverse_rotation_translation' , [ { } ] )
        ...
        bf ( 'platform_trace_trace_begin' , [ { } ] )
        bf ( 'platform_trace_trace_end' , [ ] )
        bf ( 'platform_trace_trace_num_whole' , [ { } ] )
        bf ( 'platform_trace_trace_num_whole_error' , [ { } ] )
        bf ( 'platform_trace_trace_string' , [ { } ] )
        bf ( 'platform_trace_trace_string_error' , [ { } ] )
