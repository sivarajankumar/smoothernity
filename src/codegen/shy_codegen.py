def shy_generate ( lines ) :
    ...
    res . update ( _shy_generate_common_injections_h ( ) )
    res . update ( _shy_generate_common_injections_cpp ( ) )
    res . update ( _shy_generate_loadable_h ( ) )
    res . update ( _shy_generate_loadable_hpp ( ) )
    res . update ( _shy_generate_loadable_injections_h ( ) )
    res . update ( _shy_generate_loadable_injections_cpp ( ) )
    return res
...
def _shy_generate_common_injections_h ( ) :
...
def _shy_generate_loadable_hpp ( ) :
    return { 'src/loadable/shy_loadable.hpp' :
        'void shy_loadable :: load ( )\n'
        '{\n'
        '}\n' }

def _shy_generate_loadable_injections_h ( ) :
...
def _shy_generate_loadable_injections_cpp ( ) :
