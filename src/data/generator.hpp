...
class shy_data_generator
{
    ...
    public :
        ...
        static std :: string fsm_init ( std :: string fsm_system )
        {
            return std :: string ( )
                + std :: string ( "\n" )
                + std :: string ( "template < typename " )
        ...
        static std :: string fsm_public_methods ( std :: string fsm_system )
        {
            return std :: string ( )
                ...
                + std :: string ( "    void set_mediator ( typename platform_pointer :: template pointer < mediator_type > ) ;\n" )
        ...
        static std :: string fsm_set_mediator_implementation ( std :: string fsm_system )
        {
            return std :: string ( )
                + std :: string ( "\n" )
                + std :: string ( "template < typename " )
                ...
                + std :: string ( "void shy_" )
                    ...
                    + std :: string ( "_fsm_autogenerated < " )
                    + fsm_system
                    + std :: string ( "_fsm > :: set_mediator ( typename platform_pointer :: template pointer < mediator_type > )\n" )
                + std :: string ( "{\n" )
                + std :: string ( "}\n" )
                ;
        }
        ...
        static std :: string fsm_system_begin ( std :: string name )
        {
            return std :: string ( )
                ...
                + std :: string ( "    typedef typename logic_application_fsm :: mediator_type mediator_type ;\n" )
...
void shy_data_generator < data_generator_types > :: _generate_fsm_systems ( )
{
        ...
        )
    {
        ...
        _fsm_systems_code = _fsm_systems_code
            ...
            + _consts :: fsm_set_mediator_implementation ( fsm_system_name )
            ...
            + _fsm_tick_code
            + _consts :: fsm_init ( fsm_system_name )
