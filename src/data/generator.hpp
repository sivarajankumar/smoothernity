...
private :
    ...
    void _generate_fsm_constructor_implementation ( ) ;
...
private :
    ...
    std :: string _fsm_constructor_implementation_code ;
...
void shy_data_generator < data_generator_types > :: _generate_fsm_systems ( )
{
        ...
        )
    {
        ...
        _generate_fsm_constructor_implementation ( ) ;
        ...
        _fsm_systems_code += _fsm_systems_code
            ...
            + _fsm_constructor_implementation_code
            ;
    }
}
...
template < typename data_generator_types >
void shy_data_generator < data_generator_types > :: _generate_fsm_constructor_implementation ( )
{
    _fsm_constructor_implementation_code = _consts :: fsm_constructor_implementation_begin ( _current_fsm_system_name ) ;
        ...
        )
    {
        ...
        _fsm_constructor_implementation_code += _consts :: fsm_constructor_implementation_initial_state ( machine_name ) ;
    }
    _fsm_constructor_implementation_code += _consts :: fsm_constructor_implementation_end ( ) ;
}
