...
class shy_data_generator
{
    ...
    public :
        ...
        static std :: string fsm_condition_first_implementation_begin ( std :: string conditions )
        {
            return std :: string ( )
        ...
        static std :: string fsm_condition_next_implementation_begin ( std :: string conditions )
        {
            return std :: string ( )
...
void shy_data_generator < data_generator_types > :: _generate_current_fsm_machine_state_on_input_implementation ( )
{
    ...
    if ( ! _current_fsm_state -> on_input . empty ( ) )
    {
            ...
            )
        {
            ...
            bool first_entry = on_input_i == _current_fsm_state -> on_input . begin ( ) ;
            ...
            {
                _fsm_machine_state_on_input_implementation_code +=
                    _consts :: fsm_condition_first_implementation_begin ( _fsm_conditions_implementation_code ) ;
            }
            else
            {
                _fsm_machine_state_on_input_implementation_code +=
                    _consts :: fsm_condition_next_implementation_begin ( _fsm_conditions_implementation_code ) ;
            }
            _fsm_machine_state_on_input_implementation_code +=
                _fsm_actions_implementation_code ;
            _fsm_machine_state_on_input_implementation_code +=
