...
private :
    ...
    void _generate_fsm_actions_implementation ( const data_content_fsm_actions & ) ;
...
void shy_data_generator < data_generator_types > :: _generate_current_fsm_machine_state_on_entry_implementation ( )
{
    ...
    {
        _generate_fsm_actions_implementation ( _current_fsm_state -> on_entry ) ;
...
void shy_data_generator < data_generator_types > :: _generate_current_fsm_machine_state_on_exit_implementation ( )
{
    ...
    {
        _generate_fsm_actions_implementation ( _current_fsm_state -> on_exit ) ;
...
template < typename data_generator_types >
void shy_data_generator < data_generator_types > :: _generate_fsm_actions_implementation ( const data_content_fsm_actions & actions )
{
