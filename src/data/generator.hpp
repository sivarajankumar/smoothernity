...
class shy_data_generator
{
    ...
    public :
        ...
        static std :: string fsm_machine_state_on_entry_implementation_command ( std :: string machine , std :: string command )
        {
            return std :: string ( )
        ...
        static std :: string fsm_machine_state_on_entry_implementation_do ( std :: string action )
        {
...
void shy_data_generator < data_generator_types > :: _generate_current_fsm_machine_state_on_entry_implementation ( )
{
    ...
    if ( ! _fsm_actions_empty ( _current_fsm_state -> on_entry ) )
    {
        ...
        for ( typename data_content_fsm_action_do_container :: const_iterator action_do_i = _current_fsm_state -> on_entry . actions . begin ( )
            ; action_do_i != _current_fsm_state -> on_entry . actions . end ( )
            ; ++ action_do_i
            )
        {
            const data_content_fsm_action_do & action_do = * action_do_i ;
            _fsm_machine_state_on_entry_implementation_code += 
                _consts :: fsm_machine_state_on_entry_implementation_do ( action_do . action ) ;
        } 
        for ( typename data_content_fsm_action_command_container :: const_iterator action_command_i = _current_fsm_state -> on_entry . commands . begin ( )
            ; action_command_i != _current_fsm_state -> on_entry . commands . end ( )
            ; ++ action_command_i
            )
        {
            const data_content_fsm_action_command & action_command = * action_command_i ;
            _fsm_machine_state_on_entry_implementation_code +=
                _consts :: fsm_machine_state_on_entry_implementation_command ( action_command . machine , action_command . command ) ;
        }
        _fsm_machine_state_on_entry_implementation_code +=
