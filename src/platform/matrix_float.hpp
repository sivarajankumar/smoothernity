...
{
    platform_math_insider :: num_fract_value_get ( matrix . _elements [ 0 ] , x ) ;
    platform_math_insider :: num_fract_value_get ( matrix . _elements [ 1 ] , y ) ;
    platform_math_insider :: num_fract_value_get ( matrix . _elements [ 2 ] , z ) ;
...
{
    platform_math_insider :: num_fract_value_get ( matrix . _elements [ 4 ] , x ) ;
    platform_math_insider :: num_fract_value_get ( matrix . _elements [ 5 ] , y ) ;
    platform_math_insider :: num_fract_value_get ( matrix . _elements [ 6 ] , z ) ;
...
{
    platform_math_insider :: num_fract_value_get ( matrix . _elements [ 8 ] , x ) ;
    platform_math_insider :: num_fract_value_get ( matrix . _elements [ 9 ] , y ) ;
    platform_math_insider :: num_fract_value_get ( matrix . _elements [ 10 ] , z ) ;
...
{
    platform_math_insider :: num_fract_value_get ( matrix . _elements [ 12 ] , x ) ;
    platform_math_insider :: num_fract_value_get ( matrix . _elements [ 13 ] , y ) ;
    platform_math_insider :: num_fract_value_get ( matrix . _elements [ 14 ] , z ) ;
...
{
    platform_vector_insider :: x_set ( result , matrix . _elements [ 0 ] ) ;
    platform_vector_insider :: y_set ( result , matrix . _elements [ 1 ] ) ;
    platform_vector_insider :: z_set ( result , matrix . _elements [ 2 ] ) ;
}

template < typename platform_insider >
inline void shy_platform_matrix_float < platform_insider > :: get_axis_y ( vector_data & result , const matrix_data & matrix )
{
    platform_vector_insider :: x_set ( result , matrix . _elements [ 4 ] ) ;
    platform_vector_insider :: y_set ( result , matrix . _elements [ 5 ] ) ;
    platform_vector_insider :: z_set ( result , matrix . _elements [ 6 ] ) ;
}

template < typename platform_insider >
inline void shy_platform_matrix_float < platform_insider > :: get_axis_z ( vector_data & result , const matrix_data & matrix )
{
    platform_vector_insider :: x_set ( result , matrix . _elements [ 8 ] ) ;
    platform_vector_insider :: y_set ( result , matrix . _elements [ 9 ] ) ;
    platform_vector_insider :: z_set ( result , matrix . _elements [ 10 ] ) ;
}

template < typename platform_insider >
inline void shy_platform_matrix_float < platform_insider > :: get_origin ( vector_data & result , const matrix_data & matrix )
{
    platform_vector_insider :: x_set ( result , matrix . _elements [ 12 ] ) ;
    platform_vector_insider :: y_set ( result , matrix . _elements [ 13 ] ) ;
    platform_vector_insider :: z_set ( result , matrix . _elements [ 14 ] ) ;
}
