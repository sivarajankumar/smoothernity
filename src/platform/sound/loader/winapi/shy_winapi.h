...
public :
    ...
    static void load_stereo_sample_data ( const samples_array & , const so_called_platform_sound_loader_winapi_stereo_resource_id_type & ) ;
    static void create_stereo_resource_id ( so_called_platform_sound_loader_winapi_stereo_resource_id_type & , so_called_platform_math_num_whole_type ) ;
...
void shy_platform_sound_loader_winapi :: load_stereo_sample_data
    ...
    , const so_called_platform_sound_loader_winapi_stereo_resource_id_type & resource_id 
    )
{
