...
public :
    ...
    static void set_index_value 
        ( so_called_type_platform_render_directx_index_data & data 
        , so_called_type_platform_math_num_whole index 
        ) ;
    ...
    static void use_texture ( so_called_type_platform_render_directx_texture_id arg_texture_id ) ;
    static void create_texture_id ( so_called_type_platform_render_directx_texture_id & arg_texture_id , so_called_type_platform_math_num_whole size_pow2_base ) ;
    ...
    static void delete_vertex_buffer ( so_called_type_platform_render_directx_vertex_buffer_id & arg_buffer_id ) ;
    static void delete_index_buffer ( so_called_type_platform_render_directx_index_buffer_id & arg_buffer_id ) ;
    static void delete_texture_id ( so_called_type_platform_render_directx_texture_id & arg_texture_id ) ;
    ...
    static void unmap_vertex_buffer ( so_called_type_platform_render_directx_vertex_buffer_id arg_buffer_id ) ;
    ...
    static void unmap_index_buffer ( so_called_type_platform_render_directx_index_buffer_id arg_buffer_id ) ;
...
{
    const so_called_type_platform_render_directx_texel_data * texels = 0 ;
