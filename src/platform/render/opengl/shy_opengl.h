...
public :
    ...
    static void set_index_value 
        ( so_called_platform_render_opengl_index_data_type & data 
        , so_called_platform_math_num_whole_type index 
        ) ;
    ...
    static void use_texture ( so_called_platform_render_opengl_texture_id_type arg_texture_id ) ;
    static void create_texture_id ( so_called_platform_render_opengl_texture_id_type & arg_texture_id , so_called_platform_math_num_whole_type size_pow2_base ) ;
    ...
    static void delete_vertex_buffer ( so_called_platform_render_opengl_vertex_buffer_id_type & arg_buffer_id ) ;
    static void delete_index_buffer ( so_called_platform_render_opengl_index_buffer_id_type & arg_buffer_id ) ;
    static void delete_texture_id ( so_called_platform_render_opengl_texture_id_type & arg_texture_id ) ;
    ...
    static void unmap_vertex_buffer ( so_called_platform_render_opengl_vertex_buffer_id_type arg_buffer_id ) ;
    ...
    static void unmap_index_buffer ( so_called_platform_render_opengl_index_buffer_id_type arg_buffer_id ) ;
