...
void shy_platform_render_opengl_insider :: get_mapped_indices_count ( so_called_lib_std_int32_t & elements , so_called_platform_render_opengl_index_buffer_mapped_data_type data )
{
    elements = data . _elements ;
}

void shy_platform_render_opengl_insider :: get_indices_count ( so_called_lib_std_int32_t & elements , so_called_platform_render_opengl_index_buffer_id_type data )
{
    elements = data . _elements ;
}
