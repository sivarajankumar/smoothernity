#ifndef _shy_platform_render_opengl_insider_injections_included
#define _shy_platform_render_opengl_insider_injections_included
...
typedef shy_platform_render_opengl_insider so_called_platform_render_opengl_insider ;
