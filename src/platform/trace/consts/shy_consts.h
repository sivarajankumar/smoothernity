class shy_platform_trace_consts
{
public :
    static void module_name_begin ( so_called_lib_std_string & ) ;
    static void module_name_end ( so_called_lib_std_string & ) ;
    static void number_begin ( so_called_lib_std_string & ) ;
    static void number_end ( so_called_lib_std_string & ) ;
    static void number_error_begin ( so_called_lib_std_string & ) ;
