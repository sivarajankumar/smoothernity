...
public :
    ...
    static void trace_num_fract ( so_called_type_platform_math_const_int_32 , so_called_type_platform_math_const_int_32 ) ;
    static void trace_num_fract_error ( so_called_type_platform_math_const_int_32 , so_called_type_platform_math_const_int_32 ) ;
