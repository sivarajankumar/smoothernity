...
{
    so_called_trace ( so_called_trace_platform_math :: check_uninitialized ( a ) ) ;
...
{
    so_called_trace ( so_called_trace_platform_math :: check_uninitialized ( a ) ) ;
    so_called_trace ( so_called_trace_platform_math :: check_uninitialized ( b ) ) ;
...
{
    so_called_trace ( so_called_trace_platform_math :: check_uninitialized ( from ) ) ;
    so_called_trace ( so_called_trace_platform_math :: check_uninitialized ( what ) ) ;
    so_called_profile ( so_called_profile_platform_math :: whole_add_sub ( ) ) ;
...
{
    so_called_trace ( so_called_trace_platform_math :: check_division_by_zero ( numerator , denominator ) ) ;
...
{
    so_called_trace ( so_called_trace_platform_math :: check_uninitialized ( fract ) ) ;
...
{
    so_called_trace ( so_called_trace_platform_math :: check_uninitialized ( value ) ) ;
    so_called_trace ( so_called_trace_platform_math :: check_uninitialized ( modulator ) ) ;
    so_called_trace ( so_called_trace_platform_math :: check_division_by_zero ( value , modulator ) ) ;
...
void shy_platform_math_int_float :: div_fract_by ( so_called_platform_math_int_float_num_fract_type & a , so_called_platform_math_int_float_num_fract_type b )
{
    so_called_trace ( so_called_trace_platform_math :: check_uninitialized ( a ) ) ;
    so_called_trace ( so_called_trace_platform_math :: check_uninitialized ( b ) ) ;
    so_called_trace ( so_called_trace_platform_math :: check_division_by_zero ( a , b ) ) ;
...
{
    so_called_trace ( so_called_trace_platform_math :: check_uninitialized ( whole ) ) ;
