...
template < typename platform_insider >
inline void shy_platform_vector_float < platform_insider > :: vector_xyz ( vector_data & result , num_fract x , num_fract y , num_fract z )
{
...
template < typename platform_insider >
inline void shy_platform_vector_float < platform_insider > :: vector_dot_product ( num_fract & result , vector_data v1 , vector_data v2 )
{
...
template < typename platform_insider >
inline void shy_platform_vector_float < platform_insider > :: vector_cross_product ( vector_data & result , vector_data v1 , vector_data v2 )
{
...
template < typename platform_insider >
inline void shy_platform_vector_float < platform_insider > :: vector_add ( vector_data & result , vector_data v1 , vector_data v2 )
{
...
template < typename platform_insider >
inline void shy_platform_vector_float < platform_insider > :: vector_sub ( vector_data & result , vector_data v1 , vector_data v2 )
{
    result . _x = v1 . _x - v2 . _x ;
    result . _y = v1 . _y - v2 . _y ;
    result . _z = v1 . _z - v2 . _z ;
...
template < typename platform_insider >
inline void shy_platform_vector_float < platform_insider > :: vector_mul ( vector_data & result , vector_data v , num_fract f )
{
...
template < typename platform_insider >
inline void shy_platform_vector_float < platform_insider > :: vector_mul_by ( vector_data & v , num_fract f )
{
...
template < typename platform_insider >
inline void shy_platform_vector_float < platform_insider > :: vector_length ( num_fract & result , vector_data v )
{
    platform_math_insider :: num_fract_unsafe_value_set ( result , float ( sqrt ( v . _x * v . _x + v . _y * v . _y + v . _z * v . _z ) ) ) ;
}

template < typename platform_insider >
inline void shy_platform_vector_float < platform_insider > :: vector_normalize ( vector_data & result , vector_data v )
{
