...
public :
    static void num_whole_value ( int * & value , num_whole & num ) ;
    static void num_fract_value ( float * & value , num_fract & num ) ;
...
template < typename platform >
inline void shy_platform_math_int_float_insider < platform > :: num_whole_value ( int * & value , num_whole & num )
{
    value = & num . _value ;
}

template < typename platform >
inline void shy_platform_math_int_float_insider < platform > :: num_fract_value ( float * & value , num_fract & num )
{
    value = & num . _value ;
}
