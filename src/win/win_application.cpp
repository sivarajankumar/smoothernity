...
typedef shy_platform < shy_win_platform_insider > shy_win_platform ;
typedef shy_facade < shy_win_platform , shy_fsm_collection_autogenerated > shy_facade_autogenerated ;
typedef shy_win_platform_insider :: platform_pointer platform_pointer ;

static shy_fsm_collection_autogenerated * g_fsm_collection = 0 ;
static shy_win_platform_insider * g_platform = 0 ;
static shy_facade_autogenerated * g_facade = 0 ;

void smoothernity_init ( )
{
    g_fsm_collection = new shy_fsm_collection_autogenerated ( ) ;
    g_platform = new shy_win_platform_insider ( ) ;
    
    platform_pointer :: pointer < const shy_win_platform > platform_ptr ;
    platform_pointer :: bind ( platform_ptr , g_platform -> platform ) ;
    
    platform_pointer :: pointer < shy_fsm_collection_autogenerated > fsm_collection_ptr ;
    platform_pointer :: bind ( fsm_collection_ptr , * g_fsm_collection ) ;

    g_platform -> mouse_insider . set_left_button_down ( false ) ;
    g_platform -> mouse_insider . set_enabled ( true ) ;
    g_facade = new shy_facade_autogenerated ( platform_ptr , fsm_collection_ptr ) ;
    g_facade -> init ( ) ;
}
