...
shy_win_platform :: vector_dot_product 
    ( shy_win_platform :: vector_data v1 
    , shy_win_platform :: vector_data v2
    )
{
    return v1 . _x * v2 . _x
         + v1 . _y * v2 . _y
...
inline
shy_win_platform :: vector_data 
shy_win_platform :: vector_cross_product 
    ( shy_win_platform :: vector_data v1 
    , shy_win_platform :: vector_data v2 
    )
{
    shy_win_platform :: vector_data result ;
...
inline
shy_win_platform :: vector_data 
shy_win_platform :: vector_mul 
    ( shy_win_platform :: vector_data v 
    , shy_win_platform :: float_32 f 
    )
{
    vector_data result ;
    result . _x = f * v . _x ;
...
inline
shy_win_platform :: float_32 
shy_win_platform :: vector_length 
    ( shy_win_platform :: vector_data v 
    )
{
...
inline
shy_win_platform :: vector_data 
shy_win_platform :: vector_normalize 
    ( shy_win_platform :: vector_data v 
    )
{
