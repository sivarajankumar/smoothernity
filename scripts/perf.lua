...
local function looper_alloc(count_max, machctl, machwork)
    ...
    local stats_render_update = counter_alloc(count_max)
    local stats_render_draw = counter_alloc(count_max)
    ...
    function self.update()
        ...
        local dispup, dispdr = api_render_timing()
        ...
        stats_render_update.sample(dispup)
        stats_render_draw.sample(dispdr)
        ...
        if stats_frame.count == 0 then
            ...
            io.write("Display update:  "..stats_render_update.str.."\n")
            io.write("Display draw:    "..stats_render_draw.str.."\n")
